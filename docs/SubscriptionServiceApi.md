...
> System.IO.Stream GetActivePaaSSubscriptions ()
...
namespace Example
{
    public class GetActivePaaSSubscriptionsExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "http://api.madana.io/rest";
            ...
            try
            {
                System.IO.Stream result = apiInstance.GetActivePaaSSubscriptions();
                Debug.WriteLine(result);
            }
            catch (ApiException e)
            {
                Debug.Print("Exception when calling SubscriptionServiceApi.GetActivePaaSSubscriptions: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> System.IO.Stream GetActiveSaaSSubscriptions ()
...
namespace Example
{
    public class GetActiveSaaSSubscriptionsExample
    {
        public static void Main()
        {
            ...
            try
            {
                System.IO.Stream result = apiInstance.GetActiveSaaSSubscriptions();
                Debug.WriteLine(result);
            }
            catch (ApiException e)
            {
                Debug.Print("Exception when calling SubscriptionServiceApi.GetActiveSaaSSubscriptions: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
