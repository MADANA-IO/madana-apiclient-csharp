...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonNodeInfo :  IEquatable<JsonNodeInfo>, IValidatableObject
    {
        ...
        public JsonNodeInfo(JsonSGXInfo sgxInfo = default(JsonSGXInfo), JsonIPFSSystemInfo ipfsInfo = default(JsonIPFSSystemInfo), string memory = default(string), string owner = default(string), string publicKey = default(string), string connectionURL = default(string), decimal operatingSystemUptime = default(decimal), string cpuModel = default(string), string cpuFamily = default(string), List<string> processors = default(List<string>), int cpuLogicalCount = default(int), string hardwareBaseboard = default(string), string hardwareFirmware = default(string), int cpuPhysicalCores = default(int), string operatingSystem = default(string), string status = default(string), string cpuFrequency = default(string))
        {
