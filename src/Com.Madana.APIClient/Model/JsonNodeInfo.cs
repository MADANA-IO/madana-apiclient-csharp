...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonNodeInfo :  IEquatable<JsonNodeInfo>, IValidatableObject
    {
        ...
        public JsonNodeInfo(JsonIPFSSystemInfo ipfsInfo = default(JsonIPFSSystemInfo), int cpuLogicalCount = default(int), string hardwareFirmware = default(string), string publicKey = default(string), string connectionURL = default(string), string hardwareBaseboard = default(string), string cpuFamily = default(string), decimal operatingSystemUptime = default(decimal), JsonSGXInfo sgxInfo = default(JsonSGXInfo), string cpuModel = default(string), string memory = default(string), string operatingSystem = default(string), string status = default(string), string cpuFrequency = default(string), List<string> processors = default(List<string>), string owner = default(string), int cpuPhysicalCores = default(int))
        {
