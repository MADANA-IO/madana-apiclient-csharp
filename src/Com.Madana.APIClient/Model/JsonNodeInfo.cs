...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonNodeInfo :  IEquatable<JsonNodeInfo>, IValidatableObject
    {
        ...
        public JsonNodeInfo(int cpuLogicalCount = default(int), string memory = default(string), string hardwareFirmware = default(string), string cpuModel = default(string), string owner = default(string), string cpuFrequency = default(string), int cpuPhysicalCores = default(int), string operatingSystem = default(string), decimal operatingSystemUptime = default(decimal), string hardwareBaseboard = default(string), string cpuFamily = default(string), string connectionURL = default(string), string publicKey = default(string), JsonIPFSSystemInfo ipfsInfo = default(JsonIPFSSystemInfo), string status = default(string), List<string> processors = default(List<string>))
        {
