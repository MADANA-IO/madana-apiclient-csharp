...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonNodeInfo :  IEquatable<JsonNodeInfo>, IValidatableObject
    {
        ...
        public JsonNodeInfo(string operatingSystem = default(string), string memory = default(string), string publicKey = default(string), List<string> processors = default(List<string>), string cpuFamily = default(string), string hardwareFirmware = default(string), JsonIPFSSystemInfo ipfsInfo = default(JsonIPFSSystemInfo), string status = default(string), string cpuModel = default(string), string cpuFrequency = default(string), int cpuPhysicalCores = default(int), string hardwareBaseboard = default(string), string connectionURL = default(string), int cpuLogicalCount = default(int), string owner = default(string), JsonSGXInfo sgxInfo = default(JsonSGXInfo), decimal operatingSystemUptime = default(decimal))
        {
