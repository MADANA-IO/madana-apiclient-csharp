...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonNodeInfo :  IEquatable<JsonNodeInfo>, IValidatableObject
    {
        ...
        public JsonNodeInfo(JsonIPFSSystemInfo ipfsInfo = default(JsonIPFSSystemInfo), string cpuFrequency = default(string), string operatingSystem = default(string), List<string> processors = default(List<string>), string publicKey = default(string), string hardwareFirmware = default(string), string hardwareBaseboard = default(string), string connectionURL = default(string), string cpuModel = default(string), string owner = default(string), decimal operatingSystemUptime = default(decimal), string status = default(string), int cpuPhysicalCores = default(int), string cpuFamily = default(string), int cpuLogicalCount = default(int), JsonSGXInfo sgxInfo = default(JsonSGXInfo), string memory = default(string))
        {
