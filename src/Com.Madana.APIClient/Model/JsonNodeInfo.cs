...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonNodeInfo :  IEquatable<JsonNodeInfo>, IValidatableObject
    {
        ...
        public JsonNodeInfo(string cpuFrequency = default(string), JsonSGXInfo sgxInfo = default(JsonSGXInfo), string publicKey = default(string), int cpuLogicalCount = default(int), string owner = default(string), int cpuPhysicalCores = default(int), string memory = default(string), string status = default(string), JsonIPFSSystemInfo ipfsInfo = default(JsonIPFSSystemInfo), string hardwareFirmware = default(string), string cpuModel = default(string), string operatingSystem = default(string), List<string> processors = default(List<string>), string hardwareBaseboard = default(string), string connectionURL = default(string), decimal operatingSystemUptime = default(decimal), string cpuFamily = default(string))
        {
