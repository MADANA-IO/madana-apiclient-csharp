...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonNodeInfo :  IEquatable<JsonNodeInfo>, IValidatableObject
    {
        ...
        public JsonNodeInfo(int cpuPhysicalCores = default(int), string cpuFamily = default(string), string hardwareBaseboard = default(string), string cpuFrequency = default(string), int cpuLogicalCount = default(int), string owner = default(string), JsonIPFSSystemInfo ipfsInfo = default(JsonIPFSSystemInfo), string cpuModel = default(string), string publicKey = default(string), List<string> processors = default(List<string>), string memory = default(string), string operatingSystem = default(string), string hardwareFirmware = default(string), string connectionURL = default(string), string status = default(string), JsonSGXInfo sgxInfo = default(JsonSGXInfo), decimal operatingSystemUptime = default(decimal))
        {
