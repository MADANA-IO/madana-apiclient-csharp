...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonNodeInfo :  IEquatable<JsonNodeInfo>, IValidatableObject
    {
        ...
        public JsonNodeInfo(decimal operatingSystemUptime = default(decimal), JsonIPFSSystemInfo ipfsInfo = default(JsonIPFSSystemInfo), string hardwareBaseboard = default(string), string owner = default(string), int cpuLogicalCount = default(int), string operatingSystem = default(string), JsonSGXInfo sgxInfo = default(JsonSGXInfo), string cpuFrequency = default(string), string cpuModel = default(string), string status = default(string), List<string> processors = default(List<string>), string publicKey = default(string), string memory = default(string), string cpuFamily = default(string), string connectionURL = default(string), int cpuPhysicalCores = default(int), string hardwareFirmware = default(string))
        {
