...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonNodeInfo :  IEquatable<JsonNodeInfo>, IValidatableObject
    {
        ...
        public JsonNodeInfo(string hardwareFirmware = default(string), JsonSGXInfo sgxInfo = default(JsonSGXInfo), int cpuLogicalCount = default(int), string publicKey = default(string), string memory = default(string), string status = default(string), JsonIPFSSystemInfo ipfsInfo = default(JsonIPFSSystemInfo), decimal operatingSystemUptime = default(decimal), string cpuModel = default(string), int cpuPhysicalCores = default(int), string cpuFrequency = default(string), string hardwareBaseboard = default(string), string owner = default(string), string cpuFamily = default(string), string operatingSystem = default(string), List<string> processors = default(List<string>), string connectionURL = default(string))
        {
