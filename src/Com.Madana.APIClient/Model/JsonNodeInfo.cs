...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonNodeInfo :  IEquatable<JsonNodeInfo>, IValidatableObject
    {
        ...
        public JsonNodeInfo(string hardwareBaseboard = default(string), JsonIPFSSystemInfo ipfsInfo = default(JsonIPFSSystemInfo), string cpuModel = default(string), string status = default(string), string cpuFamily = default(string), string cpuFrequency = default(string), string owner = default(string), decimal operatingSystemUptime = default(decimal), string connectionURL = default(string), string memory = default(string), List<string> processors = default(List<string>), int cpuLogicalCount = default(int), string hardwareFirmware = default(string), int cpuPhysicalCores = default(int), string publicKey = default(string), string operatingSystem = default(string))
        {
