...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonNodeInfo :  IEquatable<JsonNodeInfo>, IValidatableObject
    {
        ...
        public JsonNodeInfo(List<string> processors = default(List<string>), string memory = default(string), decimal operatingSystemUptime = default(decimal), int cpuLogicalCount = default(int), JsonSGXInfo sgxInfo = default(JsonSGXInfo), JsonIPFSSystemInfo ipfsInfo = default(JsonIPFSSystemInfo), string operatingSystem = default(string), string cpuModel = default(string), string status = default(string), string cpuFamily = default(string), string cpuFrequency = default(string), string connectionURL = default(string), string publicKey = default(string), string owner = default(string), int cpuPhysicalCores = default(int), string hardwareFirmware = default(string), string hardwareBaseboard = default(string))
        {
