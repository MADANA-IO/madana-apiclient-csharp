...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonNodeInfo :  IEquatable<JsonNodeInfo>, IValidatableObject
    {
        ...
        public JsonNodeInfo(string hardwareFirmware = default(string), string cpuModel = default(string), string publicKey = default(string), int cpuLogicalCount = default(int), string owner = default(string), string cpuFrequency = default(string), string memory = default(string), string status = default(string), string hardwareBaseboard = default(string), string cpuFamily = default(string), string connectionURL = default(string), int cpuPhysicalCores = default(int), JsonIPFSSystemInfo ipfsInfo = default(JsonIPFSSystemInfo), List<string> processors = default(List<string>), decimal operatingSystemUptime = default(decimal), string operatingSystem = default(string))
        {
