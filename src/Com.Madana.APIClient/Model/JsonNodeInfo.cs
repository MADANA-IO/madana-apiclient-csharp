...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonNodeInfo :  IEquatable<JsonNodeInfo>, IValidatableObject
    {
        ...
        public JsonNodeInfo(string cpuModel = default(string), decimal operatingSystemUptime = default(decimal), int cpuLogicalCount = default(int), string owner = default(string), string operatingSystem = default(string), string status = default(string), string memory = default(string), string hardwareFirmware = default(string), string cpuFrequency = default(string), List<string> processors = default(List<string>), string cpuFamily = default(string), JsonSGXInfo sgxInfo = default(JsonSGXInfo), string publicKey = default(string), JsonIPFSSystemInfo ipfsInfo = default(JsonIPFSSystemInfo), int cpuPhysicalCores = default(int), string connectionURL = default(string), string hardwareBaseboard = default(string))
        {
