...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonNodeInfo :  IEquatable<JsonNodeInfo>, IValidatableObject
    {
        ...
        public JsonNodeInfo(JsonSGXInfo sgxInfo = default(JsonSGXInfo), List<string> processors = default(List<string>), string connectionURL = default(string), string status = default(string), string cpuModel = default(string), JsonIPFSSystemInfo ipfsInfo = default(JsonIPFSSystemInfo), string cpuFrequency = default(string), string memory = default(string), string hardwareFirmware = default(string), string operatingSystem = default(string), string hardwareBaseboard = default(string), decimal operatingSystemUptime = default(decimal), string publicKey = default(string), int cpuPhysicalCores = default(int), string owner = default(string), string cpuFamily = default(string), int cpuLogicalCount = default(int))
        {
