...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonNodeInfo :  IEquatable<JsonNodeInfo>, IValidatableObject
    {
        ...
        public JsonNodeInfo(string publicKey = default(string), int cpuLogicalCount = default(int), string connectionURL = default(string), List<string> processors = default(List<string>), string operatingSystem = default(string), string cpuFamily = default(string), int cpuPhysicalCores = default(int), JsonSGXInfo sgxInfo = default(JsonSGXInfo), string cpuFrequency = default(string), JsonIPFSSystemInfo ipfsInfo = default(JsonIPFSSystemInfo), string cpuModel = default(string), string hardwareFirmware = default(string), string hardwareBaseboard = default(string), decimal operatingSystemUptime = default(decimal), string owner = default(string), string status = default(string), string memory = default(string))
        {
