...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonNodeInfo :  IEquatable<JsonNodeInfo>, IValidatableObject
    {
        ...
        public JsonNodeInfo(List<string> processors = default(List<string>), string hardwareBaseboard = default(string), JsonSGXInfo sgxInfo = default(JsonSGXInfo), string connectionURL = default(string), string owner = default(string), string cpuModel = default(string), string hardwareFirmware = default(string), string memory = default(string), int cpuLogicalCount = default(int), string operatingSystem = default(string), int cpuPhysicalCores = default(int), string publicKey = default(string), string cpuFrequency = default(string), decimal operatingSystemUptime = default(decimal), string cpuFamily = default(string), string status = default(string), JsonIPFSSystemInfo ipfsInfo = default(JsonIPFSSystemInfo))
        {
