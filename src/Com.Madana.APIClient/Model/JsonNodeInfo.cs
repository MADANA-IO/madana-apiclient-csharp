...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonNodeInfo :  IEquatable<JsonNodeInfo>, IValidatableObject
    {
        ...
        public JsonNodeInfo(string hardwareFirmware = default(string), decimal operatingSystemUptime = default(decimal), JsonIPFSSystemInfo ipfsInfo = default(JsonIPFSSystemInfo), int cpuPhysicalCores = default(int), string connectionURL = default(string), string status = default(string), string publicKey = default(string), string cpuModel = default(string), string memory = default(string), JsonSGXInfo sgxInfo = default(JsonSGXInfo), List<string> processors = default(List<string>), int cpuLogicalCount = default(int), string operatingSystem = default(string), string cpuFrequency = default(string), string owner = default(string), string cpuFamily = default(string), string hardwareBaseboard = default(string))
        {
