...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonNodeInfo :  IEquatable<JsonNodeInfo>, IValidatableObject
    {
        ...
        public JsonNodeInfo(JsonSGXInfo sgxInfo = default(JsonSGXInfo), int cpuPhysicalCores = default(int), string publicKey = default(string), string memory = default(string), JsonIPFSSystemInfo ipfsInfo = default(JsonIPFSSystemInfo), int cpuLogicalCount = default(int), string owner = default(string), string hardwareBaseboard = default(string), string connectionURL = default(string), string hardwareFirmware = default(string), string cpuModel = default(string), string cpuFrequency = default(string), string cpuFamily = default(string), List<string> processors = default(List<string>), string status = default(string), decimal operatingSystemUptime = default(decimal), string operatingSystem = default(string))
        {
