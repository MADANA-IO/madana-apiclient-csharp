...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonNodeInfo :  IEquatable<JsonNodeInfo>, IValidatableObject
    {
        ...
        public JsonNodeInfo(JsonSGXInfo sgxInfo = default(JsonSGXInfo), List<string> processors = default(List<string>), int cpuLogicalCount = default(int), string cpuFamily = default(string), string cpuFrequency = default(string), string hardwareFirmware = default(string), decimal operatingSystemUptime = default(decimal), string hardwareBaseboard = default(string), string operatingSystem = default(string), string publicKey = default(string), string cpuModel = default(string), int cpuPhysicalCores = default(int), string owner = default(string), string memory = default(string), string connectionURL = default(string), string status = default(string), JsonIPFSSystemInfo ipfsInfo = default(JsonIPFSSystemInfo))
        {
