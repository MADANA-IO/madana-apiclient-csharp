...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonNodeInfo :  IEquatable<JsonNodeInfo>, IValidatableObject
    {
        ...
        public JsonNodeInfo(string hardwareFirmware = default(string), string publicKey = default(string), int cpuLogicalCount = default(int), int cpuPhysicalCores = default(int), string memory = default(string), string hardwareBaseboard = default(string), decimal operatingSystemUptime = default(decimal), string cpuFrequency = default(string), string connectionURL = default(string), JsonSGXInfo sgxInfo = default(JsonSGXInfo), string owner = default(string), string operatingSystem = default(string), string status = default(string), string cpuModel = default(string), string cpuFamily = default(string), List<string> processors = default(List<string>), JsonIPFSSystemInfo ipfsInfo = default(JsonIPFSSystemInfo))
        {
