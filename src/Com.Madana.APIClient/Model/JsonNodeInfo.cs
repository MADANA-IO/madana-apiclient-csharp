...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonNodeInfo :  IEquatable<JsonNodeInfo>, IValidatableObject
    {
        ...
        public JsonNodeInfo(List<string> processors = default(List<string>), string cpuFamily = default(string), string owner = default(string), string status = default(string), string cpuFrequency = default(string), string hardwareFirmware = default(string), string memory = default(string), decimal operatingSystemUptime = default(decimal), JsonIPFSSystemInfo ipfsInfo = default(JsonIPFSSystemInfo), JsonSGXInfo sgxInfo = default(JsonSGXInfo), string cpuModel = default(string), string connectionURL = default(string), string publicKey = default(string), string operatingSystem = default(string), int cpuPhysicalCores = default(int), string hardwareBaseboard = default(string), int cpuLogicalCount = default(int))
        {
