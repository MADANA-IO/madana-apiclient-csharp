...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonNodeInfo :  IEquatable<JsonNodeInfo>, IValidatableObject
    {
        ...
        public JsonNodeInfo(int cpuPhysicalCores = default(int), string connectionURL = default(string), string memory = default(string), List<string> processors = default(List<string>), string cpuFrequency = default(string), JsonIPFSSystemInfo ipfsInfo = default(JsonIPFSSystemInfo), string publicKey = default(string), string hardwareBaseboard = default(string), int cpuLogicalCount = default(int), string owner = default(string), decimal operatingSystemUptime = default(decimal), string cpuFamily = default(string), string hardwareFirmware = default(string), string status = default(string), string operatingSystem = default(string), string cpuModel = default(string))
        {
