...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonNodeInfo :  IEquatable<JsonNodeInfo>, IValidatableObject
    {
        ...
        public JsonNodeInfo(List<string> processors = default(List<string>), string memory = default(string), string publicKey = default(string), string operatingSystem = default(string), string owner = default(string), int cpuPhysicalCores = default(int), JsonIPFSSystemInfo ipfsInfo = default(JsonIPFSSystemInfo), string hardwareFirmware = default(string), string hardwareBaseboard = default(string), string cpuModel = default(string), string connectionURL = default(string), string cpuFrequency = default(string), JsonSGXInfo sgxInfo = default(JsonSGXInfo), int cpuLogicalCount = default(int), string status = default(string), decimal operatingSystemUptime = default(decimal), string cpuFamily = default(string))
        {
