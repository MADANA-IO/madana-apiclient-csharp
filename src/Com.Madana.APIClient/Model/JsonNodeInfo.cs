...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonNodeInfo :  IEquatable<JsonNodeInfo>, IValidatableObject
    {
        ...
        public JsonNodeInfo(string memory = default(string), string cpuFamily = default(string), string owner = default(string), List<string> processors = default(List<string>), string cpuFrequency = default(string), int cpuPhysicalCores = default(int), int cpuLogicalCount = default(int), JsonIPFSSystemInfo ipfsInfo = default(JsonIPFSSystemInfo), string cpuModel = default(string), decimal operatingSystemUptime = default(decimal), string operatingSystem = default(string), string hardwareBaseboard = default(string), string hardwareFirmware = default(string), string connectionURL = default(string), string publicKey = default(string), string status = default(string), JsonSGXInfo sgxInfo = default(JsonSGXInfo))
        {
            this.Memory = memory;
