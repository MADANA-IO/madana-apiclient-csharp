...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonNodeInfo :  IEquatable<JsonNodeInfo>, IValidatableObject
    {
        ...
        public JsonNodeInfo(int cpuLogicalCount = default(int), string memory = default(string), string hardwareBaseboard = default(string), List<string> processors = default(List<string>), string cpuFamily = default(string), string hardwareFirmware = default(string), string connectionURL = default(string), string cpuModel = default(string), int cpuPhysicalCores = default(int), string cpuFrequency = default(string), JsonIPFSSystemInfo ipfsInfo = default(JsonIPFSSystemInfo), JsonSGXInfo sgxInfo = default(JsonSGXInfo), decimal operatingSystemUptime = default(decimal), string status = default(string), string publicKey = default(string), string owner = default(string), string operatingSystem = default(string))
        {
