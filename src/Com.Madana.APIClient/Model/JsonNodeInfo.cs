...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonNodeInfo :  IEquatable<JsonNodeInfo>, IValidatableObject
    {
        ...
        public JsonNodeInfo(string status = default(string), int cpuPhysicalCores = default(int), List<string> processors = default(List<string>), string owner = default(string), string hardwareBaseboard = default(string), string hardwareFirmware = default(string), string publicKey = default(string), int cpuLogicalCount = default(int), JsonIPFSSystemInfo ipfsInfo = default(JsonIPFSSystemInfo), string cpuFrequency = default(string), string memory = default(string), string cpuFamily = default(string), string cpuModel = default(string), JsonSGXInfo sgxInfo = default(JsonSGXInfo), string operatingSystem = default(string), decimal operatingSystemUptime = default(decimal), string connectionURL = default(string))
        {
            this.Status = status;
