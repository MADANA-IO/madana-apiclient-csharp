...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonNodeInfo :  IEquatable<JsonNodeInfo>, IValidatableObject
    {
        ...
        public JsonNodeInfo(int cpuPhysicalCores = default(int), string publicKey = default(string), string hardwareBaseboard = default(string), string operatingSystem = default(string), string connectionURL = default(string), List<string> processors = default(List<string>), string cpuFamily = default(string), string memory = default(string), string hardwareFirmware = default(string), decimal operatingSystemUptime = default(decimal), string cpuFrequency = default(string), string owner = default(string), string cpuModel = default(string), int cpuLogicalCount = default(int), JsonIPFSSystemInfo ipfsInfo = default(JsonIPFSSystemInfo), string status = default(string))
        {
