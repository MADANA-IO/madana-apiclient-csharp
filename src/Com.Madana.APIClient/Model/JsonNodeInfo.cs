...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonNodeInfo :  IEquatable<JsonNodeInfo>, IValidatableObject
    {
        ...
        public JsonNodeInfo(string hardwareFirmware = default(string), int cpuLogicalCount = default(int), List<string> processors = default(List<string>), string memory = default(string), int cpuPhysicalCores = default(int), string status = default(string), JsonIPFSSystemInfo ipfsInfo = default(JsonIPFSSystemInfo), string hardwareBaseboard = default(string), string owner = default(string), decimal operatingSystemUptime = default(decimal), string publicKey = default(string), string cpuFrequency = default(string), string cpuFamily = default(string), string cpuModel = default(string), string connectionURL = default(string), JsonSGXInfo sgxInfo = default(JsonSGXInfo), string operatingSystem = default(string))
        {
