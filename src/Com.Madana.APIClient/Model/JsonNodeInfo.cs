...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonNodeInfo :  IEquatable<JsonNodeInfo>, IValidatableObject
    {
        ...
        public JsonNodeInfo(string cpuModel = default(string), string operatingSystem = default(string), string publicKey = default(string), int cpuLogicalCount = default(int), string connectionURL = default(string), List<string> processors = default(List<string>), string hardwareFirmware = default(string), string status = default(string), JsonSGXInfo sgxInfo = default(JsonSGXInfo), string owner = default(string), decimal operatingSystemUptime = default(decimal), string hardwareBaseboard = default(string), JsonIPFSSystemInfo ipfsInfo = default(JsonIPFSSystemInfo), string cpuFamily = default(string), string cpuFrequency = default(string), string memory = default(string), int cpuPhysicalCores = default(int))
        {
