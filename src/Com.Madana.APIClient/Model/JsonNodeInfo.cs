...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonNodeInfo :  IEquatable<JsonNodeInfo>, IValidatableObject
    {
        ...
        public JsonNodeInfo(string hardwareFirmware = default(string), string operatingSystem = default(string), string cpuModel = default(string), string owner = default(string), decimal operatingSystemUptime = default(decimal), List<string> processors = default(List<string>), string connectionURL = default(string), string cpuFrequency = default(string), JsonSGXInfo sgxInfo = default(JsonSGXInfo), JsonIPFSSystemInfo ipfsInfo = default(JsonIPFSSystemInfo), int cpuLogicalCount = default(int), string hardwareBaseboard = default(string), string status = default(string), string cpuFamily = default(string), string publicKey = default(string), string memory = default(string), int cpuPhysicalCores = default(int))
        {
