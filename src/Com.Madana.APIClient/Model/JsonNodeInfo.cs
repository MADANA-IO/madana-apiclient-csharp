...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonNodeInfo :  IEquatable<JsonNodeInfo>, IValidatableObject
    {
        ...
        public JsonNodeInfo(decimal operatingSystemUptime = default(decimal), string memory = default(string), int cpuPhysicalCores = default(int), JsonIPFSSystemInfo ipfsInfo = default(JsonIPFSSystemInfo), int cpuLogicalCount = default(int), string operatingSystem = default(string), string cpuFrequency = default(string), string cpuFamily = default(string), string hardwareFirmware = default(string), string status = default(string), string cpuModel = default(string), string owner = default(string), string connectionURL = default(string), List<string> processors = default(List<string>), string hardwareBaseboard = default(string), string publicKey = default(string), JsonSGXInfo sgxInfo = default(JsonSGXInfo))
        {
