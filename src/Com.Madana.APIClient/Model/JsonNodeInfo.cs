...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonNodeInfo :  IEquatable<JsonNodeInfo>, IValidatableObject
    {
        ...
        public JsonNodeInfo(string hardwareFirmware = default(string), string status = default(string), string operatingSystem = default(string), int cpuPhysicalCores = default(int), int cpuLogicalCount = default(int), List<string> processors = default(List<string>), JsonSGXInfo sgxInfo = default(JsonSGXInfo), string cpuFrequency = default(string), JsonIPFSSystemInfo ipfsInfo = default(JsonIPFSSystemInfo), string memory = default(string), string cpuModel = default(string), string publicKey = default(string), string hardwareBaseboard = default(string), string owner = default(string), string cpuFamily = default(string), string connectionURL = default(string), decimal operatingSystemUptime = default(decimal))
        {
