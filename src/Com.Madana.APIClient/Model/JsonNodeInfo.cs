...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonNodeInfo :  IEquatable<JsonNodeInfo>, IValidatableObject
    {
        ...
        public JsonNodeInfo(string connectionURL = default(string), string cpuModel = default(string), string memory = default(string), string owner = default(string), string cpuFamily = default(string), string hardwareFirmware = default(string), string cpuFrequency = default(string), int cpuLogicalCount = default(int), string hardwareBaseboard = default(string), string status = default(string), List<string> processors = default(List<string>), string operatingSystem = default(string), decimal operatingSystemUptime = default(decimal), JsonIPFSSystemInfo ipfsInfo = default(JsonIPFSSystemInfo), int cpuPhysicalCores = default(int), JsonSGXInfo sgxInfo = default(JsonSGXInfo), string publicKey = default(string))
        {
