...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonNodeInfo :  IEquatable<JsonNodeInfo>, IValidatableObject
    {
        ...
        public JsonNodeInfo(List<string> processors = default(List<string>), string hardwareBaseboard = default(string), string cpuFamily = default(string), string memory = default(string), string cpuFrequency = default(string), string publicKey = default(string), string operatingSystem = default(string), string connectionURL = default(string), int cpuLogicalCount = default(int), decimal operatingSystemUptime = default(decimal), string status = default(string), string cpuModel = default(string), string hardwareFirmware = default(string), JsonSGXInfo sgxInfo = default(JsonSGXInfo), string owner = default(string), JsonIPFSSystemInfo ipfsInfo = default(JsonIPFSSystemInfo), int cpuPhysicalCores = default(int))
        {
