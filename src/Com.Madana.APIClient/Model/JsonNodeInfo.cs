...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonNodeInfo :  IEquatable<JsonNodeInfo>, IValidatableObject
    {
        ...
        public JsonNodeInfo(List<string> processors = default(List<string>), int cpuPhysicalCores = default(int), string hardwareBaseboard = default(string), string connectionURL = default(string), string owner = default(string), string memory = default(string), string operatingSystem = default(string), string hardwareFirmware = default(string), int cpuLogicalCount = default(int), string cpuModel = default(string), string status = default(string), string cpuFamily = default(string), decimal operatingSystemUptime = default(decimal), string cpuFrequency = default(string), string publicKey = default(string), JsonIPFSSystemInfo ipfsInfo = default(JsonIPFSSystemInfo), JsonSGXInfo sgxInfo = default(JsonSGXInfo))
        {
