...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonNodeInfo :  IEquatable<JsonNodeInfo>, IValidatableObject
    {
        ...
        public JsonNodeInfo(JsonIPFSSystemInfo ipfsInfo = default(JsonIPFSSystemInfo), string cpuModel = default(string), string connectionURL = default(string), string operatingSystem = default(string), List<string> processors = default(List<string>), string cpuFrequency = default(string), string status = default(string), decimal operatingSystemUptime = default(decimal), int cpuPhysicalCores = default(int), string owner = default(string), string hardwareBaseboard = default(string), JsonSGXInfo sgxInfo = default(JsonSGXInfo), string cpuFamily = default(string), string memory = default(string), int cpuLogicalCount = default(int), string hardwareFirmware = default(string), string publicKey = default(string))
        {
