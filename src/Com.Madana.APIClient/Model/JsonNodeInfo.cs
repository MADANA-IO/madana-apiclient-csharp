...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonNodeInfo :  IEquatable<JsonNodeInfo>, IValidatableObject
    {
        ...
        public JsonNodeInfo(string cpuModel = default(string), string status = default(string), List<string> processors = default(List<string>), string publicKey = default(string), string memory = default(string), string connectionURL = default(string), string operatingSystem = default(string), decimal operatingSystemUptime = default(decimal), string cpuFamily = default(string), JsonSGXInfo sgxInfo = default(JsonSGXInfo), int cpuPhysicalCores = default(int), string cpuFrequency = default(string), string owner = default(string), JsonIPFSSystemInfo ipfsInfo = default(JsonIPFSSystemInfo), int cpuLogicalCount = default(int), string hardwareFirmware = default(string), string hardwareBaseboard = default(string))
        {
