...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonNodeInfo :  IEquatable<JsonNodeInfo>, IValidatableObject
    {
        ...
        public JsonNodeInfo(string hardwareBaseboard = default(string), string operatingSystem = default(string), string status = default(string), string memory = default(string), JsonSGXInfo sgxInfo = default(JsonSGXInfo), decimal operatingSystemUptime = default(decimal), JsonIPFSSystemInfo ipfsInfo = default(JsonIPFSSystemInfo), string publicKey = default(string), int cpuPhysicalCores = default(int), string cpuModel = default(string), List<string> processors = default(List<string>), string connectionURL = default(string), string hardwareFirmware = default(string), string cpuFamily = default(string), string cpuFrequency = default(string), int cpuLogicalCount = default(int), string owner = default(string))
        {
