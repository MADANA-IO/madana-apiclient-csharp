...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonNodeInfo :  IEquatable<JsonNodeInfo>, IValidatableObject
    {
        ...
        public JsonNodeInfo(string memory = default(string), string cpuFrequency = default(string), string connectionURL = default(string), int cpuPhysicalCores = default(int), int cpuLogicalCount = default(int), JsonIPFSSystemInfo ipfsInfo = default(JsonIPFSSystemInfo), string hardwareBaseboard = default(string), string status = default(string), string owner = default(string), string cpuModel = default(string), decimal operatingSystemUptime = default(decimal), List<string> processors = default(List<string>), string operatingSystem = default(string), string cpuFamily = default(string), string publicKey = default(string), JsonSGXInfo sgxInfo = default(JsonSGXInfo), string hardwareFirmware = default(string))
        {
            this.Memory = memory;
