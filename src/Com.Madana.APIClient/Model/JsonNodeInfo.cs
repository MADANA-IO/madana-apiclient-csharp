...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonNodeInfo :  IEquatable<JsonNodeInfo>, IValidatableObject
    {
        ...
        public JsonNodeInfo(JsonIPFSSystemInfo ipfsInfo = default(JsonIPFSSystemInfo), string cpuFrequency = default(string), string operatingSystem = default(string), int cpuPhysicalCores = default(int), string cpuFamily = default(string), string memory = default(string), string owner = default(string), List<string> processors = default(List<string>), string connectionURL = default(string), string cpuModel = default(string), int cpuLogicalCount = default(int), string hardwareFirmware = default(string), decimal operatingSystemUptime = default(decimal), string status = default(string), string publicKey = default(string), string hardwareBaseboard = default(string))
        {
