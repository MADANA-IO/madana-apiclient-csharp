...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1OwnerReference :  IEquatable<JsonV1OwnerReference>, IValidatableObject
    {
        ...
        public JsonV1OwnerReference(string uid = default(string), string kind = default(string), string name = default(string), bool blockOwnerDeletion = default(bool), string apiVersion = default(string), bool controller = default(bool))
        {
            this.Uid = uid;
            this.Kind = kind;
            this.Name = name;
