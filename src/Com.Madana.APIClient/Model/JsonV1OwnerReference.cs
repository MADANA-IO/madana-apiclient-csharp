...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1OwnerReference :  IEquatable<JsonV1OwnerReference>, IValidatableObject
    {
        ...
        public JsonV1OwnerReference(string uid = default(string), bool blockOwnerDeletion = default(bool), string name = default(string), string kind = default(string), string apiVersion = default(string), bool controller = default(bool))
        {
            this.Uid = uid;
