...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1OwnerReference :  IEquatable<JsonV1OwnerReference>, IValidatableObject
    {
        ...
        public JsonV1OwnerReference(string kind = default(string), string apiVersion = default(string), string name = default(string), string uid = default(string), bool controller = default(bool), bool blockOwnerDeletion = default(bool))
        {
            this.Kind = kind;
