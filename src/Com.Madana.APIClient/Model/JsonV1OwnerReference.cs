...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1OwnerReference :  IEquatable<JsonV1OwnerReference>, IValidatableObject
    {
        ...
        public JsonV1OwnerReference(string kind = default(string), bool blockOwnerDeletion = default(bool), string apiVersion = default(string), string uid = default(string), bool controller = default(bool), string name = default(string))
        {
            this.Kind = kind;
