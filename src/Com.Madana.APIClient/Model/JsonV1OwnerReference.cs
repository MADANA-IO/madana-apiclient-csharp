...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1OwnerReference :  IEquatable<JsonV1OwnerReference>, IValidatableObject
    {
        ...
        public JsonV1OwnerReference(string name = default(string), string uid = default(string), string kind = default(string), bool controller = default(bool), string apiVersion = default(string), bool blockOwnerDeletion = default(bool))
        {
            this.Name = name;
            this.Uid = uid;
            this.Kind = kind;
