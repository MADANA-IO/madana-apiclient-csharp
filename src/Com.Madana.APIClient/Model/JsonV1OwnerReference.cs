...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1OwnerReference :  IEquatable<JsonV1OwnerReference>, IValidatableObject
    {
        ...
        public JsonV1OwnerReference(string name = default(string), string apiVersion = default(string), bool blockOwnerDeletion = default(bool), string uid = default(string), bool controller = default(bool), string kind = default(string))
        {
            this.Name = name;
