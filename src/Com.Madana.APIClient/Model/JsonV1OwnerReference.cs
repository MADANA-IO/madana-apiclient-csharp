...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1OwnerReference :  IEquatable<JsonV1OwnerReference>, IValidatableObject
    {
        ...
        public JsonV1OwnerReference(string name = default(string), string kind = default(string), bool blockOwnerDeletion = default(bool), string uid = default(string), string apiVersion = default(string), bool controller = default(bool))
        {
            this.Name = name;
            this.Kind = kind;
