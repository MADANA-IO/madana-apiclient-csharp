...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1OwnerReference :  IEquatable<JsonV1OwnerReference>, IValidatableObject
    {
        ...
        public JsonV1OwnerReference(string apiVersion = default(string), string name = default(string), bool controller = default(bool), string uid = default(string), bool blockOwnerDeletion = default(bool), string kind = default(string))
        {
