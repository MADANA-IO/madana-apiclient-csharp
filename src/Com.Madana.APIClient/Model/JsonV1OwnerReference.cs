...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1OwnerReference :  IEquatable<JsonV1OwnerReference>, IValidatableObject
    {
        ...
        public JsonV1OwnerReference(bool blockOwnerDeletion = default(bool), string name = default(string), string uid = default(string), bool controller = default(bool), string apiVersion = default(string), string kind = default(string))
        {
