...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1OwnerReference :  IEquatable<JsonV1OwnerReference>, IValidatableObject
    {
        ...
        public JsonV1OwnerReference(string uid = default(string), bool blockOwnerDeletion = default(bool), string apiVersion = default(string), bool controller = default(bool), string name = default(string), string kind = default(string))
        {
            this.Uid = uid;
