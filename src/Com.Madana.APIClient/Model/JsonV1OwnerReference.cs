...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1OwnerReference :  IEquatable<JsonV1OwnerReference>, IValidatableObject
    {
        ...
        public JsonV1OwnerReference(bool controller = default(bool), string name = default(string), string uid = default(string), bool blockOwnerDeletion = default(bool), string kind = default(string), string apiVersion = default(string))
        {
