...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1OwnerReference :  IEquatable<JsonV1OwnerReference>, IValidatableObject
    {
        ...
        public JsonV1OwnerReference(bool blockOwnerDeletion = default(bool), string uid = default(string), bool controller = default(bool), string name = default(string), string kind = default(string), string apiVersion = default(string))
        {
