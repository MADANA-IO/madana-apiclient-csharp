...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1OwnerReference :  IEquatable<JsonV1OwnerReference>, IValidatableObject
    {
        ...
        public JsonV1OwnerReference(bool controller = default(bool), bool blockOwnerDeletion = default(bool), string apiVersion = default(string), string name = default(string), string kind = default(string), string uid = default(string))
        {
