...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1OwnerReference :  IEquatable<JsonV1OwnerReference>, IValidatableObject
    {
        ...
        public JsonV1OwnerReference(string kind = default(string), string uid = default(string), string name = default(string), string apiVersion = default(string), bool blockOwnerDeletion = default(bool), bool controller = default(bool))
        {
            this.Kind = kind;
            this.Uid = uid;
            this.Name = name;
