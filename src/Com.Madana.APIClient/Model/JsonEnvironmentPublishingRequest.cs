...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironmentPublishingRequest :  IEquatable<JsonEnvironmentPublishingRequest>, IValidatableObject
    {
        ...
        public JsonEnvironmentPublishingRequest(string size = default(string), string content = default(string), string name = default(string), string ipfsPrimaryPeer = default(string), string packages = default(string), string isPublic = default(string), string uuid = default(string), string description = default(string), string ipfsHash = default(string))
        {
            this.Size = size;
