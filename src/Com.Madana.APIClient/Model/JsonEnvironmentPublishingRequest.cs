...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironmentPublishingRequest :  IEquatable<JsonEnvironmentPublishingRequest>, IValidatableObject
    {
        ...
        public JsonEnvironmentPublishingRequest(string isPublic = default(string), string packages = default(string), string size = default(string), string uuid = default(string), string ipfsPrimaryPeer = default(string), string content = default(string), string ipfsHash = default(string), string description = default(string), string name = default(string))
        {
