...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironmentPublishingRequest :  IEquatable<JsonEnvironmentPublishingRequest>, IValidatableObject
    {
        ...
        public JsonEnvironmentPublishingRequest(string size = default(string), string name = default(string), string content = default(string), string ipfsHash = default(string), string description = default(string), string packages = default(string), string isPublic = default(string), string ipfsPrimaryPeer = default(string), string uuid = default(string))
        {
            this.Size = size;
            this.Name = name;
