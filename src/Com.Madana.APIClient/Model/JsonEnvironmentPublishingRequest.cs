...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironmentPublishingRequest :  IEquatable<JsonEnvironmentPublishingRequest>, IValidatableObject
    {
        ...
        public JsonEnvironmentPublishingRequest(string content = default(string), string name = default(string), string ipfsHash = default(string), string isPublic = default(string), string description = default(string), string packages = default(string), string uuid = default(string), string ipfsPrimaryPeer = default(string), string size = default(string))
        {
