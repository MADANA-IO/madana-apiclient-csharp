...
namespace Com.Madana.APIClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class XmlNs0NodeInfoAllOf :  IEquatable<XmlNs0NodeInfoAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="XmlNs0NodeInfoAllOf" /> class.
        /// </summary>
        ...
        public XmlNs0NodeInfoAllOf(string connectionURL = default(string), string cpuFamily = default(string), string cpuFrequency = default(string), int cpuLogicalCount = default(int), string cpuModel = default(string), int cpuPhysicalCores = default(int), string hardwareBaseboard = default(string), string hardwareFirmware = default(string), XmlNs0IPFSSystemInfo ipfsInfo = default(XmlNs0IPFSSystemInfo), string memory = default(string), string operatingSystem = default(string), long operatingSystemUptime = default(long), string owner = default(string), List<string> processors = default(List<string>), string publicKey = default(string), string status = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class XmlNs0NodeInfoAllOf {\n");
        ...
        {
            return this.Equals(input as XmlNs0NodeInfoAllOf);
        }

        /// <summary>
        /// Returns true if XmlNs0NodeInfoAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of XmlNs0NodeInfoAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(XmlNs0NodeInfoAllOf input)
        {
            if (input == null)
                return false;
