...
namespace Com.Madana.APIClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class XmlNs0EnclaveRunningAttestationAllOf :  IEquatable<XmlNs0EnclaveRunningAttestationAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="XmlNs0EnclaveRunningAttestationAllOf" /> class.
        /// </summary>
        /// <param name="enclaveProcess">enclaveProcess.</param>
        /// <param name="nodeInfo">nodeInfo.</param>
        public XmlNs0EnclaveRunningAttestationAllOf(XmlNs0EnclaveProcess enclaveProcess = default(XmlNs0EnclaveProcess), XmlNs0NodeInfo nodeInfo = default(XmlNs0NodeInfo))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class XmlNs0EnclaveRunningAttestationAllOf {\n");
        ...
        {
            return this.Equals(input as XmlNs0EnclaveRunningAttestationAllOf);
        }

        /// <summary>
        /// Returns true if XmlNs0EnclaveRunningAttestationAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of XmlNs0EnclaveRunningAttestationAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(XmlNs0EnclaveRunningAttestationAllOf input)
        {
            if (input == null)
                return false;
