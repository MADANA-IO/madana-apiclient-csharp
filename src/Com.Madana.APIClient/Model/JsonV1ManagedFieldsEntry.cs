...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1ManagedFieldsEntry :  IEquatable<JsonV1ManagedFieldsEntry>, IValidatableObject
    {
        ...
        public JsonV1ManagedFieldsEntry(string fieldsType = default(string), string manager = default(string), string apiVersion = default(string), decimal time = default(decimal), Object fieldsV1 = default(Object), string operation = default(string))
        {
