...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1ManagedFieldsEntry :  IEquatable<JsonV1ManagedFieldsEntry>, IValidatableObject
    {
        ...
        public JsonV1ManagedFieldsEntry(Object fieldsV1 = default(Object), string operation = default(string), string apiVersion = default(string), string manager = default(string), decimal time = default(decimal), string fieldsType = default(string))
        {
