...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1ManagedFieldsEntry :  IEquatable<JsonV1ManagedFieldsEntry>, IValidatableObject
    {
        ...
        public JsonV1ManagedFieldsEntry(string manager = default(string), Object fieldsV1 = default(Object), string operation = default(string), string apiVersion = default(string), string fieldsType = default(string), decimal time = default(decimal))
        {
