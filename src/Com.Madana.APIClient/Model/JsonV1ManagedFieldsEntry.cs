...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1ManagedFieldsEntry :  IEquatable<JsonV1ManagedFieldsEntry>, IValidatableObject
    {
        ...
        public JsonV1ManagedFieldsEntry(string fieldsType = default(string), string manager = default(string), string apiVersion = default(string), string operation = default(string), Object fieldsV1 = default(Object), decimal time = default(decimal))
        {
