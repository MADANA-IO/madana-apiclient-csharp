...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1ManagedFieldsEntry :  IEquatable<JsonV1ManagedFieldsEntry>, IValidatableObject
    {
        ...
        public JsonV1ManagedFieldsEntry(string operation = default(string), string fieldsType = default(string), Object fieldsV1 = default(Object), string apiVersion = default(string), string manager = default(string), decimal time = default(decimal))
        {
