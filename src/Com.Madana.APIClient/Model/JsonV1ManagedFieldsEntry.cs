...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1ManagedFieldsEntry :  IEquatable<JsonV1ManagedFieldsEntry>, IValidatableObject
    {
        ...
        public JsonV1ManagedFieldsEntry(decimal time = default(decimal), string fieldsType = default(string), string apiVersion = default(string), string operation = default(string), Object fieldsV1 = default(Object), string manager = default(string))
        {
            this.Time = time;
