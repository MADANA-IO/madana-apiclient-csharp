...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1ManagedFieldsEntry :  IEquatable<JsonV1ManagedFieldsEntry>, IValidatableObject
    {
        ...
        public JsonV1ManagedFieldsEntry(string apiVersion = default(string), Object fieldsV1 = default(Object), decimal time = default(decimal), string manager = default(string), string operation = default(string), string fieldsType = default(string))
        {
