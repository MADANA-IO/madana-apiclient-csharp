...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1ManagedFieldsEntry :  IEquatable<JsonV1ManagedFieldsEntry>, IValidatableObject
    {
        ...
        public JsonV1ManagedFieldsEntry(string operation = default(string), string fieldsType = default(string), decimal time = default(decimal), string manager = default(string), Object fieldsV1 = default(Object), string apiVersion = default(string))
        {
