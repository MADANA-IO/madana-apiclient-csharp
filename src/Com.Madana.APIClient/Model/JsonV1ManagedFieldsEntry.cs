...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1ManagedFieldsEntry :  IEquatable<JsonV1ManagedFieldsEntry>, IValidatableObject
    {
        ...
        public JsonV1ManagedFieldsEntry(decimal time = default(decimal), string apiVersion = default(string), string operation = default(string), string manager = default(string), Object fieldsV1 = default(Object), string fieldsType = default(string))
        {
            this.Time = time;
