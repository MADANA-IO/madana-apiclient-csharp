...
namespace Com.Madana.APIClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class JsonEnclaveRunningAttestationApproval :  IEquatable<JsonEnclaveRunningAttestationApproval>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JsonEnclaveRunningAttestationApproval" /> class.
        /// </summary>
        /// <param name="enclaveProcess">enclaveProcess.</param>
        /// <param name="nodeInfo">nodeInfo.</param>
        /// <param name="approved">approved.</param>
        public JsonEnclaveRunningAttestationApproval(JsonEnclaveProcess enclaveProcess = default(JsonEnclaveProcess), JsonNodeInfo nodeInfo = default(JsonNodeInfo), string approved = default(string))
        {
        ...
        public JsonEnclaveProcess EnclaveProcess { get; set; }

        /// <summary>
        /// Gets or Sets NodeInfo
        /// </summary>
        [DataMember(Name="nodeInfo", EmitDefaultValue=false)]
        public JsonNodeInfo NodeInfo { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class JsonEnclaveRunningAttestationApproval {\n");
        ...
        {
            return this.Equals(input as JsonEnclaveRunningAttestationApproval);
        }

        /// <summary>
        /// Returns true if JsonEnclaveRunningAttestationApproval instances are equal
        /// </summary>
        /// <param name="input">Instance of JsonEnclaveRunningAttestationApproval to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JsonEnclaveRunningAttestationApproval input)
        {
            if (input == null)
                return false;
