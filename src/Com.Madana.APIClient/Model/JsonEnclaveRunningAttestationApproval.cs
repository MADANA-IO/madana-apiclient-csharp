...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnclaveRunningAttestationApproval :  IEquatable<JsonEnclaveRunningAttestationApproval>, IValidatableObject
    {
        ...
        public JsonEnclaveRunningAttestationApproval(JsonNodeInfo nodeInfo = default(JsonNodeInfo), JsonEnclaveProcess enclaveProcess = default(JsonEnclaveProcess), string approved = default(string))
        {
