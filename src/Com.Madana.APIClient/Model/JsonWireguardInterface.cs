...
namespace Com.Madana.APIClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class JsonWireguardInterface :  IEquatable<JsonWireguardInterface>, IValidatableObject
    {
        /// <summary>
        ...
        public JsonWireguardInterface(string name = default(string), string address = default(string), string port = default(string))
        {
            this.Name = name;
