...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1ListMeta :  IEquatable<JsonV1ListMeta>, IValidatableObject
    {
        ...
        public JsonV1ListMeta(decimal remainingItemCount = default(decimal), string selfLink = default(string), string resourceVersion = default(string), string _continue = default(string))
        {
