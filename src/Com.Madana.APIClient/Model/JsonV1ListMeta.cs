...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1ListMeta :  IEquatable<JsonV1ListMeta>, IValidatableObject
    {
        ...
        public JsonV1ListMeta(string selfLink = default(string), string _continue = default(string), string resourceVersion = default(string), decimal remainingItemCount = default(decimal))
        {
