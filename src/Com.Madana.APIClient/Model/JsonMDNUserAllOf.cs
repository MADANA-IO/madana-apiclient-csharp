...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonMDNUserAllOf :  IEquatable<JsonMDNUserAllOf>, IValidatableObject
    {
        ...
        public JsonMDNUserAllOf(string mail = default(string), string guid = default(string), List<JsonMDNSocialUserObject> socialAccounts = default(List<JsonMDNSocialUserObject>), string firstName = default(string), List<JsonMDNUserSetting> settings = default(List<JsonMDNUserSetting>), JsonMDNUserCredentials credentials = default(JsonMDNUserCredentials), string lastName = default(string))
        {
            this.Mail = mail;
            this.Guid = guid;
