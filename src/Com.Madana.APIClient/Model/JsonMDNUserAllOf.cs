...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonMDNUserAllOf :  IEquatable<JsonMDNUserAllOf>, IValidatableObject
    {
        ...
        public JsonMDNUserAllOf(List<JsonMDNSocialUserObject> socialAccounts = default(List<JsonMDNSocialUserObject>), string mail = default(string), string lastName = default(string), JsonMDNUserCredentials credentials = default(JsonMDNUserCredentials), string guid = default(string), List<JsonMDNUserSetting> settings = default(List<JsonMDNUserSetting>), string firstName = default(string))
        {
