...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonMDNUserAllOf :  IEquatable<JsonMDNUserAllOf>, IValidatableObject
    {
        ...
        public JsonMDNUserAllOf(string firstName = default(string), string mail = default(string), string lastName = default(string), List<JsonMDNSocialUserObject> socialAccounts = default(List<JsonMDNSocialUserObject>), string guid = default(string), JsonMDNUserCredentials credentials = default(JsonMDNUserCredentials), List<JsonMDNUserSetting> settings = default(List<JsonMDNUserSetting>))
        {
