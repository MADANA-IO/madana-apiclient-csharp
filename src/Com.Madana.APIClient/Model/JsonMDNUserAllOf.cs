...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonMDNUserAllOf :  IEquatable<JsonMDNUserAllOf>, IValidatableObject
    {
        ...
        public JsonMDNUserAllOf(string lastName = default(string), string mail = default(string), List<JsonMDNSocialUserObject> socialAccounts = default(List<JsonMDNSocialUserObject>), string firstName = default(string), JsonMDNUserCredentials credentials = default(JsonMDNUserCredentials), string guid = default(string), List<JsonMDNUserSetting> settings = default(List<JsonMDNUserSetting>))
        {
