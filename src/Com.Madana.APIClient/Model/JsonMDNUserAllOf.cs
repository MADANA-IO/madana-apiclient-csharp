...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonMDNUserAllOf :  IEquatable<JsonMDNUserAllOf>, IValidatableObject
    {
        ...
        public JsonMDNUserAllOf(string firstName = default(string), List<JsonMDNSocialUserObject> socialAccounts = default(List<JsonMDNSocialUserObject>), string lastName = default(string), JsonMDNUserCredentials credentials = default(JsonMDNUserCredentials), List<JsonMDNUserSetting> settings = default(List<JsonMDNUserSetting>), string mail = default(string), string guid = default(string))
        {
