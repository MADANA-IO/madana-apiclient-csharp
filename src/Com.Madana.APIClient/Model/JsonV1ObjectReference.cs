...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1ObjectReference :  IEquatable<JsonV1ObjectReference>, IValidatableObject
    {
        ...
        public JsonV1ObjectReference(string apiVersion = default(string), string resourceVersion = default(string), string _namespace = default(string), string kind = default(string), string uid = default(string), string name = default(string), string fieldPath = default(string))
        {
