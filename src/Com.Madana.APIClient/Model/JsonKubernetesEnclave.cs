...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonKubernetesEnclave :  IEquatable<JsonKubernetesEnclave>, IValidatableObject
    {
        ...
        public JsonKubernetesEnclave(List<JsonEnclavePort> ports = default(List<JsonEnclavePort>), JsonWireguardInterface wgInterface = default(JsonWireguardInterface), string consoleOutput = default(string), string startupTime = default(string), string wireguardServer = default(string), string endingTime = default(string), Dictionary<string, string> portMapping = default(Dictionary<string, string>), string enclaveIdent = default(string), string publicIdent = default(string), string remoteControlServer = default(string), string wireguardPublicKey = default(string), JsonKubernetesEnclave kubernetesEnclave = default(JsonKubernetesEnclave), string internalAttesationServer = default(string), JsonEnvironment environment = default(JsonEnvironment), JsonProcess process = default(JsonProcess), string internalWireguardServer = default(string), string startupCMD = default(string), string internalRemoteControlServer = default(string), string status = default(string), string internalIdent = default(string), string signerIdent = default(string), string attestationServer = default(string), Object enclaveInputstream = default(Object), string remoteControlIP = default(string), JsonV1EventList enclaveReplicaSetEvents = default(JsonV1EventList), JsonV1EventList enclaveDeploymentEvents = default(JsonV1EventList), string podPhase = default(string), string debugInfo = default(string), int wireguardPort = default(int), JsonV1EventList enclavePodEvents = default(JsonV1EventList), bool isUsingInitContainer = default(bool), int attestationPort = default(int))
        {
            this.Ports = ports;
