...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonKubernetesEnclave :  IEquatable<JsonKubernetesEnclave>, IValidatableObject
    {
        ...
        public JsonKubernetesEnclave(string attestationServer = default(string), Dictionary<string, string> portMapping = default(Dictionary<string, string>), List<JsonEnclavePort> ports = default(List<JsonEnclavePort>), string startupTime = default(string), string status = default(string), string internalIdent = default(string), string startupCMD = default(string), string enclaveIdent = default(string), JsonEnvironment environment = default(JsonEnvironment), string publicIdent = default(string), string consoleOutput = default(string), string internalWireguardServer = default(string), string internalAttesationServer = default(string), JsonProcess process = default(JsonProcess), string internalRemoteControlServer = default(string), string signerIdent = default(string), JsonWireguardInterface wgInterface = default(JsonWireguardInterface), string wireguardServer = default(string), string remoteControlServer = default(string), string wireguardPublicKey = default(string), string endingTime = default(string), JsonKubernetesEnclave kubernetesEnclave = default(JsonKubernetesEnclave), Object enclaveInputstream = default(Object), int wireguardPort = default(int), string podPhase = default(string), JsonV1EventList enclavePodEvents = default(JsonV1EventList), string debugInfo = default(string), int attestationPort = default(int), JsonV1EventList enclaveDeploymentEvents = default(JsonV1EventList), JsonV1EventList enclaveReplicaSetEvents = default(JsonV1EventList), string remoteControlIP = default(string), bool isUsingInitContainer = default(bool))
        {
