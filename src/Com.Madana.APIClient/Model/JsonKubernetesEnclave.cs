...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonKubernetesEnclave :  IEquatable<JsonKubernetesEnclave>, IValidatableObject
    {
        ...
        public JsonKubernetesEnclave(string signerIdent = default(string), string attestationServer = default(string), Dictionary<string, string> portMapping = default(Dictionary<string, string>), string status = default(string), JsonEnvironment environment = default(JsonEnvironment), string startupCMD = default(string), List<JsonEnclavePort> ports = default(List<JsonEnclavePort>), string internalIdent = default(string), JsonWireguardInterface wgInterface = default(JsonWireguardInterface), string wireguardPublicKey = default(string), string publicIdent = default(string), JsonProcess process = default(JsonProcess), string wireguardServer = default(string), string internalRemoteControlServer = default(string), string endingTime = default(string), string consoleOutput = default(string), Object enclaveInputstream = default(Object), string startupTime = default(string), string enclaveIdent = default(string), string internalWireguardServer = default(string), string internalAttesationServer = default(string), string remoteControlServer = default(string), JsonKubernetesEnclave kubernetesEnclave = default(JsonKubernetesEnclave), bool isUsingInitContainer = default(bool), string podPhase = default(string), string debugInfo = default(string), JsonV1EventList enclaveDeploymentEvents = default(JsonV1EventList), JsonV1EventList enclavePodEvents = default(JsonV1EventList), int wireguardPort = default(int), int attestationPort = default(int), JsonV1EventList enclaveReplicaSetEvents = default(JsonV1EventList), string remoteControlIP = default(string))
        {
