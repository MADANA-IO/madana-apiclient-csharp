...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonKubernetesEnclave :  IEquatable<JsonKubernetesEnclave>, IValidatableObject
    {
        ...
        public JsonKubernetesEnclave(JsonKubernetesEnclave kubernetesEnclave = default(JsonKubernetesEnclave), string status = default(string), Object enclaveInputstream = default(Object), string startupTime = default(string), string internalIdent = default(string), string wireguardPublicKey = default(string), string attestationServer = default(string), string enclaveIdent = default(string), JsonWireguardInterface wgInterface = default(JsonWireguardInterface), string publicIdent = default(string), string endingTime = default(string), JsonProcess process = default(JsonProcess), string consoleOutput = default(string), string internalAttesationServer = default(string), string wireguardServer = default(string), Dictionary<string, string> portMapping = default(Dictionary<string, string>), string startupCMD = default(string), JsonEnvironment environment = default(JsonEnvironment), string signerIdent = default(string), List<JsonEnclavePort> ports = default(List<JsonEnclavePort>), string remoteControlServer = default(string), string internalWireguardServer = default(string), string internalRemoteControlServer = default(string), JsonV1EventList enclaveReplicaSetEvents = default(JsonV1EventList), string remoteControlIP = default(string), JsonV1EventList enclaveDeploymentEvents = default(JsonV1EventList), string debugInfo = default(string), int attestationPort = default(int), string podPhase = default(string), JsonV1EventList enclavePodEvents = default(JsonV1EventList), bool isUsingInitContainer = default(bool), int wireguardPort = default(int))
        {
