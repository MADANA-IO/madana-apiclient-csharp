...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonKubernetesEnclave :  IEquatable<JsonKubernetesEnclave>, IValidatableObject
    {
        ...
        public JsonKubernetesEnclave(string publicIdent = default(string), string enclaveIdent = default(string), Object enclaveInputstream = default(Object), JsonKubernetesEnclave kubernetesEnclave = default(JsonKubernetesEnclave), Dictionary<string, string> portMapping = default(Dictionary<string, string>), string status = default(string), string startupCMD = default(string), JsonProcess process = default(JsonProcess), string consoleOutput = default(string), string endingTime = default(string), string signerIdent = default(string), string remoteControlServer = default(string), string internalIdent = default(string), string internalRemoteControlServer = default(string), JsonWireguardInterface wgInterface = default(JsonWireguardInterface), string attestationServer = default(string), string startupTime = default(string), JsonEnvironment environment = default(JsonEnvironment), string internalWireguardServer = default(string), string wireguardPublicKey = default(string), string internalAttesationServer = default(string), List<JsonEnclavePort> ports = default(List<JsonEnclavePort>), string wireguardServer = default(string), int wireguardPort = default(int), JsonV1EventList enclaveReplicaSetEvents = default(JsonV1EventList), bool isUsingInitContainer = default(bool), JsonV1EventList enclaveDeploymentEvents = default(JsonV1EventList), string remoteControlIP = default(string), JsonV1EventList enclavePodEvents = default(JsonV1EventList), int attestationPort = default(int), string podPhase = default(string), string debugInfo = default(string))
        {
