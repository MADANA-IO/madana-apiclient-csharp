...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonKubernetesEnclave :  IEquatable<JsonKubernetesEnclave>, IValidatableObject
    {
        ...
        public JsonKubernetesEnclave(JsonWireguardInterface wgInterface = default(JsonWireguardInterface), JsonEnvironment environment = default(JsonEnvironment), string startupCMD = default(string), string internalRemoteControlServer = default(string), string consoleOutput = default(string), string endingTime = default(string), string startupTime = default(string), string remoteControlServer = default(string), List<JsonEnclavePort> ports = default(List<JsonEnclavePort>), JsonKubernetesEnclave kubernetesEnclave = default(JsonKubernetesEnclave), string wireguardServer = default(string), string internalWireguardServer = default(string), string status = default(string), string wireguardPublicKey = default(string), string enclaveIdent = default(string), string internalIdent = default(string), string publicIdent = default(string), JsonProcess process = default(JsonProcess), string internalAttesationServer = default(string), string signerIdent = default(string), Object enclaveInputstream = default(Object), string attestationServer = default(string), Dictionary<string, string> portMapping = default(Dictionary<string, string>), JsonV1EventList enclaveReplicaSetEvents = default(JsonV1EventList), int wireguardPort = default(int), int attestationPort = default(int), JsonV1EventList enclaveDeploymentEvents = default(JsonV1EventList), JsonV1EventList enclavePodEvents = default(JsonV1EventList), bool isUsingInitContainer = default(bool), string podPhase = default(string), string debugInfo = default(string), string remoteControlIP = default(string))
        {
