...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonKubernetesEnclave :  IEquatable<JsonKubernetesEnclave>, IValidatableObject
    {
        ...
        public JsonKubernetesEnclave(string attestationServer = default(string), string startupTime = default(string), string wireguardPublicKey = default(string), string wireguardServer = default(string), string status = default(string), string internalIdent = default(string), JsonEnvironment environment = default(JsonEnvironment), string signerIdent = default(string), string remoteControlServer = default(string), string internalWireguardServer = default(string), string startupCMD = default(string), JsonWireguardInterface wgInterface = default(JsonWireguardInterface), string endingTime = default(string), JsonKubernetesEnclave kubernetesEnclave = default(JsonKubernetesEnclave), List<JsonEnclavePort> ports = default(List<JsonEnclavePort>), string internalAttesationServer = default(string), string consoleOutput = default(string), JsonProcess process = default(JsonProcess), Object enclaveInputstream = default(Object), string internalRemoteControlServer = default(string), Dictionary<string, string> portMapping = default(Dictionary<string, string>), string publicIdent = default(string), string enclaveIdent = default(string), JsonV1EventList enclaveReplicaSetEvents = default(JsonV1EventList), JsonV1EventList enclaveDeploymentEvents = default(JsonV1EventList), JsonV1EventList enclavePodEvents = default(JsonV1EventList), bool isUsingInitContainer = default(bool), int attestationPort = default(int), int wireguardPort = default(int), string remoteControlIP = default(string), string debugInfo = default(string), string podPhase = default(string))
        {
