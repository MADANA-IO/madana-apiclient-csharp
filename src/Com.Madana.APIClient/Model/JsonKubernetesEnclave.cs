...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonKubernetesEnclave :  IEquatable<JsonKubernetesEnclave>, IValidatableObject
    {
        ...
        public JsonKubernetesEnclave(JsonEnvironment environment = default(JsonEnvironment), string signerIdent = default(string), string status = default(string), string consoleOutput = default(string), string attestationServer = default(string), Object enclaveInputstream = default(Object), string endingTime = default(string), string publicIdent = default(string), string internalWireguardServer = default(string), string internalRemoteControlServer = default(string), JsonProcess process = default(JsonProcess), JsonWireguardInterface wgInterface = default(JsonWireguardInterface), string wireguardServer = default(string), string wireguardPublicKey = default(string), string internalIdent = default(string), string remoteControlServer = default(string), string startupTime = default(string), string startupCMD = default(string), string internalAttesationServer = default(string), Dictionary<string, string> portMapping = default(Dictionary<string, string>), JsonKubernetesEnclave kubernetesEnclave = default(JsonKubernetesEnclave), List<JsonEnclavePort> ports = default(List<JsonEnclavePort>), string enclaveIdent = default(string), string remoteControlIP = default(string), JsonV1EventList enclaveReplicaSetEvents = default(JsonV1EventList), string podPhase = default(string), JsonV1EventList enclaveDeploymentEvents = default(JsonV1EventList), JsonV1EventList enclavePodEvents = default(JsonV1EventList), string debugInfo = default(string), bool isUsingInitContainer = default(bool), int attestationPort = default(int), int wireguardPort = default(int))
        {
