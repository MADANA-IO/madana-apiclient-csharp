...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonKubernetesEnclave :  IEquatable<JsonKubernetesEnclave>, IValidatableObject
    {
        ...
        public JsonKubernetesEnclave(string publicIdent = default(string), string internalIdent = default(string), string internalAttesationServer = default(string), List<JsonEnclavePort> ports = default(List<JsonEnclavePort>), string startupTime = default(string), JsonKubernetesEnclave kubernetesEnclave = default(JsonKubernetesEnclave), string status = default(string), Dictionary<string, string> portMapping = default(Dictionary<string, string>), string remoteControlServer = default(string), JsonWireguardInterface wgInterface = default(JsonWireguardInterface), string internalRemoteControlServer = default(string), string wireguardServer = default(string), string internalWireguardServer = default(string), Object enclaveInputstream = default(Object), string startupCMD = default(string), JsonEnvironment environment = default(JsonEnvironment), string attestationServer = default(string), string consoleOutput = default(string), string wireguardPublicKey = default(string), string enclaveIdent = default(string), string endingTime = default(string), JsonProcess process = default(JsonProcess), string signerIdent = default(string), string podPhase = default(string), JsonV1EventList enclaveDeploymentEvents = default(JsonV1EventList), bool isUsingInitContainer = default(bool), JsonV1EventList enclaveReplicaSetEvents = default(JsonV1EventList), int wireguardPort = default(int), JsonV1EventList enclavePodEvents = default(JsonV1EventList), string remoteControlIP = default(string), string debugInfo = default(string), int attestationPort = default(int))
        {
