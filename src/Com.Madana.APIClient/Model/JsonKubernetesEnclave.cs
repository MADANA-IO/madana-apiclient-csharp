...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonKubernetesEnclave :  IEquatable<JsonKubernetesEnclave>, IValidatableObject
    {
        ...
        public JsonKubernetesEnclave(string startupCMD = default(string), Object enclaveInputstream = default(Object), string remoteControlServer = default(string), string internalIdent = default(string), string consoleOutput = default(string), string status = default(string), string internalAttesationServer = default(string), JsonWireguardInterface wgInterface = default(JsonWireguardInterface), string internalWireguardServer = default(string), string startupTime = default(string), string internalRemoteControlServer = default(string), List<JsonEnclavePort> ports = default(List<JsonEnclavePort>), Dictionary<string, string> portMapping = default(Dictionary<string, string>), string signerIdent = default(string), JsonEnvironment environment = default(JsonEnvironment), string wireguardPublicKey = default(string), string endingTime = default(string), JsonKubernetesEnclave kubernetesEnclave = default(JsonKubernetesEnclave), string enclaveIdent = default(string), JsonProcess process = default(JsonProcess), string publicIdent = default(string), string attestationServer = default(string), string wireguardServer = default(string), int wireguardPort = default(int), int attestationPort = default(int), bool isUsingInitContainer = default(bool), string debugInfo = default(string), JsonV1EventList enclaveDeploymentEvents = default(JsonV1EventList), string remoteControlIP = default(string), JsonV1EventList enclavePodEvents = default(JsonV1EventList), string podPhase = default(string), JsonV1EventList enclaveReplicaSetEvents = default(JsonV1EventList))
        {
