...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonKubernetesEnclave :  IEquatable<JsonKubernetesEnclave>, IValidatableObject
    {
        ...
        public JsonKubernetesEnclave(Object enclaveInputstream = default(Object), JsonEnvironment environment = default(JsonEnvironment), JsonWireguardInterface wgInterface = default(JsonWireguardInterface), string internalIdent = default(string), JsonProcess process = default(JsonProcess), string startupTime = default(string), string consoleOutput = default(string), List<JsonEnclavePort> ports = default(List<JsonEnclavePort>), string wireguardPublicKey = default(string), JsonKubernetesEnclave kubernetesEnclave = default(JsonKubernetesEnclave), string publicIdent = default(string), Dictionary<string, string> portMapping = default(Dictionary<string, string>), string attestationServer = default(string), string wireguardServer = default(string), string endingTime = default(string), string internalWireguardServer = default(string), string status = default(string), string remoteControlServer = default(string), string startupCMD = default(string), string signerIdent = default(string), string internalAttesationServer = default(string), string internalRemoteControlServer = default(string), string enclaveIdent = default(string), int wireguardPort = default(int), JsonV1EventList enclaveReplicaSetEvents = default(JsonV1EventList), string podPhase = default(string), string remoteControlIP = default(string), JsonV1EventList enclaveDeploymentEvents = default(JsonV1EventList), bool isUsingInitContainer = default(bool), string debugInfo = default(string), int attestationPort = default(int), JsonV1EventList enclavePodEvents = default(JsonV1EventList))
        {
