...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonKubernetesEnclave :  IEquatable<JsonKubernetesEnclave>, IValidatableObject
    {
        ...
        public JsonKubernetesEnclave(JsonWireguardInterface wgInterface = default(JsonWireguardInterface), string signerIdent = default(string), JsonEnvironment environment = default(JsonEnvironment), JsonKubernetesEnclave kubernetesEnclave = default(JsonKubernetesEnclave), string internalWireguardServer = default(string), string publicIdent = default(string), string status = default(string), string attestationServer = default(string), Object enclaveInputstream = default(Object), string internalRemoteControlServer = default(string), string startupCMD = default(string), Dictionary<string, string> portMapping = default(Dictionary<string, string>), string startupTime = default(string), string wireguardServer = default(string), string internalIdent = default(string), string enclaveIdent = default(string), string internalAttesationServer = default(string), string consoleOutput = default(string), string endingTime = default(string), string wireguardPublicKey = default(string), JsonProcess process = default(JsonProcess), string remoteControlServer = default(string), List<JsonEnclavePort> ports = default(List<JsonEnclavePort>), string remoteControlIP = default(string), string debugInfo = default(string), JsonV1EventList enclaveReplicaSetEvents = default(JsonV1EventList), int attestationPort = default(int), bool isUsingInitContainer = default(bool), int wireguardPort = default(int), JsonV1EventList enclaveDeploymentEvents = default(JsonV1EventList), JsonV1EventList enclavePodEvents = default(JsonV1EventList), string podPhase = default(string))
        {
