...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonKubernetesEnclave :  IEquatable<JsonKubernetesEnclave>, IValidatableObject
    {
        ...
        public JsonKubernetesEnclave(string internalRemoteControlServer = default(string), string internalWireguardServer = default(string), string enclaveIdent = default(string), string attestationServer = default(string), string consoleOutput = default(string), Dictionary<string, string> portMapping = default(Dictionary<string, string>), List<JsonEnclavePort> ports = default(List<JsonEnclavePort>), string remoteControlServer = default(string), string signerIdent = default(string), JsonWireguardInterface wgInterface = default(JsonWireguardInterface), string startupTime = default(string), string internalAttesationServer = default(string), JsonKubernetesEnclave kubernetesEnclave = default(JsonKubernetesEnclave), JsonEnvironment environment = default(JsonEnvironment), string internalIdent = default(string), string startupCMD = default(string), Object enclaveInputstream = default(Object), string endingTime = default(string), string wireguardPublicKey = default(string), string publicIdent = default(string), string wireguardServer = default(string), JsonProcess process = default(JsonProcess), string status = default(string), int attestationPort = default(int), JsonV1EventList enclaveDeploymentEvents = default(JsonV1EventList), JsonV1EventList enclavePodEvents = default(JsonV1EventList), bool isUsingInitContainer = default(bool), int wireguardPort = default(int), JsonV1EventList enclaveReplicaSetEvents = default(JsonV1EventList), string debugInfo = default(string), string podPhase = default(string), string remoteControlIP = default(string))
        {
