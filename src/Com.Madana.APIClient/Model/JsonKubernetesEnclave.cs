...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonKubernetesEnclave :  IEquatable<JsonKubernetesEnclave>, IValidatableObject
    {
        ...
        public JsonKubernetesEnclave(JsonEnvironment environment = default(JsonEnvironment), string signerIdent = default(string), JsonProcess process = default(JsonProcess), string enclaveIdent = default(string), Object enclaveInputstream = default(Object), string internalWireguardServer = default(string), string consoleOutput = default(string), string internalAttesationServer = default(string), string publicIdent = default(string), Dictionary<string, string> portMapping = default(Dictionary<string, string>), string internalRemoteControlServer = default(string), string remoteControlServer = default(string), string endingTime = default(string), string wireguardPublicKey = default(string), string status = default(string), string startupTime = default(string), JsonKubernetesEnclave kubernetesEnclave = default(JsonKubernetesEnclave), JsonWireguardInterface wgInterface = default(JsonWireguardInterface), string startupCMD = default(string), string attestationServer = default(string), List<JsonEnclavePort> ports = default(List<JsonEnclavePort>), string wireguardServer = default(string), string internalIdent = default(string), JsonV1EventList enclaveReplicaSetEvents = default(JsonV1EventList), int wireguardPort = default(int), bool isUsingInitContainer = default(bool), string podPhase = default(string), JsonV1EventList enclaveDeploymentEvents = default(JsonV1EventList), JsonV1EventList enclavePodEvents = default(JsonV1EventList), string remoteControlIP = default(string), int attestationPort = default(int), string debugInfo = default(string))
        {
