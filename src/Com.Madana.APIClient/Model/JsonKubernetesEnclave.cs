...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonKubernetesEnclave :  IEquatable<JsonKubernetesEnclave>, IValidatableObject
    {
        ...
        public JsonKubernetesEnclave(string wireguardServer = default(string), string status = default(string), string enclaveIdent = default(string), JsonEnvironment environment = default(JsonEnvironment), string attestationServer = default(string), JsonProcess process = default(JsonProcess), string internalWireguardServer = default(string), string remoteControlServer = default(string), string internalAttesationServer = default(string), JsonWireguardInterface wgInterface = default(JsonWireguardInterface), Dictionary<string, string> portMapping = default(Dictionary<string, string>), string endingTime = default(string), string publicIdent = default(string), string wireguardPublicKey = default(string), string internalRemoteControlServer = default(string), JsonKubernetesEnclave kubernetesEnclave = default(JsonKubernetesEnclave), string startupTime = default(string), string internalIdent = default(string), List<JsonEnclavePort> ports = default(List<JsonEnclavePort>), string signerIdent = default(string), string consoleOutput = default(string), string startupCMD = default(string), Object enclaveInputstream = default(Object), string podPhase = default(string), int wireguardPort = default(int), string remoteControlIP = default(string), JsonV1EventList enclavePodEvents = default(JsonV1EventList), string debugInfo = default(string), JsonV1EventList enclaveReplicaSetEvents = default(JsonV1EventList), JsonV1EventList enclaveDeploymentEvents = default(JsonV1EventList), bool isUsingInitContainer = default(bool), int attestationPort = default(int))
        {
