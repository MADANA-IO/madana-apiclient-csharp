...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonKubernetesEnclave :  IEquatable<JsonKubernetesEnclave>, IValidatableObject
    {
        ...
        public JsonKubernetesEnclave(JsonEnvironment environment = default(JsonEnvironment), string startupTime = default(string), string internalAttesationServer = default(string), List<JsonEnclavePort> ports = default(List<JsonEnclavePort>), Object enclaveInputstream = default(Object), JsonKubernetesEnclave kubernetesEnclave = default(JsonKubernetesEnclave), string internalRemoteControlServer = default(string), string signerIdent = default(string), JsonProcess process = default(JsonProcess), string attestationServer = default(string), Dictionary<string, string> portMapping = default(Dictionary<string, string>), string consoleOutput = default(string), string wireguardPublicKey = default(string), string status = default(string), string publicIdent = default(string), string remoteControlServer = default(string), string startupCMD = default(string), string internalIdent = default(string), JsonWireguardInterface wgInterface = default(JsonWireguardInterface), string internalWireguardServer = default(string), string wireguardServer = default(string), string enclaveIdent = default(string), string endingTime = default(string), int attestationPort = default(int), string debugInfo = default(string), string remoteControlIP = default(string), bool isUsingInitContainer = default(bool), int wireguardPort = default(int), JsonV1EventList enclaveDeploymentEvents = default(JsonV1EventList), JsonV1EventList enclavePodEvents = default(JsonV1EventList), string podPhase = default(string), JsonV1EventList enclaveReplicaSetEvents = default(JsonV1EventList))
        {
