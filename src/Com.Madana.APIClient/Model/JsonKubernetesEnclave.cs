...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonKubernetesEnclave :  IEquatable<JsonKubernetesEnclave>, IValidatableObject
    {
        ...
        public JsonKubernetesEnclave(string enclaveIdent = default(string), string internalWireguardServer = default(string), JsonProcess process = default(JsonProcess), string signerIdent = default(string), List<JsonEnclavePort> ports = default(List<JsonEnclavePort>), Object enclaveInputstream = default(Object), string remoteControlServer = default(string), string endingTime = default(string), string consoleOutput = default(string), string internalRemoteControlServer = default(string), string attestationServer = default(string), Dictionary<string, string> portMapping = default(Dictionary<string, string>), string internalIdent = default(string), JsonKubernetesEnclave kubernetesEnclave = default(JsonKubernetesEnclave), string status = default(string), string publicIdent = default(string), string startupTime = default(string), JsonEnvironment environment = default(JsonEnvironment), JsonWireguardInterface wgInterface = default(JsonWireguardInterface), string startupCMD = default(string), string wireguardServer = default(string), string internalAttesationServer = default(string), string wireguardPublicKey = default(string), JsonV1EventList enclavePodEvents = default(JsonV1EventList), JsonV1EventList enclaveDeploymentEvents = default(JsonV1EventList), string debugInfo = default(string), int attestationPort = default(int), string remoteControlIP = default(string), int wireguardPort = default(int), bool isUsingInitContainer = default(bool), string podPhase = default(string), JsonV1EventList enclaveReplicaSetEvents = default(JsonV1EventList))
        {
