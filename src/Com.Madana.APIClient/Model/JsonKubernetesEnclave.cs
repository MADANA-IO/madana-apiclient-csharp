...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonKubernetesEnclave :  IEquatable<JsonKubernetesEnclave>, IValidatableObject
    {
        ...
        public JsonKubernetesEnclave(string consoleOutput = default(string), List<JsonEnclavePort> ports = default(List<JsonEnclavePort>), string internalIdent = default(string), Object enclaveInputstream = default(Object), string remoteControlServer = default(string), string publicIdent = default(string), string startupTime = default(string), JsonKubernetesEnclave kubernetesEnclave = default(JsonKubernetesEnclave), string internalWireguardServer = default(string), string internalAttesationServer = default(string), string enclaveIdent = default(string), string wireguardServer = default(string), string internalRemoteControlServer = default(string), string wireguardPublicKey = default(string), JsonEnvironment environment = default(JsonEnvironment), string signerIdent = default(string), string startupCMD = default(string), JsonProcess process = default(JsonProcess), Dictionary<string, string> portMapping = default(Dictionary<string, string>), string status = default(string), string attestationServer = default(string), string endingTime = default(string), JsonWireguardInterface wgInterface = default(JsonWireguardInterface), string podPhase = default(string), JsonV1EventList enclaveReplicaSetEvents = default(JsonV1EventList), JsonV1EventList enclaveDeploymentEvents = default(JsonV1EventList), int attestationPort = default(int), bool isUsingInitContainer = default(bool), int wireguardPort = default(int), string remoteControlIP = default(string), string debugInfo = default(string), JsonV1EventList enclavePodEvents = default(JsonV1EventList))
        {
