...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonKubernetesEnclave :  IEquatable<JsonKubernetesEnclave>, IValidatableObject
    {
        ...
        public JsonKubernetesEnclave(string internalRemoteControlServer = default(string), string wireguardServer = default(string), string endingTime = default(string), List<JsonEnclavePort> ports = default(List<JsonEnclavePort>), string publicIdent = default(string), string internalWireguardServer = default(string), JsonEnvironment environment = default(JsonEnvironment), string startupCMD = default(string), string internalAttesationServer = default(string), string status = default(string), string remoteControlServer = default(string), string startupTime = default(string), Object enclaveInputstream = default(Object), string wireguardPublicKey = default(string), string internalIdent = default(string), JsonProcess process = default(JsonProcess), string attestationServer = default(string), string signerIdent = default(string), string consoleOutput = default(string), JsonWireguardInterface wgInterface = default(JsonWireguardInterface), string enclaveIdent = default(string), JsonKubernetesEnclave kubernetesEnclave = default(JsonKubernetesEnclave), Dictionary<string, string> portMapping = default(Dictionary<string, string>), int attestationPort = default(int), bool isUsingInitContainer = default(bool), int wireguardPort = default(int), JsonV1EventList enclaveDeploymentEvents = default(JsonV1EventList), JsonV1EventList enclaveReplicaSetEvents = default(JsonV1EventList), string podPhase = default(string), string remoteControlIP = default(string), JsonV1EventList enclavePodEvents = default(JsonV1EventList), string debugInfo = default(string))
        {
