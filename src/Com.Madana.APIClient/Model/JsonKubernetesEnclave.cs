...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonKubernetesEnclave :  IEquatable<JsonKubernetesEnclave>, IValidatableObject
    {
        ...
        public JsonKubernetesEnclave(string startupTime = default(string), JsonEnvironment environment = default(JsonEnvironment), string enclaveIdent = default(string), string wireguardServer = default(string), List<JsonEnclavePort> ports = default(List<JsonEnclavePort>), Object enclaveInputstream = default(Object), string signerIdent = default(string), string endingTime = default(string), string internalRemoteControlServer = default(string), string attestationServer = default(string), string consoleOutput = default(string), string internalIdent = default(string), string status = default(string), JsonKubernetesEnclave kubernetesEnclave = default(JsonKubernetesEnclave), string internalAttesationServer = default(string), string startupCMD = default(string), Dictionary<string, string> portMapping = default(Dictionary<string, string>), JsonProcess process = default(JsonProcess), string wireguardPublicKey = default(string), string remoteControlServer = default(string), JsonWireguardInterface wgInterface = default(JsonWireguardInterface), string internalWireguardServer = default(string), string publicIdent = default(string), JsonV1EventList enclaveReplicaSetEvents = default(JsonV1EventList), bool isUsingInitContainer = default(bool), int attestationPort = default(int), int wireguardPort = default(int), string podPhase = default(string), JsonV1EventList enclavePodEvents = default(JsonV1EventList), JsonV1EventList enclaveDeploymentEvents = default(JsonV1EventList), string remoteControlIP = default(string), string debugInfo = default(string))
        {
