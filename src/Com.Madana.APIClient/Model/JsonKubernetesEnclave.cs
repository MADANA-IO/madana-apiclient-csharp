...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonKubernetesEnclave :  IEquatable<JsonKubernetesEnclave>, IValidatableObject
    {
        ...
        public JsonKubernetesEnclave(string publicIdent = default(string), string remoteControlServer = default(string), JsonEnvironment environment = default(JsonEnvironment), string endingTime = default(string), string attestationServer = default(string), JsonWireguardInterface wgInterface = default(JsonWireguardInterface), string status = default(string), JsonKubernetesEnclave kubernetesEnclave = default(JsonKubernetesEnclave), Dictionary<string, string> portMapping = default(Dictionary<string, string>), string enclaveIdent = default(string), string startupCMD = default(string), string internalWireguardServer = default(string), string signerIdent = default(string), string consoleOutput = default(string), string internalRemoteControlServer = default(string), string internalAttesationServer = default(string), string wireguardServer = default(string), JsonProcess process = default(JsonProcess), string internalIdent = default(string), string wireguardPublicKey = default(string), List<JsonEnclavePort> ports = default(List<JsonEnclavePort>), string startupTime = default(string), Object enclaveInputstream = default(Object), JsonV1EventList enclaveReplicaSetEvents = default(JsonV1EventList), int wireguardPort = default(int), bool isUsingInitContainer = default(bool), JsonV1EventList enclaveDeploymentEvents = default(JsonV1EventList), string podPhase = default(string), JsonV1EventList enclavePodEvents = default(JsonV1EventList), int attestationPort = default(int), string debugInfo = default(string), string remoteControlIP = default(string))
        {
