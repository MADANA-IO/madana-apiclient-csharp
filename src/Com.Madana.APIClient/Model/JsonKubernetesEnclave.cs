...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonKubernetesEnclave :  IEquatable<JsonKubernetesEnclave>, IValidatableObject
    {
        ...
        public JsonKubernetesEnclave(string wireguardServer = default(string), string signerIdent = default(string), string endingTime = default(string), string publicIdent = default(string), string status = default(string), string consoleOutput = default(string), string startupTime = default(string), string enclaveIdent = default(string), JsonProcess process = default(JsonProcess), string internalRemoteControlServer = default(string), string attestationServer = default(string), string remoteControlServer = default(string), Object enclaveInputstream = default(Object), string internalAttesationServer = default(string), JsonEnvironment environment = default(JsonEnvironment), string wireguardPublicKey = default(string), string startupCMD = default(string), JsonWireguardInterface wgInterface = default(JsonWireguardInterface), string internalWireguardServer = default(string), Dictionary<string, string> portMapping = default(Dictionary<string, string>), string internalIdent = default(string), List<JsonEnclavePort> ports = default(List<JsonEnclavePort>), JsonKubernetesEnclave kubernetesEnclave = default(JsonKubernetesEnclave), string debugInfo = default(string), int attestationPort = default(int), string podPhase = default(string), bool isUsingInitContainer = default(bool), JsonV1EventList enclavePodEvents = default(JsonV1EventList), string remoteControlIP = default(string), JsonV1EventList enclaveReplicaSetEvents = default(JsonV1EventList), JsonV1EventList enclaveDeploymentEvents = default(JsonV1EventList), int wireguardPort = default(int))
        {
