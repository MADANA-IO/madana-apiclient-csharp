...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonKubernetesEnclave :  IEquatable<JsonKubernetesEnclave>, IValidatableObject
    {
        ...
        public JsonKubernetesEnclave(string internalWireguardServer = default(string), JsonWireguardInterface wgInterface = default(JsonWireguardInterface), List<JsonEnclavePort> ports = default(List<JsonEnclavePort>), string publicIdent = default(string), string internalAttesationServer = default(string), JsonProcess process = default(JsonProcess), string startupCMD = default(string), string enclaveIdent = default(string), string attestationServer = default(string), string internalRemoteControlServer = default(string), JsonEnvironment environment = default(JsonEnvironment), string signerIdent = default(string), string endingTime = default(string), string consoleOutput = default(string), Dictionary<string, string> portMapping = default(Dictionary<string, string>), string remoteControlServer = default(string), JsonKubernetesEnclave kubernetesEnclave = default(JsonKubernetesEnclave), string wireguardPublicKey = default(string), string wireguardServer = default(string), string internalIdent = default(string), Object enclaveInputstream = default(Object), string status = default(string), string startupTime = default(string), JsonV1EventList enclaveDeploymentEvents = default(JsonV1EventList), bool isUsingInitContainer = default(bool), int wireguardPort = default(int), string debugInfo = default(string), string podPhase = default(string), string remoteControlIP = default(string), JsonV1EventList enclaveReplicaSetEvents = default(JsonV1EventList), int attestationPort = default(int), JsonV1EventList enclavePodEvents = default(JsonV1EventList))
        {
