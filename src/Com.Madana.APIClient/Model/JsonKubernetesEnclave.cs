...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonKubernetesEnclave :  IEquatable<JsonKubernetesEnclave>, IValidatableObject
    {
        ...
        public JsonKubernetesEnclave(JsonEnvironment environment = default(JsonEnvironment), string wireguardServer = default(string), JsonWireguardInterface wgInterface = default(JsonWireguardInterface), string internalRemoteControlServer = default(string), string consoleOutput = default(string), string remoteControlServer = default(string), string startupTime = default(string), string endingTime = default(string), Dictionary<string, string> portMapping = default(Dictionary<string, string>), string internalAttesationServer = default(string), string status = default(string), JsonProcess process = default(JsonProcess), string enclaveIdent = default(string), Object enclaveInputstream = default(Object), string wireguardPublicKey = default(string), string internalWireguardServer = default(string), JsonKubernetesEnclave kubernetesEnclave = default(JsonKubernetesEnclave), string publicIdent = default(string), List<JsonEnclavePort> ports = default(List<JsonEnclavePort>), string signerIdent = default(string), string startupCMD = default(string), string attestationServer = default(string), string internalIdent = default(string), JsonV1EventList enclaveDeploymentEvents = default(JsonV1EventList), int attestationPort = default(int), string debugInfo = default(string), string podPhase = default(string), bool isUsingInitContainer = default(bool), int wireguardPort = default(int), JsonV1EventList enclavePodEvents = default(JsonV1EventList), JsonV1EventList enclaveReplicaSetEvents = default(JsonV1EventList), string remoteControlIP = default(string))
        {
