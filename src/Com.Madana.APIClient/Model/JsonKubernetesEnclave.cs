...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonKubernetesEnclave :  IEquatable<JsonKubernetesEnclave>, IValidatableObject
    {
        ...
        public JsonKubernetesEnclave(string signerIdent = default(string), List<JsonEnclavePort> ports = default(List<JsonEnclavePort>), string status = default(string), string internalIdent = default(string), string wireguardServer = default(string), string wireguardPublicKey = default(string), JsonProcess process = default(JsonProcess), string startupCMD = default(string), JsonKubernetesEnclave kubernetesEnclave = default(JsonKubernetesEnclave), string internalWireguardServer = default(string), Dictionary<string, string> portMapping = default(Dictionary<string, string>), string endingTime = default(string), string consoleOutput = default(string), Object enclaveInputstream = default(Object), JsonEnvironment environment = default(JsonEnvironment), string internalAttesationServer = default(string), string startupTime = default(string), JsonWireguardInterface wgInterface = default(JsonWireguardInterface), string attestationServer = default(string), string remoteControlServer = default(string), string publicIdent = default(string), string enclaveIdent = default(string), string internalRemoteControlServer = default(string), int attestationPort = default(int), int wireguardPort = default(int), string podPhase = default(string), string debugInfo = default(string), bool isUsingInitContainer = default(bool), string remoteControlIP = default(string), JsonV1EventList enclaveDeploymentEvents = default(JsonV1EventList), JsonV1EventList enclavePodEvents = default(JsonV1EventList), JsonV1EventList enclaveReplicaSetEvents = default(JsonV1EventList))
        {
