...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonKubernetesEnclave :  IEquatable<JsonKubernetesEnclave>, IValidatableObject
    {
        ...
        public JsonKubernetesEnclave(string enclaveIdent = default(string), JsonKubernetesEnclave kubernetesEnclave = default(JsonKubernetesEnclave), string internalRemoteControlServer = default(string), string internalWireguardServer = default(string), string attestationServer = default(string), string wireguardServer = default(string), JsonWireguardInterface wgInterface = default(JsonWireguardInterface), string startupCMD = default(string), string remoteControlServer = default(string), string status = default(string), string consoleOutput = default(string), string publicIdent = default(string), string endingTime = default(string), string internalAttesationServer = default(string), JsonProcess process = default(JsonProcess), string signerIdent = default(string), string startupTime = default(string), Dictionary<string, string> portMapping = default(Dictionary<string, string>), List<JsonEnclavePort> ports = default(List<JsonEnclavePort>), string internalIdent = default(string), string wireguardPublicKey = default(string), JsonEnvironment environment = default(JsonEnvironment), Object enclaveInputstream = default(Object), string remoteControlIP = default(string), JsonV1EventList enclaveReplicaSetEvents = default(JsonV1EventList), JsonV1EventList enclavePodEvents = default(JsonV1EventList), string podPhase = default(string), int wireguardPort = default(int), bool isUsingInitContainer = default(bool), string debugInfo = default(string), int attestationPort = default(int), JsonV1EventList enclaveDeploymentEvents = default(JsonV1EventList))
        {
