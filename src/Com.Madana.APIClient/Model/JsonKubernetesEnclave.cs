...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonKubernetesEnclave :  IEquatable<JsonKubernetesEnclave>, IValidatableObject
    {
        ...
        public JsonKubernetesEnclave(string signerIdent = default(string), JsonKubernetesEnclave kubernetesEnclave = default(JsonKubernetesEnclave), string internalRemoteControlServer = default(string), JsonWireguardInterface wgInterface = default(JsonWireguardInterface), JsonEnvironment environment = default(JsonEnvironment), string status = default(string), List<JsonEnclavePort> ports = default(List<JsonEnclavePort>), JsonProcess process = default(JsonProcess), Dictionary<string, string> portMapping = default(Dictionary<string, string>), string consoleOutput = default(string), string endingTime = default(string), string publicIdent = default(string), string internalAttesationServer = default(string), string attestationServer = default(string), string wireguardPublicKey = default(string), string internalIdent = default(string), Object enclaveInputstream = default(Object), string startupTime = default(string), string startupCMD = default(string), string wireguardServer = default(string), string enclaveIdent = default(string), string internalWireguardServer = default(string), string remoteControlServer = default(string), string debugInfo = default(string), int wireguardPort = default(int), string podPhase = default(string), JsonV1EventList enclaveDeploymentEvents = default(JsonV1EventList), bool isUsingInitContainer = default(bool), JsonV1EventList enclaveReplicaSetEvents = default(JsonV1EventList), string remoteControlIP = default(string), JsonV1EventList enclavePodEvents = default(JsonV1EventList), int attestationPort = default(int))
        {
