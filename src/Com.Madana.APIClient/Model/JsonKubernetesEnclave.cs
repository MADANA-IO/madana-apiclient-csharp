...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonKubernetesEnclave :  IEquatable<JsonKubernetesEnclave>, IValidatableObject
    {
        ...
        public JsonKubernetesEnclave(string internalWireguardServer = default(string), string publicIdent = default(string), string wireguardPublicKey = default(string), JsonProcess process = default(JsonProcess), Dictionary<string, string> portMapping = default(Dictionary<string, string>), string internalRemoteControlServer = default(string), string remoteControlServer = default(string), string attestationServer = default(string), string signerIdent = default(string), JsonWireguardInterface wgInterface = default(JsonWireguardInterface), string startupTime = default(string), string endingTime = default(string), Object enclaveInputstream = default(Object), string internalIdent = default(string), string status = default(string), JsonKubernetesEnclave kubernetesEnclave = default(JsonKubernetesEnclave), string enclaveIdent = default(string), string startupCMD = default(string), string wireguardServer = default(string), List<JsonEnclavePort> ports = default(List<JsonEnclavePort>), string internalAttesationServer = default(string), string consoleOutput = default(string), JsonEnvironment environment = default(JsonEnvironment), int attestationPort = default(int), bool isUsingInitContainer = default(bool), JsonV1EventList enclaveDeploymentEvents = default(JsonV1EventList), string debugInfo = default(string), string remoteControlIP = default(string), JsonV1EventList enclavePodEvents = default(JsonV1EventList), JsonV1EventList enclaveReplicaSetEvents = default(JsonV1EventList), string podPhase = default(string), int wireguardPort = default(int))
        {
