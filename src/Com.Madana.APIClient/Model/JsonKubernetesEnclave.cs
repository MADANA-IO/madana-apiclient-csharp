...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonKubernetesEnclave :  IEquatable<JsonKubernetesEnclave>, IValidatableObject
    {
        ...
        public JsonKubernetesEnclave(string enclaveIdent = default(string), Dictionary<string, string> portMapping = default(Dictionary<string, string>), string wireguardPublicKey = default(string), string signerIdent = default(string), string internalIdent = default(string), string internalRemoteControlServer = default(string), List<JsonEnclavePort> ports = default(List<JsonEnclavePort>), string publicIdent = default(string), Object enclaveInputstream = default(Object), JsonKubernetesEnclave kubernetesEnclave = default(JsonKubernetesEnclave), string internalWireguardServer = default(string), string internalAttesationServer = default(string), string status = default(string), JsonWireguardInterface wgInterface = default(JsonWireguardInterface), string consoleOutput = default(string), string remoteControlServer = default(string), string startupCMD = default(string), string attestationServer = default(string), string endingTime = default(string), JsonProcess process = default(JsonProcess), string startupTime = default(string), JsonEnvironment environment = default(JsonEnvironment), string wireguardServer = default(string), int wireguardPort = default(int), string debugInfo = default(string), bool isUsingInitContainer = default(bool), JsonV1EventList enclavePodEvents = default(JsonV1EventList), string podPhase = default(string), string remoteControlIP = default(string), JsonV1EventList enclaveReplicaSetEvents = default(JsonV1EventList), int attestationPort = default(int), JsonV1EventList enclaveDeploymentEvents = default(JsonV1EventList))
        {
