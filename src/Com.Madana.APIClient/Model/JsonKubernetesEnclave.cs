...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonKubernetesEnclave :  IEquatable<JsonKubernetesEnclave>, IValidatableObject
    {
        ...
        public JsonKubernetesEnclave(string wireguardPublicKey = default(string), JsonWireguardInterface wgInterface = default(JsonWireguardInterface), JsonEnvironment environment = default(JsonEnvironment), Object enclaveInputstream = default(Object), string signerIdent = default(string), string consoleOutput = default(string), string wireguardServer = default(string), string remoteControlServer = default(string), string publicIdent = default(string), string attestationServer = default(string), Dictionary<string, string> portMapping = default(Dictionary<string, string>), string status = default(string), string internalAttesationServer = default(string), string endingTime = default(string), List<JsonEnclavePort> ports = default(List<JsonEnclavePort>), string startupCMD = default(string), JsonProcess process = default(JsonProcess), string startupTime = default(string), string internalIdent = default(string), string internalWireguardServer = default(string), JsonKubernetesEnclave kubernetesEnclave = default(JsonKubernetesEnclave), string enclaveIdent = default(string), string internalRemoteControlServer = default(string), JsonV1EventList enclaveReplicaSetEvents = default(JsonV1EventList), bool isUsingInitContainer = default(bool), JsonV1EventList enclaveDeploymentEvents = default(JsonV1EventList), string remoteControlIP = default(string), string debugInfo = default(string), string podPhase = default(string), int wireguardPort = default(int), int attestationPort = default(int), JsonV1EventList enclavePodEvents = default(JsonV1EventList))
        {
