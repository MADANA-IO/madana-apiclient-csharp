...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonKubernetesEnclave :  IEquatable<JsonKubernetesEnclave>, IValidatableObject
    {
        ...
        public JsonKubernetesEnclave(string signerIdent = default(string), string internalWireguardServer = default(string), string wireguardServer = default(string), string wireguardPublicKey = default(string), Object enclaveInputstream = default(Object), JsonEnvironment environment = default(JsonEnvironment), string status = default(string), string startupCMD = default(string), string attestationServer = default(string), string consoleOutput = default(string), string endingTime = default(string), string internalAttesationServer = default(string), JsonWireguardInterface wgInterface = default(JsonWireguardInterface), string remoteControlServer = default(string), string internalIdent = default(string), JsonProcess process = default(JsonProcess), string enclaveIdent = default(string), Dictionary<string, string> portMapping = default(Dictionary<string, string>), string startupTime = default(string), JsonKubernetesEnclave kubernetesEnclave = default(JsonKubernetesEnclave), string internalRemoteControlServer = default(string), string publicIdent = default(string), List<JsonEnclavePort> ports = default(List<JsonEnclavePort>), JsonV1EventList enclavePodEvents = default(JsonV1EventList), string remoteControlIP = default(string), JsonV1EventList enclaveReplicaSetEvents = default(JsonV1EventList), int attestationPort = default(int), string debugInfo = default(string), string podPhase = default(string), bool isUsingInitContainer = default(bool), int wireguardPort = default(int), JsonV1EventList enclaveDeploymentEvents = default(JsonV1EventList))
        {
