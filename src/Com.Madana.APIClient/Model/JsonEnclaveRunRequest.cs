...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnclaveRunRequest :  IEquatable<JsonEnclaveRunRequest>, IValidatableObject
    {
        ...
        public JsonEnclaveRunRequest(string environmentUUID = default(string), string wireguardPublicKey = default(string), string enclaveExecutionType = default(string), List<JsonEnclavePort> ports = default(List<JsonEnclavePort>), bool usingDefaultRunConfig = default(bool))
        {
