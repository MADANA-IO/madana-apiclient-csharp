...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnclaveRunRequest :  IEquatable<JsonEnclaveRunRequest>, IValidatableObject
    {
        ...
        public JsonEnclaveRunRequest(string wireguardPublicKey = default(string), List<JsonEnclavePort> ports = default(List<JsonEnclavePort>), bool usingDefaultRunConfig = default(bool), string enclaveExecutionType = default(string), string environmentUUID = default(string))
        {
