...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnclaveRunRequest :  IEquatable<JsonEnclaveRunRequest>, IValidatableObject
    {
        ...
        public JsonEnclaveRunRequest(string environmentUUID = default(string), List<JsonEnclavePort> ports = default(List<JsonEnclavePort>), string enclaveExecutionType = default(string), bool usingDefaultRunConfig = default(bool), string wireguardPublicKey = default(string))
        {
