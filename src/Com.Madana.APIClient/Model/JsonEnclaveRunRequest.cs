...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnclaveRunRequest :  IEquatable<JsonEnclaveRunRequest>, IValidatableObject
    {
        ...
        public JsonEnclaveRunRequest(string enclaveExecutionType = default(string), bool usingDefaultRunConfig = default(bool), string environmentUUID = default(string), List<JsonEnclavePort> ports = default(List<JsonEnclavePort>), string wireguardPublicKey = default(string))
        {
