...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnclaveRunRequest :  IEquatable<JsonEnclaveRunRequest>, IValidatableObject
    {
        ...
        public JsonEnclaveRunRequest(string wireguardPublicKey = default(string), bool usingDefaultRunConfig = default(bool), string enclaveExecutionType = default(string), List<JsonEnclavePort> ports = default(List<JsonEnclavePort>), string environmentUUID = default(string))
        {
