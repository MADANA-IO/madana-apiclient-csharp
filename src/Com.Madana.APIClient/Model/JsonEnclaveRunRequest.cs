...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnclaveRunRequest :  IEquatable<JsonEnclaveRunRequest>, IValidatableObject
    {
        ...
        public JsonEnclaveRunRequest(string enclaveExecutionType = default(string), string wireguardPublicKey = default(string), string environmentUUID = default(string), List<JsonEnclavePort> ports = default(List<JsonEnclavePort>), bool usingDefaultRunConfig = default(bool))
        {
