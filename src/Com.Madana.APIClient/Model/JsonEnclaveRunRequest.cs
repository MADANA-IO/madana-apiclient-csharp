...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnclaveRunRequest :  IEquatable<JsonEnclaveRunRequest>, IValidatableObject
    {
        ...
        public JsonEnclaveRunRequest(string enclaveExecutionType = default(string), string wireguardPublicKey = default(string), bool usingDefaultRunConfig = default(bool), List<JsonEnclavePort> ports = default(List<JsonEnclavePort>), string environmentUUID = default(string))
        {
