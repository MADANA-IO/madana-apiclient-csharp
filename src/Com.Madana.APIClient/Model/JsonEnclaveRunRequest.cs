...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnclaveRunRequest :  IEquatable<JsonEnclaveRunRequest>, IValidatableObject
    {
        ...
        public JsonEnclaveRunRequest(bool usingDefaultRunConfig = default(bool), string wireguardPublicKey = default(string), string enclaveExecutionType = default(string), string environmentUUID = default(string))
        {
