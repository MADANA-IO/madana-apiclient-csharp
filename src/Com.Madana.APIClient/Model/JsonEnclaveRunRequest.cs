...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnclaveRunRequest :  IEquatable<JsonEnclaveRunRequest>, IValidatableObject
    {
        ...
        public JsonEnclaveRunRequest(List<JsonEnclavePort> ports = default(List<JsonEnclavePort>), string wireguardPublicKey = default(string), bool usingDefaultRunConfig = default(bool), string environmentUUID = default(string), string enclaveExecutionType = default(string))
        {
            this.Ports = ports;
