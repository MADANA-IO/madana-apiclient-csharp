...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnclaveRunRequest :  IEquatable<JsonEnclaveRunRequest>, IValidatableObject
    {
        ...
        public JsonEnclaveRunRequest(List<JsonEnclavePort> ports = default(List<JsonEnclavePort>), string environmentUUID = default(string), bool usingDefaultRunConfig = default(bool), string enclaveExecutionType = default(string), string wireguardPublicKey = default(string))
        {
            this.Ports = ports;
