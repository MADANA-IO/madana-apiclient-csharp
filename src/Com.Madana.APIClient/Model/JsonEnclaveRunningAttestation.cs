...
namespace Com.Madana.APIClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class JsonEnclaveRunningAttestation :  IEquatable<JsonEnclaveRunningAttestation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JsonEnclaveRunningAttestation" /> class.
        /// </summary>
        /// <param name="enclaveProcess">enclaveProcess.</param>
        /// <param name="nodeInfo">nodeInfo.</param>
        public JsonEnclaveRunningAttestation(JsonEnclaveProcess enclaveProcess = default(JsonEnclaveProcess), JsonNodeInfo nodeInfo = default(JsonNodeInfo))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class JsonEnclaveRunningAttestation {\n");
        ...
        {
            return this.Equals(input as JsonEnclaveRunningAttestation);
        }

        /// <summary>
        /// Returns true if JsonEnclaveRunningAttestation instances are equal
        /// </summary>
        /// <param name="input">Instance of JsonEnclaveRunningAttestation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JsonEnclaveRunningAttestation input)
        {
            if (input == null)
                return false;
