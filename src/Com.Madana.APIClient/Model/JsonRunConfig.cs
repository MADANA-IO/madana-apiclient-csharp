...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonRunConfig :  IEquatable<JsonRunConfig>, IValidatableObject
    {
        ...
        public JsonRunConfig(string run = default(string), List<string> args = default(List<string>), Dictionary<string, string> environment = default(Dictionary<string, string>), List<JsonDiskConfig> diskConfig = default(List<JsonDiskConfig>))
        {
            this.Run = run;
            this.Args = args;
