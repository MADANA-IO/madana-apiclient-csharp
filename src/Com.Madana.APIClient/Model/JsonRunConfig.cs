...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonRunConfig :  IEquatable<JsonRunConfig>, IValidatableObject
    {
        ...
        public JsonRunConfig(List<JsonDiskConfig> diskConfig = default(List<JsonDiskConfig>), Dictionary<string, string> environment = default(Dictionary<string, string>), List<string> args = default(List<string>), string run = default(string))
        {
