...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonRunConfig :  IEquatable<JsonRunConfig>, IValidatableObject
    {
        ...
        public JsonRunConfig(string run = default(string), List<string> args = default(List<string>), List<JsonDiskConfig> diskConfig = default(List<JsonDiskConfig>), Dictionary<string, string> environment = default(Dictionary<string, string>))
        {
            this.Run = run;
            this.Args = args;
