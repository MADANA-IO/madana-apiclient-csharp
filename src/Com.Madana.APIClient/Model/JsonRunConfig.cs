...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonRunConfig :  IEquatable<JsonRunConfig>, IValidatableObject
    {
        ...
        public JsonRunConfig(List<string> args = default(List<string>), List<JsonDiskConfig> diskConfig = default(List<JsonDiskConfig>), Dictionary<string, string> environment = default(Dictionary<string, string>), string run = default(string))
        {
            this.Args = args;
