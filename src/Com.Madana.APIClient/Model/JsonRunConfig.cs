...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonRunConfig :  IEquatable<JsonRunConfig>, IValidatableObject
    {
        ...
        public JsonRunConfig(Dictionary<string, string> environment = default(Dictionary<string, string>), List<JsonDiskConfig> diskConfig = default(List<JsonDiskConfig>), string run = default(string), List<string> args = default(List<string>))
        {
