...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonMDNAUserObject :  IEquatable<JsonMDNAUserObject>, IValidatableObject
    {
        ...
        public JsonMDNAUserObject(string lastActive = default(string), string created = default(string), string activated = default(string), string image = default(string), string userName = default(string))
        {
