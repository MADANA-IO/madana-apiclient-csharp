...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonMDNAUserObject :  IEquatable<JsonMDNAUserObject>, IValidatableObject
    {
        ...
        public JsonMDNAUserObject(string activated = default(string), string image = default(string), string userName = default(string), string lastActive = default(string), string created = default(string))
        {
