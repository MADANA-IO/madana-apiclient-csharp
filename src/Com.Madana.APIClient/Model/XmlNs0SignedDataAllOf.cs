...
namespace Com.Madana.APIClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class XmlNs0SignedDataAllOf :  IEquatable<XmlNs0SignedDataAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="XmlNs0SignedDataAllOf" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="fingerpint">fingerpint.</param>
        /// <param name="signature">signature.</param>
        public XmlNs0SignedDataAllOf(string data = default(string), string fingerpint = default(string), string signature = default(string))
        {
            this.Data = data;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class XmlNs0SignedDataAllOf {\n");
        ...
        {
            return this.Equals(input as XmlNs0SignedDataAllOf);
        }

        /// <summary>
        /// Returns true if XmlNs0SignedDataAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of XmlNs0SignedDataAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(XmlNs0SignedDataAllOf input)
        {
            if (input == null)
                return false;
