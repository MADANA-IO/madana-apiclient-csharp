...
namespace Com.Madana.APIClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class XmlNs0EnclaveRunningAttestationApproval :  IEquatable<XmlNs0EnclaveRunningAttestationApproval>, IValidatableObject
    {
        /// <summary>
        ...
        public XmlNs0EnclaveRunningAttestationApproval(XmlNs0EnclaveProcess enclaveProcess = default(XmlNs0EnclaveProcess), XmlNs0NodeInfo nodeInfo = default(XmlNs0NodeInfo), string approved = default(string))
        {
