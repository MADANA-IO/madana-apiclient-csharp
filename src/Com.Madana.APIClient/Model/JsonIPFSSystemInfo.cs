...
namespace Com.Madana.APIClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class JsonIPFSSystemInfo :  IEquatable<JsonIPFSSystemInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JsonIPFSSystemInfo" /> class.
        /// </summary>
        ...
        public JsonIPFSSystemInfo(string id = default(string), string swarmConnection = default(string), string protocolVersion = default(string), string publicKey = default(string), string agentVersion = default(string))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class JsonIPFSSystemInfo {\n");
        ...
        {
            return this.Equals(input as JsonIPFSSystemInfo);
        }

        /// <summary>
        /// Returns true if JsonIPFSSystemInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of JsonIPFSSystemInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JsonIPFSSystemInfo input)
        {
            if (input == null)
                return false;
