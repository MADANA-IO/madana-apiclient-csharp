...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonIPFSSystemInfo :  IEquatable<JsonIPFSSystemInfo>, IValidatableObject
    {
        ...
        public JsonIPFSSystemInfo(string id = default(string), string publicKey = default(string), string agentVersion = default(string), string protocolVersion = default(string), string swarmConnection = default(string))
        {
            this.Id = id;
