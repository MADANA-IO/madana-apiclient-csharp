...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonIPFSSystemInfo :  IEquatable<JsonIPFSSystemInfo>, IValidatableObject
    {
        ...
        public JsonIPFSSystemInfo(string protocolVersion = default(string), string swarmConnection = default(string), string publicKey = default(string), string id = default(string), string agentVersion = default(string))
        {
