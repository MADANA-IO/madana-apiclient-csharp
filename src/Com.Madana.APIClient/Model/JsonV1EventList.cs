...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1EventList :  IEquatable<JsonV1EventList>, IValidatableObject
    {
        ...
        public JsonV1EventList(string kind = default(string), string apiVersion = default(string), JsonV1ListMeta metadata = default(JsonV1ListMeta), List<JsonV1Event> items = default(List<JsonV1Event>))
        {
            this.Kind = kind;
