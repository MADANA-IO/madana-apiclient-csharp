...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1EventList :  IEquatable<JsonV1EventList>, IValidatableObject
    {
        ...
        public JsonV1EventList(List<JsonV1Event> items = default(List<JsonV1Event>), string kind = default(string), string apiVersion = default(string), JsonV1ListMeta metadata = default(JsonV1ListMeta))
        {
            this.Items = items;
            this.Kind = kind;
