...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1EventList :  IEquatable<JsonV1EventList>, IValidatableObject
    {
        ...
        public JsonV1EventList(JsonV1ListMeta metadata = default(JsonV1ListMeta), List<JsonV1Event> items = default(List<JsonV1Event>), string apiVersion = default(string), string kind = default(string))
        {
