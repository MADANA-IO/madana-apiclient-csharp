...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1EventList :  IEquatable<JsonV1EventList>, IValidatableObject
    {
        ...
        public JsonV1EventList(List<JsonV1Event> items = default(List<JsonV1Event>), JsonV1ListMeta metadata = default(JsonV1ListMeta), string kind = default(string), string apiVersion = default(string))
        {
            this.Items = items;
