...
namespace Com.Madana.APIClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class XmlNs0EnclaveProcessAllOf :  IEquatable<XmlNs0EnclaveProcessAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="XmlNs0EnclaveProcessAllOf" /> class.
        /// </summary>
        ...
        public XmlNs0EnclaveProcessAllOf(string attestationServer = default(string), string consoleOutput = default(string), string enclaveIdent = default(string), XmlNs0InputStream enclaveInputstream = default(XmlNs0InputStream), string endingTime = default(string), XmlNs0Environment environment = default(XmlNs0Environment), string internalAttesationServer = default(string), string internalIdent = default(string), string internalRemoteControlServer = default(string), XmlNs0Process process = default(XmlNs0Process), string publicIdent = default(string), string remoteControlServer = default(string), string signerIdent = default(string), string startupCMD = default(string), string startupTime = default(string), string status = default(string), XmlNs0WireguardInterface wgInterface = default(XmlNs0WireguardInterface), string wireguardPublicKey = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class XmlNs0EnclaveProcessAllOf {\n");
        ...
        {
            return this.Equals(input as XmlNs0EnclaveProcessAllOf);
        }

        /// <summary>
        /// Returns true if XmlNs0EnclaveProcessAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of XmlNs0EnclaveProcessAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(XmlNs0EnclaveProcessAllOf input)
        {
            if (input == null)
                return false;
