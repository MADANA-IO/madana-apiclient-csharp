...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironment :  IEquatable<JsonEnvironment>, IValidatableObject
    {
        ...
        public JsonEnvironment(string description = default(string), List<string> content = default(List<string>), bool published = default(bool), string uuid = default(string), JsonRunConfig defaultRunConfiguration = default(JsonRunConfig), string name = default(string), string ipfsHash = default(string), string roothash = default(string), string rootHashOffset = default(string), string size = default(string), List<string> packages = default(List<string>))
        {
