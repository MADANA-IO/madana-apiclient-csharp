...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironment :  IEquatable<JsonEnvironment>, IValidatableObject
    {
        ...
        public JsonEnvironment(List<string> content = default(List<string>), string rootHashOffset = default(string), bool published = default(bool), List<string> packages = default(List<string>), string description = default(string), string uuid = default(string), string roothash = default(string), string ipfsHash = default(string), string name = default(string), JsonRunConfig defaultRunConfiguration = default(JsonRunConfig), string size = default(string))
        {
