...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironment :  IEquatable<JsonEnvironment>, IValidatableObject
    {
        ...
        public JsonEnvironment(string size = default(string), string rootHashOffset = default(string), List<string> packages = default(List<string>), bool published = default(bool), string roothash = default(string), List<string> content = default(List<string>), string ipfsHash = default(string), string uuid = default(string), string description = default(string), JsonRunConfig defaultRunConfiguration = default(JsonRunConfig), string name = default(string))
        {
            this.Size = size;
