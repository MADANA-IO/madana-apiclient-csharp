...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironment :  IEquatable<JsonEnvironment>, IValidatableObject
    {
        ...
        public JsonEnvironment(string ipfsHash = default(string), bool published = default(bool), List<string> packages = default(List<string>), List<string> content = default(List<string>), string uuid = default(string), string rootHashOffset = default(string), string roothash = default(string), string name = default(string), JsonRunConfig defaultRunConfiguration = default(JsonRunConfig), string size = default(string), string description = default(string))
        {
