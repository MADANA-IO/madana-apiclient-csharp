...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironment :  IEquatable<JsonEnvironment>, IValidatableObject
    {
        ...
        public JsonEnvironment(string name = default(string), string rootHashOffset = default(string), string ipfsHash = default(string), JsonRunConfig defaultRunConfiguration = default(JsonRunConfig), List<string> content = default(List<string>), string description = default(string), bool published = default(bool), List<string> packages = default(List<string>), string size = default(string), string roothash = default(string), string uuid = default(string))
        {
            this.Name = name;
