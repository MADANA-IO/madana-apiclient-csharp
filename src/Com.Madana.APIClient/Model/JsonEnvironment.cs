...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironment :  IEquatable<JsonEnvironment>, IValidatableObject
    {
        ...
        public JsonEnvironment(string name = default(string), string uuid = default(string), JsonRunConfig defaultRunConfiguration = default(JsonRunConfig), string roothash = default(string), string size = default(string), string rootHashOffset = default(string), List<string> packages = default(List<string>), string description = default(string), List<string> content = default(List<string>), bool published = default(bool), string ipfsHash = default(string))
        {
            this.Name = name;
            this.Uuid = uuid;
