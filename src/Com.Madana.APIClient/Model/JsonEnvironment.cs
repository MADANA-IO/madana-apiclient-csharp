...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironment :  IEquatable<JsonEnvironment>, IValidatableObject
    {
        ...
        public JsonEnvironment(string size = default(string), string name = default(string), string uuid = default(string), string rootHashOffset = default(string), List<string> content = default(List<string>), JsonRunConfig defaultRunConfiguration = default(JsonRunConfig), string ipfsHash = default(string), string roothash = default(string), bool published = default(bool), List<string> packages = default(List<string>), string description = default(string))
        {
            this.Size = size;
            this.Name = name;
            this.Uuid = uuid;
