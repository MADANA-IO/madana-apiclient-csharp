...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironment :  IEquatable<JsonEnvironment>, IValidatableObject
    {
        ...
        public JsonEnvironment(string ipfsHash = default(string), List<string> packages = default(List<string>), string rootHashOffset = default(string), string size = default(string), string description = default(string), string roothash = default(string), JsonRunConfig defaultRunConfiguration = default(JsonRunConfig), bool published = default(bool), List<string> content = default(List<string>), string name = default(string), string uuid = default(string))
        {
