...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironment :  IEquatable<JsonEnvironment>, IValidatableObject
    {
        ...
        public JsonEnvironment(string roothash = default(string), string size = default(string), bool published = default(bool), JsonRunConfig defaultRunConfiguration = default(JsonRunConfig), string ipfsHash = default(string), string rootHashOffset = default(string), string uuid = default(string), string name = default(string), List<string> packages = default(List<string>), List<string> content = default(List<string>), string description = default(string))
        {
