...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironment :  IEquatable<JsonEnvironment>, IValidatableObject
    {
        ...
        public JsonEnvironment(string rootHashOffset = default(string), string size = default(string), string description = default(string), string roothash = default(string), List<string> content = default(List<string>), string ipfsHash = default(string), bool published = default(bool), JsonRunConfig defaultRunConfiguration = default(JsonRunConfig), List<string> packages = default(List<string>), string name = default(string), string uuid = default(string))
        {
