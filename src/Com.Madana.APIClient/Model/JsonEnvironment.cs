...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironment :  IEquatable<JsonEnvironment>, IValidatableObject
    {
        ...
        public JsonEnvironment(List<string> packages = default(List<string>), bool published = default(bool), string ipfsHash = default(string), string roothash = default(string), JsonRunConfig defaultRunConfiguration = default(JsonRunConfig), string description = default(string), string rootHashOffset = default(string), List<string> content = default(List<string>), string size = default(string), string uuid = default(string), string name = default(string))
        {
