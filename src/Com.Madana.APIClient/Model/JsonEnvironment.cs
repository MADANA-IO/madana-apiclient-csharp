...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironment :  IEquatable<JsonEnvironment>, IValidatableObject
    {
        ...
        public JsonEnvironment(string description = default(string), bool published = default(bool), string roothash = default(string), string size = default(string), JsonRunConfig defaultRunConfiguration = default(JsonRunConfig), string ipfsHash = default(string), List<string> packages = default(List<string>), string rootHashOffset = default(string), string name = default(string), string uuid = default(string), List<string> content = default(List<string>))
        {
