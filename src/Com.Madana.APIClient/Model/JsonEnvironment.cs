...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironment :  IEquatable<JsonEnvironment>, IValidatableObject
    {
        ...
        public JsonEnvironment(string name = default(string), string roothash = default(string), string uuid = default(string), List<string> content = default(List<string>), string rootHashOffset = default(string), JsonRunConfig defaultRunConfiguration = default(JsonRunConfig), string size = default(string), List<string> packages = default(List<string>), string description = default(string), bool published = default(bool), string ipfsHash = default(string))
        {
            this.Name = name;
