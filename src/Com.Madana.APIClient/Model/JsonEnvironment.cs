...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironment :  IEquatable<JsonEnvironment>, IValidatableObject
    {
        ...
        public JsonEnvironment(string size = default(string), List<string> content = default(List<string>), string ipfsHash = default(string), string name = default(string), string rootHashOffset = default(string), JsonRunConfig defaultRunConfiguration = default(JsonRunConfig), List<string> packages = default(List<string>), string roothash = default(string), string uuid = default(string), bool published = default(bool), string description = default(string))
        {
            this.Size = size;
