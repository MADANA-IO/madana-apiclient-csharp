...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironment :  IEquatable<JsonEnvironment>, IValidatableObject
    {
        ...
        public JsonEnvironment(string ipfsHash = default(string), string rootHashOffset = default(string), string name = default(string), string description = default(string), List<string> content = default(List<string>), string roothash = default(string), string uuid = default(string), JsonRunConfig defaultRunConfiguration = default(JsonRunConfig), List<string> packages = default(List<string>), bool published = default(bool), string size = default(string))
        {
