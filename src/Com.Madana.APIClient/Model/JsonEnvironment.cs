...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironment :  IEquatable<JsonEnvironment>, IValidatableObject
    {
        ...
        public JsonEnvironment(string rootHashOffset = default(string), List<string> packages = default(List<string>), string roothash = default(string), string uuid = default(string), string name = default(string), JsonRunConfig defaultRunConfiguration = default(JsonRunConfig), string description = default(string), bool published = default(bool), string size = default(string), List<string> content = default(List<string>), string ipfsHash = default(string))
        {
