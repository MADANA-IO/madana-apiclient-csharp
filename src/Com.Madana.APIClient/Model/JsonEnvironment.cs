...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironment :  IEquatable<JsonEnvironment>, IValidatableObject
    {
        ...
        public JsonEnvironment(JsonRunConfig defaultRunConfiguration = default(JsonRunConfig), string size = default(string), List<string> packages = default(List<string>), string ipfsHash = default(string), bool published = default(bool), string uuid = default(string), List<string> content = default(List<string>), string roothash = default(string), string name = default(string), string description = default(string), string rootHashOffset = default(string))
        {
