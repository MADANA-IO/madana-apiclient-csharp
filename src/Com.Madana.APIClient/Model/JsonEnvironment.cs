...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironment :  IEquatable<JsonEnvironment>, IValidatableObject
    {
        ...
        public JsonEnvironment(bool published = default(bool), string uuid = default(string), JsonRunConfig defaultRunConfiguration = default(JsonRunConfig), string size = default(string), string description = default(string), List<string> packages = default(List<string>), List<string> content = default(List<string>), string name = default(string), string roothash = default(string), string ipfsHash = default(string), string rootHashOffset = default(string))
        {
