...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironment :  IEquatable<JsonEnvironment>, IValidatableObject
    {
        ...
        public JsonEnvironment(List<string> content = default(List<string>), string uuid = default(string), string description = default(string), string size = default(string), string name = default(string), string rootHashOffset = default(string), JsonRunConfig defaultRunConfiguration = default(JsonRunConfig), bool published = default(bool), string ipfsHash = default(string), string roothash = default(string), List<string> packages = default(List<string>))
        {
