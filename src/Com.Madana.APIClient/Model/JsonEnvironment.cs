...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironment :  IEquatable<JsonEnvironment>, IValidatableObject
    {
        ...
        public JsonEnvironment(string description = default(string), string name = default(string), List<string> content = default(List<string>), string size = default(string), string roothash = default(string), string uuid = default(string), bool published = default(bool), string rootHashOffset = default(string), string ipfsHash = default(string), JsonRunConfig defaultRunConfiguration = default(JsonRunConfig), List<string> packages = default(List<string>))
        {
