...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironment :  IEquatable<JsonEnvironment>, IValidatableObject
    {
        ...
        public JsonEnvironment(bool published = default(bool), string size = default(string), List<string> packages = default(List<string>), string uuid = default(string), string rootHashOffset = default(string), string ipfsHash = default(string), string roothash = default(string), string description = default(string), List<string> content = default(List<string>), JsonRunConfig defaultRunConfiguration = default(JsonRunConfig), string name = default(string))
        {
