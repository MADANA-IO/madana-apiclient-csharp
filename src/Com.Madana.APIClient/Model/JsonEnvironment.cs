...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironment :  IEquatable<JsonEnvironment>, IValidatableObject
    {
        ...
        public JsonEnvironment(string name = default(string), string description = default(string), string uuid = default(string), string size = default(string), bool published = default(bool), List<string> packages = default(List<string>), string ipfsHash = default(string), List<string> content = default(List<string>), JsonRunConfig defaultRunConfiguration = default(JsonRunConfig), string roothash = default(string), string rootHashOffset = default(string))
        {
            this.Name = name;
