...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironment :  IEquatable<JsonEnvironment>, IValidatableObject
    {
        ...
        public JsonEnvironment(string ipfsHash = default(string), bool published = default(bool), List<string> packages = default(List<string>), string roothash = default(string), string name = default(string), string description = default(string), List<string> content = default(List<string>), JsonRunConfig defaultRunConfiguration = default(JsonRunConfig), string rootHashOffset = default(string), string size = default(string), string uuid = default(string))
        {
