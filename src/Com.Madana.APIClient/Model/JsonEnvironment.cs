...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironment :  IEquatable<JsonEnvironment>, IValidatableObject
    {
        ...
        public JsonEnvironment(string description = default(string), string rootHashOffset = default(string), string uuid = default(string), string name = default(string), bool published = default(bool), string roothash = default(string), JsonRunConfig defaultRunConfiguration = default(JsonRunConfig), string size = default(string), List<string> content = default(List<string>), List<string> packages = default(List<string>), string ipfsHash = default(string))
        {
