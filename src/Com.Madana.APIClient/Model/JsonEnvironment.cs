...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironment :  IEquatable<JsonEnvironment>, IValidatableObject
    {
        ...
        public JsonEnvironment(string name = default(string), JsonRunConfig defaultRunConfiguration = default(JsonRunConfig), string ipfsHash = default(string), string rootHashOffset = default(string), List<string> content = default(List<string>), List<string> packages = default(List<string>), string description = default(string), bool published = default(bool), string uuid = default(string), string roothash = default(string), string size = default(string))
        {
            this.Name = name;
