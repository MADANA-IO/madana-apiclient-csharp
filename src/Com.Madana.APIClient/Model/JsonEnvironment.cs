...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironment :  IEquatable<JsonEnvironment>, IValidatableObject
    {
        ...
        public JsonEnvironment(string rootHashOffset = default(string), bool published = default(bool), JsonRunConfig defaultRunConfiguration = default(JsonRunConfig), string name = default(string), string roothash = default(string), List<string> content = default(List<string>), string uuid = default(string), string ipfsHash = default(string), string size = default(string), List<string> packages = default(List<string>), string description = default(string))
        {
