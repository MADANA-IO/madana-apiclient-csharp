...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironment :  IEquatable<JsonEnvironment>, IValidatableObject
    {
        ...
        public JsonEnvironment(string roothash = default(string), string uuid = default(string), bool published = default(bool), string ipfsHash = default(string), List<string> packages = default(List<string>), JsonRunConfig defaultRunConfiguration = default(JsonRunConfig), List<string> content = default(List<string>), string size = default(string), string rootHashOffset = default(string), string description = default(string), string name = default(string))
        {
