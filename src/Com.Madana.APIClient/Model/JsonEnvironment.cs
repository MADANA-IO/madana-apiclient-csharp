...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironment :  IEquatable<JsonEnvironment>, IValidatableObject
    {
        ...
        public JsonEnvironment(string name = default(string), List<string> packages = default(List<string>), string size = default(string), string rootHashOffset = default(string), string ipfsHash = default(string), string description = default(string), JsonRunConfig defaultRunConfiguration = default(JsonRunConfig), bool published = default(bool), string uuid = default(string), string roothash = default(string), List<string> content = default(List<string>))
        {
            this.Name = name;
