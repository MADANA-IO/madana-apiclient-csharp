...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironment :  IEquatable<JsonEnvironment>, IValidatableObject
    {
        ...
        public JsonEnvironment(List<string> content = default(List<string>), string name = default(string), string uuid = default(string), string ipfsHash = default(string), JsonRunConfig defaultRunConfiguration = default(JsonRunConfig), bool published = default(bool), string description = default(string), string rootHashOffset = default(string), string size = default(string), List<string> packages = default(List<string>), string roothash = default(string))
        {
