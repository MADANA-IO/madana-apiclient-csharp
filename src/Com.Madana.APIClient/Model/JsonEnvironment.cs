...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironment :  IEquatable<JsonEnvironment>, IValidatableObject
    {
        ...
        public JsonEnvironment(bool published = default(bool), string rootHashOffset = default(string), string name = default(string), List<string> content = default(List<string>), JsonRunConfig defaultRunConfiguration = default(JsonRunConfig), string size = default(string), string ipfsHash = default(string), string uuid = default(string), string roothash = default(string), string description = default(string), List<string> packages = default(List<string>))
        {
