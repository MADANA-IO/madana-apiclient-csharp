...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironment :  IEquatable<JsonEnvironment>, IValidatableObject
    {
        ...
        public JsonEnvironment(List<string> packages = default(List<string>), JsonRunConfig defaultRunConfiguration = default(JsonRunConfig), string size = default(string), bool published = default(bool), string uuid = default(string), string description = default(string), string ipfsHash = default(string), List<string> content = default(List<string>), string rootHashOffset = default(string), string name = default(string), string roothash = default(string))
        {
