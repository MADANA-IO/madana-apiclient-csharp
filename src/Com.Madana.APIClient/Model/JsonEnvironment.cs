...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironment :  IEquatable<JsonEnvironment>, IValidatableObject
    {
        ...
        public JsonEnvironment(string roothash = default(string), string rootHashOffset = default(string), string ipfsHash = default(string), string description = default(string), string name = default(string), JsonRunConfig defaultRunConfiguration = default(JsonRunConfig), string uuid = default(string), List<string> packages = default(List<string>), List<string> content = default(List<string>), string size = default(string), bool published = default(bool))
        {
