...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironment :  IEquatable<JsonEnvironment>, IValidatableObject
    {
        ...
        public JsonEnvironment(string ipfsHash = default(string), string roothash = default(string), List<string> content = default(List<string>), string rootHashOffset = default(string), string size = default(string), string description = default(string), string name = default(string), string uuid = default(string), bool published = default(bool), List<string> packages = default(List<string>), JsonRunConfig defaultRunConfiguration = default(JsonRunConfig))
        {
