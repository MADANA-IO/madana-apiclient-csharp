...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironment :  IEquatable<JsonEnvironment>, IValidatableObject
    {
        ...
        public JsonEnvironment(List<string> content = default(List<string>), string name = default(string), string description = default(string), bool published = default(bool), string rootHashOffset = default(string), string uuid = default(string), string ipfsHash = default(string), List<string> packages = default(List<string>), JsonRunConfig defaultRunConfiguration = default(JsonRunConfig), string roothash = default(string), string size = default(string))
        {
