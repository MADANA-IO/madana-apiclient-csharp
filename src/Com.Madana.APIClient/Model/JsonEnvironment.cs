...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironment :  IEquatable<JsonEnvironment>, IValidatableObject
    {
        ...
        public JsonEnvironment(string rootHashOffset = default(string), string description = default(string), List<string> content = default(List<string>), string size = default(string), string roothash = default(string), string name = default(string), List<string> packages = default(List<string>), bool published = default(bool), JsonRunConfig defaultRunConfiguration = default(JsonRunConfig), string ipfsHash = default(string), string uuid = default(string))
        {
