...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironment :  IEquatable<JsonEnvironment>, IValidatableObject
    {
        ...
        public JsonEnvironment(List<string> content = default(List<string>), string uuid = default(string), string roothash = default(string), string rootHashOffset = default(string), JsonRunConfig defaultRunConfiguration = default(JsonRunConfig), string ipfsHash = default(string), string description = default(string), bool published = default(bool), string name = default(string), List<string> packages = default(List<string>), string size = default(string))
        {
