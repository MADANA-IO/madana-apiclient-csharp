...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironment :  IEquatable<JsonEnvironment>, IValidatableObject
    {
        ...
        public JsonEnvironment(string uuid = default(string), string description = default(string), JsonRunConfig defaultRunConfiguration = default(JsonRunConfig), string rootHashOffset = default(string), string ipfsHash = default(string), List<string> packages = default(List<string>), bool published = default(bool), string roothash = default(string), string name = default(string), List<string> content = default(List<string>), string size = default(string))
        {
            this.Uuid = uuid;
