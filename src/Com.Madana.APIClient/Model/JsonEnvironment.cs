...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironment :  IEquatable<JsonEnvironment>, IValidatableObject
    {
        ...
        public JsonEnvironment(bool published = default(bool), string roothash = default(string), string uuid = default(string), string ipfsHash = default(string), string size = default(string), string description = default(string), JsonRunConfig defaultRunConfiguration = default(JsonRunConfig), List<string> packages = default(List<string>), string rootHashOffset = default(string), string name = default(string), List<string> content = default(List<string>))
        {
