...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnvironment :  IEquatable<JsonEnvironment>, IValidatableObject
    {
        ...
        public JsonEnvironment(string ipfsHash = default(string), List<string> packages = default(List<string>), string name = default(string), List<string> content = default(List<string>), JsonRunConfig defaultRunConfiguration = default(JsonRunConfig), string roothash = default(string), bool published = default(bool), string description = default(string), string uuid = default(string), string rootHashOffset = default(string), string size = default(string))
        {
