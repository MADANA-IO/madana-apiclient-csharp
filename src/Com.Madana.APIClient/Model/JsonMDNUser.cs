...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonMDNUser :  IEquatable<JsonMDNUser>, IValidatableObject
    {
        ...
        public JsonMDNUser(string created = default(string), string userName = default(string), string image = default(string), string lastActive = default(string), string activated = default(string), JsonMDNUserCredentials credentials = default(JsonMDNUserCredentials), List<JsonMDNSocialUserObject> socialAccounts = default(List<JsonMDNSocialUserObject>), string lastName = default(string), string firstName = default(string), string guid = default(string), List<JsonMDNUserSetting> settings = default(List<JsonMDNUserSetting>), string mail = default(string))
        {
