...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonMDNUser :  IEquatable<JsonMDNUser>, IValidatableObject
    {
        ...
        public JsonMDNUser(string image = default(string), string created = default(string), string lastActive = default(string), string activated = default(string), string userName = default(string), string firstName = default(string), string mail = default(string), string lastName = default(string), List<JsonMDNSocialUserObject> socialAccounts = default(List<JsonMDNSocialUserObject>), string guid = default(string), JsonMDNUserCredentials credentials = default(JsonMDNUserCredentials), List<JsonMDNUserSetting> settings = default(List<JsonMDNUserSetting>))
        {
            this.Image = image;
