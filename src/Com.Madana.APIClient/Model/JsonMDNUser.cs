...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonMDNUser : JsonMDNAUserObject,  IEquatable<JsonMDNUser>, IValidatableObject
    {
        ...
        public JsonMDNUser(string lastName = default(string), JsonMDNUserCredentials credentials = default(JsonMDNUserCredentials), List<JsonMDNUserSetting> settings = default(List<JsonMDNUserSetting>), string mail = default(string), string guid = default(string), string firstName = default(string), List<JsonMDNSocialUserObject> socialAccounts = default(List<JsonMDNSocialUserObject>), string created = default(string), string image = default(string), string activated = default(string), string userName = default(string), string lastActive = default(string)) : base()
        {
