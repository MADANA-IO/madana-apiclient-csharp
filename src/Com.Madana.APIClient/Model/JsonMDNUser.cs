...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonMDNUser :  IEquatable<JsonMDNUser>, IValidatableObject
    {
        ...
        public JsonMDNUser(string userName = default(string), string created = default(string), string lastActive = default(string), string image = default(string), string activated = default(string), JsonMDNUserCredentials credentials = default(JsonMDNUserCredentials), List<JsonMDNSocialUserObject> socialAccounts = default(List<JsonMDNSocialUserObject>), string lastName = default(string), string mail = default(string), List<JsonMDNUserSetting> settings = default(List<JsonMDNUserSetting>), string guid = default(string), string firstName = default(string))
        {
