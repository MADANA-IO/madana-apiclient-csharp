...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonMDNUser :  IEquatable<JsonMDNUser>, IValidatableObject
    {
        ...
        public JsonMDNUser(string activated = default(string), string userName = default(string), string lastActive = default(string), string created = default(string), string image = default(string), List<JsonMDNUserSetting> settings = default(List<JsonMDNUserSetting>), List<JsonMDNSocialUserObject> socialAccounts = default(List<JsonMDNSocialUserObject>), string mail = default(string), string guid = default(string), string firstName = default(string), string lastName = default(string), JsonMDNUserCredentials credentials = default(JsonMDNUserCredentials))
        {
