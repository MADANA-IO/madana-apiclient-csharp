...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonMDNUser :  IEquatable<JsonMDNUser>, IValidatableObject
    {
        ...
        public JsonMDNUser(string activated = default(string), string lastActive = default(string), string created = default(string), string userName = default(string), string image = default(string), List<JsonMDNSocialUserObject> socialAccounts = default(List<JsonMDNSocialUserObject>), string mail = default(string), string lastName = default(string), JsonMDNUserCredentials credentials = default(JsonMDNUserCredentials), string guid = default(string), List<JsonMDNUserSetting> settings = default(List<JsonMDNUserSetting>), string firstName = default(string))
        {
