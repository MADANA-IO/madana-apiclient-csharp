...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonMDNUser : JsonMDNAUserObject,  IEquatable<JsonMDNUser>, IValidatableObject
    {
        ...
        public JsonMDNUser(JsonMDNUserCredentials credentials = default(JsonMDNUserCredentials), string guid = default(string), List<JsonMDNSocialUserObject> socialAccounts = default(List<JsonMDNSocialUserObject>), string mail = default(string), List<JsonMDNUserSetting> settings = default(List<JsonMDNUserSetting>), string lastName = default(string), string firstName = default(string), string lastActive = default(string), string created = default(string), string activated = default(string), string userName = default(string), string image = default(string)) : base()
        {
