...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonMDNUser :  IEquatable<JsonMDNUser>, IValidatableObject
    {
        ...
        public JsonMDNUser(string userName = default(string), string lastActive = default(string), string activated = default(string), string image = default(string), string created = default(string), string mail = default(string), List<JsonMDNUserSetting> settings = default(List<JsonMDNUserSetting>), string firstName = default(string), string lastName = default(string), List<JsonMDNSocialUserObject> socialAccounts = default(List<JsonMDNSocialUserObject>), JsonMDNUserCredentials credentials = default(JsonMDNUserCredentials), string guid = default(string))
        {
