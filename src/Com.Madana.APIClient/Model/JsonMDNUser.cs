...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonMDNUser : JsonMDNAUserObject,  IEquatable<JsonMDNUser>, IValidatableObject
    {
        ...
        public JsonMDNUser(List<JsonMDNSocialUserObject> socialAccounts = default(List<JsonMDNSocialUserObject>), string firstName = default(string), List<JsonMDNUserSetting> settings = default(List<JsonMDNUserSetting>), string guid = default(string), string lastName = default(string), string mail = default(string), JsonMDNUserCredentials credentials = default(JsonMDNUserCredentials), string created = default(string), string activated = default(string), string lastActive = default(string), string image = default(string), string userName = default(string)) : base()
        {
