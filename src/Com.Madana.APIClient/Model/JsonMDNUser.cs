...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonMDNUser : JsonMDNAUserObject,  IEquatable<JsonMDNUser>, IValidatableObject
    {
        ...
        public JsonMDNUser(List<JsonMDNUserSetting> settings = default(List<JsonMDNUserSetting>), List<JsonMDNSocialUserObject> socialAccounts = default(List<JsonMDNSocialUserObject>), string lastName = default(string), string mail = default(string), string firstName = default(string), JsonMDNUserCredentials credentials = default(JsonMDNUserCredentials), string guid = default(string), string activated = default(string), string image = default(string), string userName = default(string), string lastActive = default(string), string created = default(string)) : base()
        {
