...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonMDNUser :  IEquatable<JsonMDNUser>, IValidatableObject
    {
        ...
        public JsonMDNUser(string image = default(string), string created = default(string), string activated = default(string), string userName = default(string), string lastActive = default(string), List<JsonMDNUserSetting> settings = default(List<JsonMDNUserSetting>), List<JsonMDNSocialUserObject> socialAccounts = default(List<JsonMDNSocialUserObject>), string firstName = default(string), string lastName = default(string), string guid = default(string), string mail = default(string), JsonMDNUserCredentials credentials = default(JsonMDNUserCredentials))
        {
            this.Image = image;
