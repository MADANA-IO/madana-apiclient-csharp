...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonMDNUser :  IEquatable<JsonMDNUser>, IValidatableObject
    {
        ...
        public JsonMDNUser(string created = default(string), string lastActive = default(string), string image = default(string), string userName = default(string), string activated = default(string), string lastName = default(string), string mail = default(string), List<JsonMDNSocialUserObject> socialAccounts = default(List<JsonMDNSocialUserObject>), string firstName = default(string), JsonMDNUserCredentials credentials = default(JsonMDNUserCredentials), string guid = default(string), List<JsonMDNUserSetting> settings = default(List<JsonMDNUserSetting>))
        {
