...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonMDNUser :  IEquatable<JsonMDNUser>, IValidatableObject
    {
        ...
        public JsonMDNUser(string image = default(string), string lastActive = default(string), string activated = default(string), string created = default(string), string userName = default(string), string mail = default(string), string lastName = default(string), string firstName = default(string), string guid = default(string), List<JsonMDNUserSetting> settings = default(List<JsonMDNUserSetting>), List<JsonMDNSocialUserObject> socialAccounts = default(List<JsonMDNSocialUserObject>), JsonMDNUserCredentials credentials = default(JsonMDNUserCredentials))
        {
            this.Image = image;
