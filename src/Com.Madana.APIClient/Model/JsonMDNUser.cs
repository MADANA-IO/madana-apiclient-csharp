...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonMDNUser :  IEquatable<JsonMDNUser>, IValidatableObject
    {
        ...
        public JsonMDNUser(string image = default(string), string userName = default(string), string activated = default(string), string created = default(string), string lastActive = default(string), string mail = default(string), string firstName = default(string), JsonMDNUserCredentials credentials = default(JsonMDNUserCredentials), List<JsonMDNSocialUserObject> socialAccounts = default(List<JsonMDNSocialUserObject>), string guid = default(string), List<JsonMDNUserSetting> settings = default(List<JsonMDNUserSetting>), string lastName = default(string))
        {
            this.Image = image;
