...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonMDNUser :  IEquatable<JsonMDNUser>, IValidatableObject
    {
        ...
        public JsonMDNUser(string lastActive = default(string), string image = default(string), string activated = default(string), string created = default(string), string userName = default(string), List<JsonMDNSocialUserObject> socialAccounts = default(List<JsonMDNSocialUserObject>), List<JsonMDNUserSetting> settings = default(List<JsonMDNUserSetting>), string mail = default(string), string lastName = default(string), string guid = default(string), string firstName = default(string), JsonMDNUserCredentials credentials = default(JsonMDNUserCredentials))
        {
