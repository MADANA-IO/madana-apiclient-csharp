...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonMDNUser :  IEquatable<JsonMDNUser>, IValidatableObject
    {
        ...
        public JsonMDNUser(string lastActive = default(string), string image = default(string), string created = default(string), string userName = default(string), string activated = default(string), JsonMDNUserCredentials credentials = default(JsonMDNUserCredentials), string mail = default(string), string guid = default(string), List<JsonMDNSocialUserObject> socialAccounts = default(List<JsonMDNSocialUserObject>), List<JsonMDNUserSetting> settings = default(List<JsonMDNUserSetting>), string lastName = default(string), string firstName = default(string))
        {
