...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1ObjectMeta :  IEquatable<JsonV1ObjectMeta>, IValidatableObject
    {
        ...
        public JsonV1ObjectMeta(List<string> finalizers = default(List<string>), string name = default(string), decimal generation = default(decimal), string uid = default(string), string _namespace = default(string), List<JsonV1ManagedFieldsEntry> managedFields = default(List<JsonV1ManagedFieldsEntry>), string resourceVersion = default(string), decimal deletionTimestamp = default(decimal), decimal deletionGracePeriodSeconds = default(decimal), string generateName = default(string), decimal creationTimestamp = default(decimal), string selfLink = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), List<JsonV1OwnerReference> ownerReferences = default(List<JsonV1OwnerReference>), string clusterName = default(string), Dictionary<string, string> labels = default(Dictionary<string, string>))
        {
