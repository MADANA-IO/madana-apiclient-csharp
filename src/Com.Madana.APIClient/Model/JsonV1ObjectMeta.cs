...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1ObjectMeta :  IEquatable<JsonV1ObjectMeta>, IValidatableObject
    {
        ...
        public JsonV1ObjectMeta(string _namespace = default(string), decimal generation = default(decimal), List<JsonV1ManagedFieldsEntry> managedFields = default(List<JsonV1ManagedFieldsEntry>), Dictionary<string, string> annotations = default(Dictionary<string, string>), List<JsonV1OwnerReference> ownerReferences = default(List<JsonV1OwnerReference>), decimal creationTimestamp = default(decimal), Dictionary<string, string> labels = default(Dictionary<string, string>), List<string> finalizers = default(List<string>), string generateName = default(string), string clusterName = default(string), decimal deletionTimestamp = default(decimal), string name = default(string), string selfLink = default(string), string uid = default(string), string resourceVersion = default(string), decimal deletionGracePeriodSeconds = default(decimal))
        {
