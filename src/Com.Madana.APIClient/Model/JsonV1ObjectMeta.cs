...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1ObjectMeta :  IEquatable<JsonV1ObjectMeta>, IValidatableObject
    {
        ...
        public JsonV1ObjectMeta(string name = default(string), string generateName = default(string), List<string> finalizers = default(List<string>), string _namespace = default(string), string selfLink = default(string), List<JsonV1ManagedFieldsEntry> managedFields = default(List<JsonV1ManagedFieldsEntry>), decimal generation = default(decimal), Dictionary<string, string> annotations = default(Dictionary<string, string>), decimal deletionTimestamp = default(decimal), decimal deletionGracePeriodSeconds = default(decimal), List<JsonV1OwnerReference> ownerReferences = default(List<JsonV1OwnerReference>), string uid = default(string), string resourceVersion = default(string), decimal creationTimestamp = default(decimal), string clusterName = default(string), Dictionary<string, string> labels = default(Dictionary<string, string>))
        {
            this.Name = name;
