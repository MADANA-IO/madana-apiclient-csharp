...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1ObjectMeta :  IEquatable<JsonV1ObjectMeta>, IValidatableObject
    {
        ...
        public JsonV1ObjectMeta(string selfLink = default(string), string generateName = default(string), string uid = default(string), Dictionary<string, string> labels = default(Dictionary<string, string>), decimal generation = default(decimal), Dictionary<string, string> annotations = default(Dictionary<string, string>), string name = default(string), decimal deletionGracePeriodSeconds = default(decimal), List<JsonV1OwnerReference> ownerReferences = default(List<JsonV1OwnerReference>), List<string> finalizers = default(List<string>), string resourceVersion = default(string), decimal deletionTimestamp = default(decimal), string _namespace = default(string), decimal creationTimestamp = default(decimal), List<JsonV1ManagedFieldsEntry> managedFields = default(List<JsonV1ManagedFieldsEntry>), string clusterName = default(string))
        {
