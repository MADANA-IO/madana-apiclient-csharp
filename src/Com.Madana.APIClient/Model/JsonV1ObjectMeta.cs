...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1ObjectMeta :  IEquatable<JsonV1ObjectMeta>, IValidatableObject
    {
        ...
        public JsonV1ObjectMeta(decimal generation = default(decimal), string resourceVersion = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), string clusterName = default(string), string selfLink = default(string), List<JsonV1OwnerReference> ownerReferences = default(List<JsonV1OwnerReference>), string name = default(string), decimal creationTimestamp = default(decimal), decimal deletionTimestamp = default(decimal), List<JsonV1ManagedFieldsEntry> managedFields = default(List<JsonV1ManagedFieldsEntry>), string _namespace = default(string), Dictionary<string, string> labels = default(Dictionary<string, string>), decimal deletionGracePeriodSeconds = default(decimal), string uid = default(string), List<string> finalizers = default(List<string>), string generateName = default(string))
        {
