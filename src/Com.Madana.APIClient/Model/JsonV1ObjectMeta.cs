...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1ObjectMeta :  IEquatable<JsonV1ObjectMeta>, IValidatableObject
    {
        ...
        public JsonV1ObjectMeta(List<string> finalizers = default(List<string>), string resourceVersion = default(string), decimal generation = default(decimal), Dictionary<string, string> annotations = default(Dictionary<string, string>), string generateName = default(string), string _namespace = default(string), Dictionary<string, string> labels = default(Dictionary<string, string>), string uid = default(string), string name = default(string), List<JsonV1OwnerReference> ownerReferences = default(List<JsonV1OwnerReference>), decimal deletionGracePeriodSeconds = default(decimal), decimal deletionTimestamp = default(decimal), decimal creationTimestamp = default(decimal), string clusterName = default(string), string selfLink = default(string), List<JsonV1ManagedFieldsEntry> managedFields = default(List<JsonV1ManagedFieldsEntry>))
        {
