...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1ObjectMeta :  IEquatable<JsonV1ObjectMeta>, IValidatableObject
    {
        ...
        public JsonV1ObjectMeta(decimal deletionTimestamp = default(decimal), string name = default(string), List<string> finalizers = default(List<string>), string generateName = default(string), string selfLink = default(string), string uid = default(string), string _namespace = default(string), Dictionary<string, string> labels = default(Dictionary<string, string>), decimal deletionGracePeriodSeconds = default(decimal), Dictionary<string, string> annotations = default(Dictionary<string, string>), decimal creationTimestamp = default(decimal), string resourceVersion = default(string), string clusterName = default(string), decimal generation = default(decimal), List<JsonV1ManagedFieldsEntry> managedFields = default(List<JsonV1ManagedFieldsEntry>), List<JsonV1OwnerReference> ownerReferences = default(List<JsonV1OwnerReference>))
        {
