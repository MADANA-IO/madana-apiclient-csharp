...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1ObjectMeta :  IEquatable<JsonV1ObjectMeta>, IValidatableObject
    {
        ...
        public JsonV1ObjectMeta(string _namespace = default(string), decimal generation = default(decimal), string generateName = default(string), string selfLink = default(string), List<JsonV1OwnerReference> ownerReferences = default(List<JsonV1OwnerReference>), string clusterName = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), string name = default(string), decimal creationTimestamp = default(decimal), string resourceVersion = default(string), List<string> finalizers = default(List<string>), decimal deletionTimestamp = default(decimal), string uid = default(string), decimal deletionGracePeriodSeconds = default(decimal), List<JsonV1ManagedFieldsEntry> managedFields = default(List<JsonV1ManagedFieldsEntry>), Dictionary<string, string> labels = default(Dictionary<string, string>))
        {
