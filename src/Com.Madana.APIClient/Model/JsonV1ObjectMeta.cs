...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1ObjectMeta :  IEquatable<JsonV1ObjectMeta>, IValidatableObject
    {
        ...
        public JsonV1ObjectMeta(Dictionary<string, string> annotations = default(Dictionary<string, string>), List<JsonV1ManagedFieldsEntry> managedFields = default(List<JsonV1ManagedFieldsEntry>), decimal creationTimestamp = default(decimal), string name = default(string), string generateName = default(string), Dictionary<string, string> labels = default(Dictionary<string, string>), string clusterName = default(string), decimal deletionGracePeriodSeconds = default(decimal), decimal generation = default(decimal), string resourceVersion = default(string), string uid = default(string), decimal deletionTimestamp = default(decimal), string selfLink = default(string), List<string> finalizers = default(List<string>), string _namespace = default(string), List<JsonV1OwnerReference> ownerReferences = default(List<JsonV1OwnerReference>))
        {
