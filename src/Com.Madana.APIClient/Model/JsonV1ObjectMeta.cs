...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1ObjectMeta :  IEquatable<JsonV1ObjectMeta>, IValidatableObject
    {
        ...
        public JsonV1ObjectMeta(string resourceVersion = default(string), List<string> finalizers = default(List<string>), List<JsonV1OwnerReference> ownerReferences = default(List<JsonV1OwnerReference>), decimal deletionTimestamp = default(decimal), decimal creationTimestamp = default(decimal), string name = default(string), Dictionary<string, string> labels = default(Dictionary<string, string>), string selfLink = default(string), string uid = default(string), string _namespace = default(string), string generateName = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), List<JsonV1ManagedFieldsEntry> managedFields = default(List<JsonV1ManagedFieldsEntry>), decimal deletionGracePeriodSeconds = default(decimal), decimal generation = default(decimal), string clusterName = default(string))
        {
