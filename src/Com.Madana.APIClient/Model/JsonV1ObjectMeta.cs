...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1ObjectMeta :  IEquatable<JsonV1ObjectMeta>, IValidatableObject
    {
        ...
        public JsonV1ObjectMeta(List<string> finalizers = default(List<string>), List<JsonV1OwnerReference> ownerReferences = default(List<JsonV1OwnerReference>), decimal deletionTimestamp = default(decimal), List<JsonV1ManagedFieldsEntry> managedFields = default(List<JsonV1ManagedFieldsEntry>), string generateName = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), decimal deletionGracePeriodSeconds = default(decimal), decimal generation = default(decimal), string uid = default(string), decimal creationTimestamp = default(decimal), string selfLink = default(string), string name = default(string), Dictionary<string, string> labels = default(Dictionary<string, string>), string _namespace = default(string), string clusterName = default(string), string resourceVersion = default(string))
        {
