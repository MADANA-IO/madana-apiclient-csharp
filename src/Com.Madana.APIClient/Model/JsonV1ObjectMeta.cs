...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1ObjectMeta :  IEquatable<JsonV1ObjectMeta>, IValidatableObject
    {
        ...
        public JsonV1ObjectMeta(decimal creationTimestamp = default(decimal), string resourceVersion = default(string), decimal generation = default(decimal), decimal deletionTimestamp = default(decimal), string clusterName = default(string), Dictionary<string, string> labels = default(Dictionary<string, string>), string _namespace = default(string), string selfLink = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), string generateName = default(string), decimal deletionGracePeriodSeconds = default(decimal), string uid = default(string), string name = default(string), List<JsonV1ManagedFieldsEntry> managedFields = default(List<JsonV1ManagedFieldsEntry>), List<JsonV1OwnerReference> ownerReferences = default(List<JsonV1OwnerReference>), List<string> finalizers = default(List<string>))
        {
