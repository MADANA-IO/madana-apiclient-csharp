...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1ObjectMeta :  IEquatable<JsonV1ObjectMeta>, IValidatableObject
    {
        ...
        public JsonV1ObjectMeta(List<JsonV1OwnerReference> ownerReferences = default(List<JsonV1OwnerReference>), string name = default(string), decimal deletionGracePeriodSeconds = default(decimal), string clusterName = default(string), string selfLink = default(string), decimal creationTimestamp = default(decimal), string _namespace = default(string), string generateName = default(string), Dictionary<string, string> labels = default(Dictionary<string, string>), string resourceVersion = default(string), List<string> finalizers = default(List<string>), decimal generation = default(decimal), List<JsonV1ManagedFieldsEntry> managedFields = default(List<JsonV1ManagedFieldsEntry>), string uid = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), decimal deletionTimestamp = default(decimal))
        {
