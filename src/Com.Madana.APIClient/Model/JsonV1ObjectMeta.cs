...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1ObjectMeta :  IEquatable<JsonV1ObjectMeta>, IValidatableObject
    {
        ...
        public JsonV1ObjectMeta(Dictionary<string, string> annotations = default(Dictionary<string, string>), List<JsonV1ManagedFieldsEntry> managedFields = default(List<JsonV1ManagedFieldsEntry>), decimal generation = default(decimal), string resourceVersion = default(string), Dictionary<string, string> labels = default(Dictionary<string, string>), List<string> finalizers = default(List<string>), decimal deletionGracePeriodSeconds = default(decimal), List<JsonV1OwnerReference> ownerReferences = default(List<JsonV1OwnerReference>), string uid = default(string), decimal deletionTimestamp = default(decimal), string _namespace = default(string), string selfLink = default(string), string clusterName = default(string), decimal creationTimestamp = default(decimal), string name = default(string), string generateName = default(string))
        {
