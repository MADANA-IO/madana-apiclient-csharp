...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1ObjectMeta :  IEquatable<JsonV1ObjectMeta>, IValidatableObject
    {
        ...
        public JsonV1ObjectMeta(List<JsonV1OwnerReference> ownerReferences = default(List<JsonV1OwnerReference>), string _namespace = default(string), Dictionary<string, string> labels = default(Dictionary<string, string>), decimal generation = default(decimal), List<JsonV1ManagedFieldsEntry> managedFields = default(List<JsonV1ManagedFieldsEntry>), List<string> finalizers = default(List<string>), string generateName = default(string), string uid = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), string clusterName = default(string), string selfLink = default(string), decimal creationTimestamp = default(decimal), decimal deletionGracePeriodSeconds = default(decimal), decimal deletionTimestamp = default(decimal), string resourceVersion = default(string), string name = default(string))
        {
