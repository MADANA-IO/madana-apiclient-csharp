...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1ObjectMeta :  IEquatable<JsonV1ObjectMeta>, IValidatableObject
    {
        ...
        public JsonV1ObjectMeta(decimal creationTimestamp = default(decimal), string clusterName = default(string), List<string> finalizers = default(List<string>), Dictionary<string, string> annotations = default(Dictionary<string, string>), string resourceVersion = default(string), string generateName = default(string), decimal deletionTimestamp = default(decimal), string _namespace = default(string), decimal generation = default(decimal), string uid = default(string), string name = default(string), Dictionary<string, string> labels = default(Dictionary<string, string>), decimal deletionGracePeriodSeconds = default(decimal), List<JsonV1OwnerReference> ownerReferences = default(List<JsonV1OwnerReference>), List<JsonV1ManagedFieldsEntry> managedFields = default(List<JsonV1ManagedFieldsEntry>), string selfLink = default(string))
        {
