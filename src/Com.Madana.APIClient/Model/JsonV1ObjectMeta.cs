...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1ObjectMeta :  IEquatable<JsonV1ObjectMeta>, IValidatableObject
    {
        ...
        public JsonV1ObjectMeta(string generateName = default(string), string selfLink = default(string), string clusterName = default(string), List<JsonV1OwnerReference> ownerReferences = default(List<JsonV1OwnerReference>), List<JsonV1ManagedFieldsEntry> managedFields = default(List<JsonV1ManagedFieldsEntry>), decimal generation = default(decimal), Dictionary<string, string> annotations = default(Dictionary<string, string>), string _namespace = default(string), string uid = default(string), decimal deletionTimestamp = default(decimal), Dictionary<string, string> labels = default(Dictionary<string, string>), decimal creationTimestamp = default(decimal), string resourceVersion = default(string), string name = default(string), List<string> finalizers = default(List<string>), decimal deletionGracePeriodSeconds = default(decimal))
        {
