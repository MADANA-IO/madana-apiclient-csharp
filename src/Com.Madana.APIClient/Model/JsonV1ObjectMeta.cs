...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1ObjectMeta :  IEquatable<JsonV1ObjectMeta>, IValidatableObject
    {
        ...
        public JsonV1ObjectMeta(decimal deletionTimestamp = default(decimal), string generateName = default(string), Dictionary<string, string> labels = default(Dictionary<string, string>), string resourceVersion = default(string), decimal deletionGracePeriodSeconds = default(decimal), string uid = default(string), string _namespace = default(string), string name = default(string), List<string> finalizers = default(List<string>), decimal creationTimestamp = default(decimal), string selfLink = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), decimal generation = default(decimal), List<JsonV1ManagedFieldsEntry> managedFields = default(List<JsonV1ManagedFieldsEntry>), string clusterName = default(string), List<JsonV1OwnerReference> ownerReferences = default(List<JsonV1OwnerReference>))
        {
