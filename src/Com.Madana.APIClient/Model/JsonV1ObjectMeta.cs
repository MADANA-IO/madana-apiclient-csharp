...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1ObjectMeta :  IEquatable<JsonV1ObjectMeta>, IValidatableObject
    {
        ...
        public JsonV1ObjectMeta(decimal deletionTimestamp = default(decimal), List<JsonV1OwnerReference> ownerReferences = default(List<JsonV1OwnerReference>), Dictionary<string, string> labels = default(Dictionary<string, string>), string clusterName = default(string), string uid = default(string), string resourceVersion = default(string), string _namespace = default(string), decimal generation = default(decimal), string generateName = default(string), List<JsonV1ManagedFieldsEntry> managedFields = default(List<JsonV1ManagedFieldsEntry>), decimal deletionGracePeriodSeconds = default(decimal), string selfLink = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), string name = default(string), decimal creationTimestamp = default(decimal), List<string> finalizers = default(List<string>))
        {
