...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1ObjectMeta :  IEquatable<JsonV1ObjectMeta>, IValidatableObject
    {
        ...
        public JsonV1ObjectMeta(Dictionary<string, string> labels = default(Dictionary<string, string>), decimal deletionTimestamp = default(decimal), List<JsonV1ManagedFieldsEntry> managedFields = default(List<JsonV1ManagedFieldsEntry>), string selfLink = default(string), string name = default(string), List<JsonV1OwnerReference> ownerReferences = default(List<JsonV1OwnerReference>), string clusterName = default(string), string uid = default(string), decimal deletionGracePeriodSeconds = default(decimal), List<string> finalizers = default(List<string>), string _namespace = default(string), decimal creationTimestamp = default(decimal), decimal generation = default(decimal), string generateName = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), string resourceVersion = default(string))
        {
            this.Labels = labels;
