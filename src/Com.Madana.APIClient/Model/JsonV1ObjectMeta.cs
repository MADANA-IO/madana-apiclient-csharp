...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1ObjectMeta :  IEquatable<JsonV1ObjectMeta>, IValidatableObject
    {
        ...
        public JsonV1ObjectMeta(string selfLink = default(string), decimal generation = default(decimal), decimal deletionTimestamp = default(decimal), string name = default(string), string resourceVersion = default(string), Dictionary<string, string> labels = default(Dictionary<string, string>), decimal creationTimestamp = default(decimal), string uid = default(string), decimal deletionGracePeriodSeconds = default(decimal), List<JsonV1OwnerReference> ownerReferences = default(List<JsonV1OwnerReference>), string generateName = default(string), string _namespace = default(string), List<string> finalizers = default(List<string>), Dictionary<string, string> annotations = default(Dictionary<string, string>), List<JsonV1ManagedFieldsEntry> managedFields = default(List<JsonV1ManagedFieldsEntry>), string clusterName = default(string))
        {
