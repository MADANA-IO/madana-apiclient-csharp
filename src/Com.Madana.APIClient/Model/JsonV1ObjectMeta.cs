...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1ObjectMeta :  IEquatable<JsonV1ObjectMeta>, IValidatableObject
    {
        ...
        public JsonV1ObjectMeta(List<JsonV1ManagedFieldsEntry> managedFields = default(List<JsonV1ManagedFieldsEntry>), List<string> finalizers = default(List<string>), string selfLink = default(string), string name = default(string), string clusterName = default(string), string uid = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), string resourceVersion = default(string), decimal generation = default(decimal), decimal creationTimestamp = default(decimal), List<JsonV1OwnerReference> ownerReferences = default(List<JsonV1OwnerReference>), decimal deletionGracePeriodSeconds = default(decimal), string _namespace = default(string), Dictionary<string, string> labels = default(Dictionary<string, string>), string generateName = default(string), decimal deletionTimestamp = default(decimal))
        {
