...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1ObjectMeta :  IEquatable<JsonV1ObjectMeta>, IValidatableObject
    {
        ...
        public JsonV1ObjectMeta(List<JsonV1ManagedFieldsEntry> managedFields = default(List<JsonV1ManagedFieldsEntry>), string generateName = default(string), Dictionary<string, string> labels = default(Dictionary<string, string>), decimal deletionTimestamp = default(decimal), decimal deletionGracePeriodSeconds = default(decimal), string uid = default(string), string resourceVersion = default(string), string clusterName = default(string), decimal creationTimestamp = default(decimal), string _namespace = default(string), string selfLink = default(string), decimal generation = default(decimal), string name = default(string), List<JsonV1OwnerReference> ownerReferences = default(List<JsonV1OwnerReference>), List<string> finalizers = default(List<string>), Dictionary<string, string> annotations = default(Dictionary<string, string>))
        {
