...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1ObjectMeta :  IEquatable<JsonV1ObjectMeta>, IValidatableObject
    {
        ...
        public JsonV1ObjectMeta(string generateName = default(string), string clusterName = default(string), decimal generation = default(decimal), string _namespace = default(string), List<JsonV1ManagedFieldsEntry> managedFields = default(List<JsonV1ManagedFieldsEntry>), string selfLink = default(string), List<JsonV1OwnerReference> ownerReferences = default(List<JsonV1OwnerReference>), Dictionary<string, string> annotations = default(Dictionary<string, string>), decimal creationTimestamp = default(decimal), decimal deletionGracePeriodSeconds = default(decimal), string uid = default(string), decimal deletionTimestamp = default(decimal), string resourceVersion = default(string), List<string> finalizers = default(List<string>), string name = default(string), Dictionary<string, string> labels = default(Dictionary<string, string>))
        {
