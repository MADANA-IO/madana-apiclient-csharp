...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1ObjectMeta :  IEquatable<JsonV1ObjectMeta>, IValidatableObject
    {
        ...
        public JsonV1ObjectMeta(string resourceVersion = default(string), string generateName = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), decimal deletionGracePeriodSeconds = default(decimal), decimal generation = default(decimal), Dictionary<string, string> labels = default(Dictionary<string, string>), List<JsonV1ManagedFieldsEntry> managedFields = default(List<JsonV1ManagedFieldsEntry>), decimal deletionTimestamp = default(decimal), string name = default(string), string uid = default(string), string _namespace = default(string), string clusterName = default(string), List<JsonV1OwnerReference> ownerReferences = default(List<JsonV1OwnerReference>), decimal creationTimestamp = default(decimal), List<string> finalizers = default(List<string>), string selfLink = default(string))
        {
