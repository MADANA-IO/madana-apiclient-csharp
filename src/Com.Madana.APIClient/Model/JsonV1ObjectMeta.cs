...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1ObjectMeta :  IEquatable<JsonV1ObjectMeta>, IValidatableObject
    {
        ...
        public JsonV1ObjectMeta(Dictionary<string, string> labels = default(Dictionary<string, string>), string _namespace = default(string), string resourceVersion = default(string), decimal deletionTimestamp = default(decimal), decimal deletionGracePeriodSeconds = default(decimal), List<JsonV1ManagedFieldsEntry> managedFields = default(List<JsonV1ManagedFieldsEntry>), List<JsonV1OwnerReference> ownerReferences = default(List<JsonV1OwnerReference>), string uid = default(string), string generateName = default(string), string name = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), decimal creationTimestamp = default(decimal), List<string> finalizers = default(List<string>), string clusterName = default(string), decimal generation = default(decimal), string selfLink = default(string))
        {
            this.Labels = labels;
