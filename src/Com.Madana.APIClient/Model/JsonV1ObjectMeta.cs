...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1ObjectMeta :  IEquatable<JsonV1ObjectMeta>, IValidatableObject
    {
        ...
        public JsonV1ObjectMeta(string selfLink = default(string), List<string> finalizers = default(List<string>), decimal deletionGracePeriodSeconds = default(decimal), decimal creationTimestamp = default(decimal), string resourceVersion = default(string), string name = default(string), string generateName = default(string), string clusterName = default(string), decimal generation = default(decimal), string uid = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), List<JsonV1ManagedFieldsEntry> managedFields = default(List<JsonV1ManagedFieldsEntry>), Dictionary<string, string> labels = default(Dictionary<string, string>), string _namespace = default(string), decimal deletionTimestamp = default(decimal), List<JsonV1OwnerReference> ownerReferences = default(List<JsonV1OwnerReference>))
        {
