...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1ObjectMeta :  IEquatable<JsonV1ObjectMeta>, IValidatableObject
    {
        ...
        public JsonV1ObjectMeta(List<string> finalizers = default(List<string>), string uid = default(string), decimal creationTimestamp = default(decimal), List<JsonV1ManagedFieldsEntry> managedFields = default(List<JsonV1ManagedFieldsEntry>), string clusterName = default(string), decimal generation = default(decimal), List<JsonV1OwnerReference> ownerReferences = default(List<JsonV1OwnerReference>), string selfLink = default(string), Dictionary<string, string> labels = default(Dictionary<string, string>), decimal deletionGracePeriodSeconds = default(decimal), string name = default(string), string _namespace = default(string), decimal deletionTimestamp = default(decimal), string resourceVersion = default(string), string generateName = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>))
        {
