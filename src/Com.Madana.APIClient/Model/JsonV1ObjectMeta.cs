...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1ObjectMeta :  IEquatable<JsonV1ObjectMeta>, IValidatableObject
    {
        ...
        public JsonV1ObjectMeta(decimal deletionTimestamp = default(decimal), Dictionary<string, string> labels = default(Dictionary<string, string>), string clusterName = default(string), List<JsonV1OwnerReference> ownerReferences = default(List<JsonV1OwnerReference>), string resourceVersion = default(string), string selfLink = default(string), List<string> finalizers = default(List<string>), string _namespace = default(string), string name = default(string), List<JsonV1ManagedFieldsEntry> managedFields = default(List<JsonV1ManagedFieldsEntry>), Dictionary<string, string> annotations = default(Dictionary<string, string>), decimal generation = default(decimal), string generateName = default(string), decimal creationTimestamp = default(decimal), string uid = default(string), decimal deletionGracePeriodSeconds = default(decimal))
        {
