...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonKubernetesEnclaveAllOf :  IEquatable<JsonKubernetesEnclaveAllOf>, IValidatableObject
    {
        ...
        public JsonKubernetesEnclaveAllOf(JsonV1EventList enclaveDeploymentEvents = default(JsonV1EventList), bool isUsingInitContainer = default(bool), int wireguardPort = default(int), string debugInfo = default(string), string podPhase = default(string), string remoteControlIP = default(string), JsonV1EventList enclaveReplicaSetEvents = default(JsonV1EventList), int attestationPort = default(int), JsonV1EventList enclavePodEvents = default(JsonV1EventList))
        {
