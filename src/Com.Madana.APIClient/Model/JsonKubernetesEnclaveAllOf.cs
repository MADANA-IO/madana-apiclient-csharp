...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonKubernetesEnclaveAllOf :  IEquatable<JsonKubernetesEnclaveAllOf>, IValidatableObject
    {
        ...
        public JsonKubernetesEnclaveAllOf(JsonV1EventList enclavePodEvents = default(JsonV1EventList), string remoteControlIP = default(string), string podPhase = default(string), JsonV1EventList enclaveDeploymentEvents = default(JsonV1EventList), string debugInfo = default(string), int attestationPort = default(int), bool isUsingInitContainer = default(bool), int wireguardPort = default(int), JsonV1EventList enclaveReplicaSetEvents = default(JsonV1EventList))
        {
