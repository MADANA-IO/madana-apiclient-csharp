...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonKubernetesEnclaveAllOf :  IEquatable<JsonKubernetesEnclaveAllOf>, IValidatableObject
    {
        ...
        public JsonKubernetesEnclaveAllOf(string remoteControlIP = default(string), JsonV1EventList enclaveReplicaSetEvents = default(JsonV1EventList), JsonV1EventList enclaveDeploymentEvents = default(JsonV1EventList), string podPhase = default(string), string debugInfo = default(string), int wireguardPort = default(int), JsonV1EventList enclavePodEvents = default(JsonV1EventList), bool isUsingInitContainer = default(bool), int attestationPort = default(int))
        {
