...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonKubernetesEnclaveAllOf :  IEquatable<JsonKubernetesEnclaveAllOf>, IValidatableObject
    {
        ...
        public JsonKubernetesEnclaveAllOf(bool isUsingInitContainer = default(bool), string podPhase = default(string), string debugInfo = default(string), JsonV1EventList enclaveDeploymentEvents = default(JsonV1EventList), JsonV1EventList enclavePodEvents = default(JsonV1EventList), int wireguardPort = default(int), int attestationPort = default(int), JsonV1EventList enclaveReplicaSetEvents = default(JsonV1EventList), string remoteControlIP = default(string))
        {
