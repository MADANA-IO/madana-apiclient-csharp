...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonKubernetesEnclaveAllOf :  IEquatable<JsonKubernetesEnclaveAllOf>, IValidatableObject
    {
        ...
        public JsonKubernetesEnclaveAllOf(int wireguardPort = default(int), string debugInfo = default(string), bool isUsingInitContainer = default(bool), JsonV1EventList enclavePodEvents = default(JsonV1EventList), string podPhase = default(string), string remoteControlIP = default(string), JsonV1EventList enclaveReplicaSetEvents = default(JsonV1EventList), int attestationPort = default(int), JsonV1EventList enclaveDeploymentEvents = default(JsonV1EventList))
        {
