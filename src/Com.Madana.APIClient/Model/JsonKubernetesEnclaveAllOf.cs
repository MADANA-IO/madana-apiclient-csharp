...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonKubernetesEnclaveAllOf :  IEquatable<JsonKubernetesEnclaveAllOf>, IValidatableObject
    {
        ...
        public JsonKubernetesEnclaveAllOf(JsonV1EventList enclaveReplicaSetEvents = default(JsonV1EventList), bool isUsingInitContainer = default(bool), JsonV1EventList enclaveDeploymentEvents = default(JsonV1EventList), string remoteControlIP = default(string), string debugInfo = default(string), string podPhase = default(string), int wireguardPort = default(int), int attestationPort = default(int), JsonV1EventList enclavePodEvents = default(JsonV1EventList))
        {
