...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonKubernetesEnclaveAllOf :  IEquatable<JsonKubernetesEnclaveAllOf>, IValidatableObject
    {
        ...
        public JsonKubernetesEnclaveAllOf(JsonV1EventList enclaveReplicaSetEvents = default(JsonV1EventList), JsonV1EventList enclaveDeploymentEvents = default(JsonV1EventList), JsonV1EventList enclavePodEvents = default(JsonV1EventList), bool isUsingInitContainer = default(bool), int attestationPort = default(int), int wireguardPort = default(int), string remoteControlIP = default(string), string debugInfo = default(string), string podPhase = default(string))
        {
