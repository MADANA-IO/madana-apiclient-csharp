...
namespace Com.Madana.APIClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class JsonDiskConfig :  IEquatable<JsonDiskConfig>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JsonDiskConfig" /> class.
        /// </summary>
        ...
        public JsonDiskConfig(string disk = default(string), int roothashOffset = default(int), string roothash = default(string), bool _readonly = default(bool))
        {
            this.Disk = disk;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class JsonDiskConfig {\n");
        ...
        {
            return this.Equals(input as JsonDiskConfig);
        }

        /// <summary>
        /// Returns true if JsonDiskConfig instances are equal
        /// </summary>
        /// <param name="input">Instance of JsonDiskConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JsonDiskConfig input)
        {
            if (input == null)
                return false;
