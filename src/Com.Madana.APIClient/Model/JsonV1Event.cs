...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1Event :  IEquatable<JsonV1Event>, IValidatableObject
    {
        ...
        public JsonV1Event(string type = default(string), JsonV1ObjectReference involvedObject = default(JsonV1ObjectReference), JsonV1ObjectMeta metadata = default(JsonV1ObjectMeta), string reportingComponent = default(string), decimal count = default(decimal), string action = default(string), decimal lastTimestamp = default(decimal), string reason = default(string), string kind = default(string), JsonV1EventSource source = default(JsonV1EventSource), decimal firstTimestamp = default(decimal), decimal eventTime = default(decimal), string message = default(string), JsonV1ObjectReference related = default(JsonV1ObjectReference), string apiVersion = default(string), string reportingInstance = default(string), JsonV1EventSeries series = default(JsonV1EventSeries))
        {
            this.Type = type;
