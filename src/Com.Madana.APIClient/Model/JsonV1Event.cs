...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1Event :  IEquatable<JsonV1Event>, IValidatableObject
    {
        ...
        public JsonV1Event(string message = default(string), decimal firstTimestamp = default(decimal), JsonV1ObjectReference related = default(JsonV1ObjectReference), string action = default(string), JsonV1ObjectMeta metadata = default(JsonV1ObjectMeta), decimal eventTime = default(decimal), string apiVersion = default(string), string reportingInstance = default(string), string reportingComponent = default(string), decimal count = default(decimal), string kind = default(string), JsonV1EventSource source = default(JsonV1EventSource), JsonV1EventSeries series = default(JsonV1EventSeries), decimal lastTimestamp = default(decimal), string reason = default(string), JsonV1ObjectReference involvedObject = default(JsonV1ObjectReference), string type = default(string))
        {
