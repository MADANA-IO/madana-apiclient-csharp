...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1Event :  IEquatable<JsonV1Event>, IValidatableObject
    {
        ...
        public JsonV1Event(JsonV1EventSource source = default(JsonV1EventSource), string reportingComponent = default(string), JsonV1ObjectMeta metadata = default(JsonV1ObjectMeta), decimal lastTimestamp = default(decimal), string reason = default(string), decimal count = default(decimal), string apiVersion = default(string), JsonV1EventSeries series = default(JsonV1EventSeries), string reportingInstance = default(string), decimal eventTime = default(decimal), string action = default(string), string kind = default(string), string type = default(string), string message = default(string), decimal firstTimestamp = default(decimal), JsonV1ObjectReference related = default(JsonV1ObjectReference), JsonV1ObjectReference involvedObject = default(JsonV1ObjectReference))
        {
            this.Source = source;
