...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1Event :  IEquatable<JsonV1Event>, IValidatableObject
    {
        ...
        public JsonV1Event(string message = default(string), decimal firstTimestamp = default(decimal), JsonV1ObjectReference related = default(JsonV1ObjectReference), string apiVersion = default(string), decimal eventTime = default(decimal), string reportingInstance = default(string), string reportingComponent = default(string), JsonV1ObjectMeta metadata = default(JsonV1ObjectMeta), JsonV1EventSeries series = default(JsonV1EventSeries), decimal lastTimestamp = default(decimal), decimal count = default(decimal), string type = default(string), string kind = default(string), JsonV1ObjectReference involvedObject = default(JsonV1ObjectReference), string action = default(string), JsonV1EventSource source = default(JsonV1EventSource), string reason = default(string))
        {
