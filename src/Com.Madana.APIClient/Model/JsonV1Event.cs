...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1Event :  IEquatable<JsonV1Event>, IValidatableObject
    {
        ...
        public JsonV1Event(JsonV1ObjectMeta metadata = default(JsonV1ObjectMeta), decimal eventTime = default(decimal), JsonV1EventSource source = default(JsonV1EventSource), string message = default(string), JsonV1ObjectReference related = default(JsonV1ObjectReference), string reportingInstance = default(string), decimal lastTimestamp = default(decimal), string reportingComponent = default(string), JsonV1ObjectReference involvedObject = default(JsonV1ObjectReference), string reason = default(string), string apiVersion = default(string), JsonV1EventSeries series = default(JsonV1EventSeries), decimal count = default(decimal), string action = default(string), decimal firstTimestamp = default(decimal), string type = default(string), string kind = default(string))
        {
