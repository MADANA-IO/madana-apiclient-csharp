...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1Event :  IEquatable<JsonV1Event>, IValidatableObject
    {
        ...
        public JsonV1Event(JsonV1ObjectReference related = default(JsonV1ObjectReference), string apiVersion = default(string), decimal count = default(decimal), string action = default(string), string reason = default(string), JsonV1EventSource source = default(JsonV1EventSource), string reportingComponent = default(string), decimal eventTime = default(decimal), string reportingInstance = default(string), string type = default(string), decimal lastTimestamp = default(decimal), string kind = default(string), JsonV1EventSeries series = default(JsonV1EventSeries), decimal firstTimestamp = default(decimal), JsonV1ObjectMeta metadata = default(JsonV1ObjectMeta), string message = default(string), JsonV1ObjectReference involvedObject = default(JsonV1ObjectReference))
        {
