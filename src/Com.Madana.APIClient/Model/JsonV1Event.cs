...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1Event :  IEquatable<JsonV1Event>, IValidatableObject
    {
        ...
        public JsonV1Event(string action = default(string), JsonV1EventSource source = default(JsonV1EventSource), JsonV1EventSeries series = default(JsonV1EventSeries), string kind = default(string), string reportingComponent = default(string), decimal count = default(decimal), decimal firstTimestamp = default(decimal), string reportingInstance = default(string), JsonV1ObjectMeta metadata = default(JsonV1ObjectMeta), decimal lastTimestamp = default(decimal), JsonV1ObjectReference involvedObject = default(JsonV1ObjectReference), decimal eventTime = default(decimal), string type = default(string), JsonV1ObjectReference related = default(JsonV1ObjectReference), string reason = default(string), string message = default(string), string apiVersion = default(string))
        {
            this.Action = action;
            this.Source = source;
            this.Series = series;
