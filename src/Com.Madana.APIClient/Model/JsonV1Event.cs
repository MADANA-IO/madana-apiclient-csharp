...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1Event :  IEquatable<JsonV1Event>, IValidatableObject
    {
        ...
        public JsonV1Event(JsonV1ObjectReference involvedObject = default(JsonV1ObjectReference), JsonV1ObjectMeta metadata = default(JsonV1ObjectMeta), string reason = default(string), string action = default(string), decimal eventTime = default(decimal), string reportingComponent = default(string), string kind = default(string), decimal firstTimestamp = default(decimal), decimal lastTimestamp = default(decimal), string message = default(string), JsonV1ObjectReference related = default(JsonV1ObjectReference), string type = default(string), JsonV1EventSeries series = default(JsonV1EventSeries), decimal count = default(decimal), string reportingInstance = default(string), string apiVersion = default(string), JsonV1EventSource source = default(JsonV1EventSource))
        {
