...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1Event :  IEquatable<JsonV1Event>, IValidatableObject
    {
        ...
        public JsonV1Event(JsonV1EventSeries series = default(JsonV1EventSeries), decimal count = default(decimal), JsonV1ObjectReference involvedObject = default(JsonV1ObjectReference), string kind = default(string), string reportingComponent = default(string), decimal eventTime = default(decimal), string apiVersion = default(string), JsonV1ObjectMeta metadata = default(JsonV1ObjectMeta), JsonV1EventSource source = default(JsonV1EventSource), decimal lastTimestamp = default(decimal), decimal firstTimestamp = default(decimal), string action = default(string), JsonV1ObjectReference related = default(JsonV1ObjectReference), string message = default(string), string reason = default(string), string reportingInstance = default(string), string type = default(string))
        {
            this.Series = series;
            this.Count = count;
