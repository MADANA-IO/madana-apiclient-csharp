...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1Event :  IEquatable<JsonV1Event>, IValidatableObject
    {
        ...
        public JsonV1Event(JsonV1EventSource source = default(JsonV1EventSource), JsonV1ObjectReference related = default(JsonV1ObjectReference), JsonV1EventSeries series = default(JsonV1EventSeries), string kind = default(string), string message = default(string), decimal eventTime = default(decimal), string action = default(string), decimal firstTimestamp = default(decimal), JsonV1ObjectMeta metadata = default(JsonV1ObjectMeta), decimal count = default(decimal), string reportingComponent = default(string), decimal lastTimestamp = default(decimal), string apiVersion = default(string), string type = default(string), JsonV1ObjectReference involvedObject = default(JsonV1ObjectReference), string reportingInstance = default(string), string reason = default(string))
        {
            this.Source = source;
