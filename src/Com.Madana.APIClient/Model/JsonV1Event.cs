...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1Event :  IEquatable<JsonV1Event>, IValidatableObject
    {
        ...
        public JsonV1Event(decimal firstTimestamp = default(decimal), JsonV1ObjectReference related = default(JsonV1ObjectReference), string message = default(string), string action = default(string), JsonV1EventSource source = default(JsonV1EventSource), decimal eventTime = default(decimal), JsonV1ObjectReference involvedObject = default(JsonV1ObjectReference), decimal lastTimestamp = default(decimal), string apiVersion = default(string), string reportingInstance = default(string), string reason = default(string), string reportingComponent = default(string), JsonV1ObjectMeta metadata = default(JsonV1ObjectMeta), string type = default(string), JsonV1EventSeries series = default(JsonV1EventSeries), string kind = default(string), decimal count = default(decimal))
        {
