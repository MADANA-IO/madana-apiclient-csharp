...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1Event :  IEquatable<JsonV1Event>, IValidatableObject
    {
        ...
        public JsonV1Event(string action = default(string), string type = default(string), string reportingInstance = default(string), JsonV1ObjectReference related = default(JsonV1ObjectReference), string reportingComponent = default(string), string message = default(string), JsonV1EventSeries series = default(JsonV1EventSeries), JsonV1ObjectReference involvedObject = default(JsonV1ObjectReference), JsonV1EventSource source = default(JsonV1EventSource), JsonV1ObjectMeta metadata = default(JsonV1ObjectMeta), string apiVersion = default(string), decimal lastTimestamp = default(decimal), decimal eventTime = default(decimal), string reason = default(string), string kind = default(string), decimal firstTimestamp = default(decimal), decimal count = default(decimal))
        {
            this.Action = action;
            this.Type = type;
