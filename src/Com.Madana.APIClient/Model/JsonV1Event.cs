...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1Event :  IEquatable<JsonV1Event>, IValidatableObject
    {
        ...
        public JsonV1Event(JsonV1EventSeries series = default(JsonV1EventSeries), string reportingComponent = default(string), JsonV1EventSource source = default(JsonV1EventSource), string reportingInstance = default(string), JsonV1ObjectReference related = default(JsonV1ObjectReference), string kind = default(string), string message = default(string), string reason = default(string), decimal firstTimestamp = default(decimal), decimal lastTimestamp = default(decimal), decimal eventTime = default(decimal), JsonV1ObjectMeta metadata = default(JsonV1ObjectMeta), decimal count = default(decimal), string type = default(string), string apiVersion = default(string), JsonV1ObjectReference involvedObject = default(JsonV1ObjectReference), string action = default(string))
        {
            this.Series = series;
