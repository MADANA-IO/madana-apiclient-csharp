...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1Event :  IEquatable<JsonV1Event>, IValidatableObject
    {
        ...
        public JsonV1Event(string action = default(string), string type = default(string), decimal count = default(decimal), JsonV1EventSource source = default(JsonV1EventSource), string apiVersion = default(string), JsonV1ObjectMeta metadata = default(JsonV1ObjectMeta), JsonV1ObjectReference related = default(JsonV1ObjectReference), string message = default(string), decimal eventTime = default(decimal), string reason = default(string), JsonV1EventSeries series = default(JsonV1EventSeries), JsonV1ObjectReference involvedObject = default(JsonV1ObjectReference), string reportingInstance = default(string), decimal firstTimestamp = default(decimal), decimal lastTimestamp = default(decimal), string reportingComponent = default(string), string kind = default(string))
        {
            this.Action = action;
            this.Type = type;
            this.Count = count;
