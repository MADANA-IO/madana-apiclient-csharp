...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1Event :  IEquatable<JsonV1Event>, IValidatableObject
    {
        ...
        public JsonV1Event(decimal eventTime = default(decimal), string kind = default(string), JsonV1ObjectReference related = default(JsonV1ObjectReference), decimal lastTimestamp = default(decimal), decimal firstTimestamp = default(decimal), string apiVersion = default(string), string reason = default(string), JsonV1ObjectMeta metadata = default(JsonV1ObjectMeta), string message = default(string), decimal count = default(decimal), JsonV1EventSeries series = default(JsonV1EventSeries), JsonV1EventSource source = default(JsonV1EventSource), string type = default(string), JsonV1ObjectReference involvedObject = default(JsonV1ObjectReference), string action = default(string), string reportingInstance = default(string), string reportingComponent = default(string))
        {
