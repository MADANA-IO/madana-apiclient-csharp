...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1Event :  IEquatable<JsonV1Event>, IValidatableObject
    {
        ...
        public JsonV1Event(decimal lastTimestamp = default(decimal), string type = default(string), JsonV1ObjectReference related = default(JsonV1ObjectReference), JsonV1EventSeries series = default(JsonV1EventSeries), JsonV1EventSource source = default(JsonV1EventSource), string reason = default(string), string apiVersion = default(string), string reportingComponent = default(string), string kind = default(string), string reportingInstance = default(string), JsonV1ObjectMeta metadata = default(JsonV1ObjectMeta), string message = default(string), JsonV1ObjectReference involvedObject = default(JsonV1ObjectReference), decimal eventTime = default(decimal), decimal firstTimestamp = default(decimal), decimal count = default(decimal), string action = default(string))
        {
