...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1Event :  IEquatable<JsonV1Event>, IValidatableObject
    {
        ...
        public JsonV1Event(decimal eventTime = default(decimal), decimal firstTimestamp = default(decimal), JsonV1EventSource source = default(JsonV1EventSource), JsonV1ObjectMeta metadata = default(JsonV1ObjectMeta), JsonV1ObjectReference related = default(JsonV1ObjectReference), string reportingInstance = default(string), JsonV1EventSeries series = default(JsonV1EventSeries), string type = default(string), string kind = default(string), string reportingComponent = default(string), string reason = default(string), decimal count = default(decimal), string apiVersion = default(string), string message = default(string), decimal lastTimestamp = default(decimal), JsonV1ObjectReference involvedObject = default(JsonV1ObjectReference), string action = default(string))
        {
