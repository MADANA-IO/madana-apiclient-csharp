...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1Event :  IEquatable<JsonV1Event>, IValidatableObject
    {
        ...
        public JsonV1Event(string type = default(string), string reason = default(string), JsonV1ObjectMeta metadata = default(JsonV1ObjectMeta), string reportingInstance = default(string), string apiVersion = default(string), decimal firstTimestamp = default(decimal), string kind = default(string), JsonV1EventSeries series = default(JsonV1EventSeries), string message = default(string), decimal count = default(decimal), JsonV1ObjectReference related = default(JsonV1ObjectReference), decimal lastTimestamp = default(decimal), JsonV1ObjectReference involvedObject = default(JsonV1ObjectReference), JsonV1EventSource source = default(JsonV1EventSource), string action = default(string), decimal eventTime = default(decimal), string reportingComponent = default(string))
        {
            this.Type = type;
            this.Reason = reason;
