...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1Event :  IEquatable<JsonV1Event>, IValidatableObject
    {
        ...
        public JsonV1Event(string reason = default(string), string apiVersion = default(string), string message = default(string), JsonV1ObjectReference involvedObject = default(JsonV1ObjectReference), string kind = default(string), string reportingComponent = default(string), JsonV1ObjectMeta metadata = default(JsonV1ObjectMeta), JsonV1EventSeries series = default(JsonV1EventSeries), string type = default(string), string action = default(string), JsonV1ObjectReference related = default(JsonV1ObjectReference), JsonV1EventSource source = default(JsonV1EventSource), string reportingInstance = default(string), decimal lastTimestamp = default(decimal), decimal count = default(decimal), decimal eventTime = default(decimal), decimal firstTimestamp = default(decimal))
        {
            this.Reason = reason;
