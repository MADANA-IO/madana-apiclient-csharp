...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1Event :  IEquatable<JsonV1Event>, IValidatableObject
    {
        ...
        public JsonV1Event(string reportingComponent = default(string), JsonV1EventSource source = default(JsonV1EventSource), JsonV1EventSeries series = default(JsonV1EventSeries), decimal eventTime = default(decimal), string apiVersion = default(string), string message = default(string), string reportingInstance = default(string), decimal firstTimestamp = default(decimal), string type = default(string), JsonV1ObjectMeta metadata = default(JsonV1ObjectMeta), decimal lastTimestamp = default(decimal), string kind = default(string), string action = default(string), JsonV1ObjectReference involvedObject = default(JsonV1ObjectReference), string reason = default(string), decimal count = default(decimal), JsonV1ObjectReference related = default(JsonV1ObjectReference))
        {
