...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1Event :  IEquatable<JsonV1Event>, IValidatableObject
    {
        ...
        public JsonV1Event(string reportingInstance = default(string), JsonV1ObjectReference related = default(JsonV1ObjectReference), string apiVersion = default(string), string action = default(string), JsonV1ObjectMeta metadata = default(JsonV1ObjectMeta), decimal firstTimestamp = default(decimal), string message = default(string), JsonV1EventSeries series = default(JsonV1EventSeries), decimal lastTimestamp = default(decimal), string reason = default(string), JsonV1EventSource source = default(JsonV1EventSource), string kind = default(string), string type = default(string), JsonV1ObjectReference involvedObject = default(JsonV1ObjectReference), string reportingComponent = default(string), decimal count = default(decimal), decimal eventTime = default(decimal))
        {
