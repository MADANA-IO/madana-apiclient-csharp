...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1Event :  IEquatable<JsonV1Event>, IValidatableObject
    {
        ...
        public JsonV1Event(decimal eventTime = default(decimal), JsonV1ObjectReference involvedObject = default(JsonV1ObjectReference), decimal firstTimestamp = default(decimal), string action = default(string), string kind = default(string), JsonV1EventSeries series = default(JsonV1EventSeries), JsonV1EventSource source = default(JsonV1EventSource), string reportingComponent = default(string), decimal count = default(decimal), decimal lastTimestamp = default(decimal), JsonV1ObjectMeta metadata = default(JsonV1ObjectMeta), string type = default(string), string message = default(string), string apiVersion = default(string), JsonV1ObjectReference related = default(JsonV1ObjectReference), string reason = default(string), string reportingInstance = default(string))
        {
