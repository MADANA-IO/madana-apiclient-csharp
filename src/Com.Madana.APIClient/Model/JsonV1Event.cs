...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1Event :  IEquatable<JsonV1Event>, IValidatableObject
    {
        ...
        public JsonV1Event(string action = default(string), JsonV1ObjectReference related = default(JsonV1ObjectReference), JsonV1ObjectMeta metadata = default(JsonV1ObjectMeta), string apiVersion = default(string), JsonV1EventSource source = default(JsonV1EventSource), string message = default(string), string reason = default(string), decimal count = default(decimal), decimal eventTime = default(decimal), string type = default(string), string reportingComponent = default(string), decimal lastTimestamp = default(decimal), JsonV1ObjectReference involvedObject = default(JsonV1ObjectReference), JsonV1EventSeries series = default(JsonV1EventSeries), decimal firstTimestamp = default(decimal), string reportingInstance = default(string), string kind = default(string))
        {
            this.Action = action;
