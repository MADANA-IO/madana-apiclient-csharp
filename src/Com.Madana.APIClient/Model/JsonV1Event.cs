...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1Event :  IEquatable<JsonV1Event>, IValidatableObject
    {
        ...
        public JsonV1Event(JsonV1EventSource source = default(JsonV1EventSource), string reason = default(string), string action = default(string), JsonV1ObjectReference related = default(JsonV1ObjectReference), decimal eventTime = default(decimal), decimal count = default(decimal), decimal lastTimestamp = default(decimal), string reportingComponent = default(string), JsonV1EventSeries series = default(JsonV1EventSeries), string message = default(string), string type = default(string), JsonV1ObjectReference involvedObject = default(JsonV1ObjectReference), string apiVersion = default(string), decimal firstTimestamp = default(decimal), JsonV1ObjectMeta metadata = default(JsonV1ObjectMeta), string kind = default(string), string reportingInstance = default(string))
        {
            this.Source = source;
            this.Reason = reason;
            this.Action = action;
