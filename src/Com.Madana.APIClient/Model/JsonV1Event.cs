...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1Event :  IEquatable<JsonV1Event>, IValidatableObject
    {
        ...
        public JsonV1Event(decimal lastTimestamp = default(decimal), decimal count = default(decimal), JsonV1ObjectReference related = default(JsonV1ObjectReference), decimal eventTime = default(decimal), string kind = default(string), string reportingComponent = default(string), decimal firstTimestamp = default(decimal), string reason = default(string), JsonV1ObjectReference involvedObject = default(JsonV1ObjectReference), string type = default(string), string action = default(string), string reportingInstance = default(string), string apiVersion = default(string), JsonV1EventSeries series = default(JsonV1EventSeries), JsonV1EventSource source = default(JsonV1EventSource), string message = default(string), JsonV1ObjectMeta metadata = default(JsonV1ObjectMeta))
        {
