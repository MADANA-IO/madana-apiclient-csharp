...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1Event :  IEquatable<JsonV1Event>, IValidatableObject
    {
        ...
        public JsonV1Event(decimal eventTime = default(decimal), string reason = default(string), JsonV1EventSource source = default(JsonV1EventSource), string action = default(string), string reportingComponent = default(string), decimal count = default(decimal), JsonV1ObjectReference involvedObject = default(JsonV1ObjectReference), string type = default(string), string apiVersion = default(string), JsonV1ObjectReference related = default(JsonV1ObjectReference), string reportingInstance = default(string), JsonV1ObjectMeta metadata = default(JsonV1ObjectMeta), decimal lastTimestamp = default(decimal), string kind = default(string), JsonV1EventSeries series = default(JsonV1EventSeries), decimal firstTimestamp = default(decimal), string message = default(string))
        {
