...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1Event :  IEquatable<JsonV1Event>, IValidatableObject
    {
        ...
        public JsonV1Event(decimal firstTimestamp = default(decimal), JsonV1EventSeries series = default(JsonV1EventSeries), string kind = default(string), string reportingComponent = default(string), JsonV1ObjectMeta metadata = default(JsonV1ObjectMeta), string reportingInstance = default(string), string apiVersion = default(string), string message = default(string), string type = default(string), JsonV1ObjectReference related = default(JsonV1ObjectReference), string reason = default(string), decimal eventTime = default(decimal), JsonV1EventSource source = default(JsonV1EventSource), decimal lastTimestamp = default(decimal), decimal count = default(decimal), string action = default(string), JsonV1ObjectReference involvedObject = default(JsonV1ObjectReference))
        {
