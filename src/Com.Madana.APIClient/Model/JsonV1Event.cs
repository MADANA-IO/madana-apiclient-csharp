...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1Event :  IEquatable<JsonV1Event>, IValidatableObject
    {
        ...
        public JsonV1Event(string kind = default(string), string reportingInstance = default(string), JsonV1ObjectMeta metadata = default(JsonV1ObjectMeta), decimal eventTime = default(decimal), JsonV1EventSource source = default(JsonV1EventSource), string apiVersion = default(string), decimal lastTimestamp = default(decimal), string type = default(string), JsonV1ObjectReference involvedObject = default(JsonV1ObjectReference), string message = default(string), JsonV1EventSeries series = default(JsonV1EventSeries), string action = default(string), string reason = default(string), decimal firstTimestamp = default(decimal), JsonV1ObjectReference related = default(JsonV1ObjectReference), string reportingComponent = default(string), decimal count = default(decimal))
        {
            this.Kind = kind;
