...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1Event :  IEquatable<JsonV1Event>, IValidatableObject
    {
        ...
        public JsonV1Event(JsonV1EventSource source = default(JsonV1EventSource), string reportingComponent = default(string), JsonV1ObjectMeta metadata = default(JsonV1ObjectMeta), JsonV1ObjectReference involvedObject = default(JsonV1ObjectReference), string type = default(string), JsonV1ObjectReference related = default(JsonV1ObjectReference), string kind = default(string), decimal lastTimestamp = default(decimal), string reportingInstance = default(string), string apiVersion = default(string), string message = default(string), string reason = default(string), decimal firstTimestamp = default(decimal), string action = default(string), decimal eventTime = default(decimal), JsonV1EventSeries series = default(JsonV1EventSeries), decimal count = default(decimal))
        {
            this.Source = source;
