...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1Event :  IEquatable<JsonV1Event>, IValidatableObject
    {
        ...
        public JsonV1Event(string action = default(string), decimal count = default(decimal), string message = default(string), string reportingInstance = default(string), JsonV1ObjectReference related = default(JsonV1ObjectReference), decimal lastTimestamp = default(decimal), decimal eventTime = default(decimal), string reportingComponent = default(string), JsonV1EventSeries series = default(JsonV1EventSeries), decimal firstTimestamp = default(decimal), string reason = default(string), JsonV1EventSource source = default(JsonV1EventSource), string apiVersion = default(string), JsonV1ObjectMeta metadata = default(JsonV1ObjectMeta), string type = default(string), JsonV1ObjectReference involvedObject = default(JsonV1ObjectReference), string kind = default(string))
        {
            this.Action = action;
            this.Count = count;
