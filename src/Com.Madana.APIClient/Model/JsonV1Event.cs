...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1Event :  IEquatable<JsonV1Event>, IValidatableObject
    {
        ...
        public JsonV1Event(decimal count = default(decimal), JsonV1ObjectMeta metadata = default(JsonV1ObjectMeta), decimal eventTime = default(decimal), string reportingComponent = default(string), string type = default(string), string reportingInstance = default(string), JsonV1EventSeries series = default(JsonV1EventSeries), JsonV1ObjectReference related = default(JsonV1ObjectReference), decimal lastTimestamp = default(decimal), string kind = default(string), string reason = default(string), string message = default(string), decimal firstTimestamp = default(decimal), string action = default(string), string apiVersion = default(string), JsonV1ObjectReference involvedObject = default(JsonV1ObjectReference), JsonV1EventSource source = default(JsonV1EventSource))
        {
            this.Count = count;
