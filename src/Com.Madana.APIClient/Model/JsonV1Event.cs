...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1Event :  IEquatable<JsonV1Event>, IValidatableObject
    {
        ...
        public JsonV1Event(string message = default(string), string action = default(string), JsonV1EventSeries series = default(JsonV1EventSeries), string type = default(string), decimal lastTimestamp = default(decimal), JsonV1ObjectReference related = default(JsonV1ObjectReference), JsonV1ObjectReference involvedObject = default(JsonV1ObjectReference), JsonV1ObjectMeta metadata = default(JsonV1ObjectMeta), string reportingComponent = default(string), string kind = default(string), string apiVersion = default(string), JsonV1EventSource source = default(JsonV1EventSource), decimal firstTimestamp = default(decimal), string reason = default(string), string reportingInstance = default(string), decimal count = default(decimal), decimal eventTime = default(decimal))
        {
