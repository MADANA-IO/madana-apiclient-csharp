...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1Event :  IEquatable<JsonV1Event>, IValidatableObject
    {
        ...
        public JsonV1Event(string reason = default(string), JsonV1EventSource source = default(JsonV1EventSource), string kind = default(string), decimal firstTimestamp = default(decimal), string reportingInstance = default(string), decimal eventTime = default(decimal), JsonV1EventSeries series = default(JsonV1EventSeries), string reportingComponent = default(string), decimal lastTimestamp = default(decimal), string type = default(string), string action = default(string), JsonV1ObjectReference related = default(JsonV1ObjectReference), JsonV1ObjectReference involvedObject = default(JsonV1ObjectReference), JsonV1ObjectMeta metadata = default(JsonV1ObjectMeta), string apiVersion = default(string), decimal count = default(decimal), string message = default(string))
        {
            this.Reason = reason;
            this.Source = source;
            this.Kind = kind;
