...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonV1Event :  IEquatable<JsonV1Event>, IValidatableObject
    {
        ...
        public JsonV1Event(decimal eventTime = default(decimal), JsonV1EventSeries series = default(JsonV1EventSeries), decimal lastTimestamp = default(decimal), string reportingComponent = default(string), JsonV1ObjectMeta metadata = default(JsonV1ObjectMeta), decimal count = default(decimal), string type = default(string), JsonV1ObjectReference related = default(JsonV1ObjectReference), decimal firstTimestamp = default(decimal), string message = default(string), string reportingInstance = default(string), JsonV1EventSource source = default(JsonV1EventSource), string apiVersion = default(string), JsonV1ObjectReference involvedObject = default(JsonV1ObjectReference), string action = default(string), string kind = default(string), string reason = default(string))
        {
