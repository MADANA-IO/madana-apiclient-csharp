...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnclaveProcess :  IEquatable<JsonEnclaveProcess>, IValidatableObject
    {
        ...
        public JsonEnclaveProcess(string startupTime = default(string), string remoteControlServer = default(string), string enclaveIdent = default(string), string internalIdent = default(string), string startupCMD = default(string), string signerIdent = default(string), string wireguardPublicKey = default(string), JsonEnvironment environment = default(JsonEnvironment), string internalRemoteControlServer = default(string), JsonProcess process = default(JsonProcess), string attestationServer = default(string), string internalAttesationServer = default(string), string consoleOutput = default(string), string endingTime = default(string), string status = default(string), JsonWireguardInterface wgInterface = default(JsonWireguardInterface), Object enclaveInputstream = default(Object))
        {
