...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnclaveProcess :  IEquatable<JsonEnclaveProcess>, IValidatableObject
    {
        ...
        public JsonEnclaveProcess(JsonEnvironment environment = default(JsonEnvironment), string wireguardPublicKey = default(string), string startupCMD = default(string), string status = default(string), Object enclaveInputstream = default(Object), JsonProcess process = default(JsonProcess), string consoleOutput = default(string), string internalIdent = default(string), string attestationServer = default(string), string remoteControlServer = default(string), string endingTime = default(string), JsonWireguardInterface wgInterface = default(JsonWireguardInterface), string signerIdent = default(string), string enclaveIdent = default(string), string internalAttesationServer = default(string), string internalRemoteControlServer = default(string), string startupTime = default(string))
        {
