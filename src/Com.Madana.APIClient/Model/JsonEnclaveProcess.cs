...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnclaveProcess :  IEquatable<JsonEnclaveProcess>, IValidatableObject
    {
        ...
        public JsonEnclaveProcess(string signerIdent = default(string), Object enclaveInputstream = default(Object), string status = default(string), JsonWireguardInterface wgInterface = default(JsonWireguardInterface), string internalIdent = default(string), string wireguardPublicKey = default(string), string consoleOutput = default(string), string startupTime = default(string), string internalRemoteControlServer = default(string), string remoteControlServer = default(string), string internalAttesationServer = default(string), JsonEnvironment environment = default(JsonEnvironment), JsonProcess process = default(JsonProcess), string endingTime = default(string), string enclaveIdent = default(string), string attestationServer = default(string), string startupCMD = default(string))
        {
