...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnclaveProcess :  IEquatable<JsonEnclaveProcess>, IValidatableObject
    {
        ...
        public JsonEnclaveProcess(Object enclaveInputstream = default(Object), string internalAttesationServer = default(string), string startupTime = default(string), string wireguardPublicKey = default(string), string signerIdent = default(string), string startupCMD = default(string), string internalIdent = default(string), string attestationServer = default(string), string remoteControlServer = default(string), string internalRemoteControlServer = default(string), string enclaveIdent = default(string), string status = default(string), string endingTime = default(string), JsonWireguardInterface wgInterface = default(JsonWireguardInterface), JsonProcess process = default(JsonProcess), string publicIdent = default(string), string consoleOutput = default(string), JsonEnvironment environment = default(JsonEnvironment))
        {
