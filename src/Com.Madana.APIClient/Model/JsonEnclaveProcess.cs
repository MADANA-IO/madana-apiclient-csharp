...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnclaveProcess :  IEquatable<JsonEnclaveProcess>, IValidatableObject
    {
        ...
        public JsonEnclaveProcess(string attestationServer = default(string), string consoleOutput = default(string), JsonWireguardInterface wgInterface = default(JsonWireguardInterface), string enclaveIdent = default(string), JsonEnvironment environment = default(JsonEnvironment), string wireguardPublicKey = default(string), string internalIdent = default(string), string internalRemoteControlServer = default(string), string signerIdent = default(string), string status = default(string), JsonProcess process = default(JsonProcess), string publicIdent = default(string), string internalAttesationServer = default(string), string startupCMD = default(string), string remoteControlServer = default(string), Object enclaveInputstream = default(Object), string startupTime = default(string), string endingTime = default(string))
        {
