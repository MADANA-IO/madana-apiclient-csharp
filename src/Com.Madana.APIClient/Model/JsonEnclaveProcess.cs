...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnclaveProcess :  IEquatable<JsonEnclaveProcess>, IValidatableObject
    {
        ...
        public JsonEnclaveProcess(JsonWireguardInterface wgInterface = default(JsonWireguardInterface), JsonProcess process = default(JsonProcess), string startupCMD = default(string), string status = default(string), string signerIdent = default(string), string remoteControlServer = default(string), JsonEnvironment environment = default(JsonEnvironment), string wireguardServer = default(string), string enclaveIdent = default(string), string startupTime = default(string), string internalRemoteControlServer = default(string), Object enclaveInputstream = default(Object), string attestationServer = default(string), string consoleOutput = default(string), string endingTime = default(string), string wireguardPublicKey = default(string), string publicIdent = default(string), Dictionary<string, string> portMapping = default(Dictionary<string, string>), List<JsonEnclavePort> ports = default(List<JsonEnclavePort>), string internalIdent = default(string), JsonKubernetesEnclave kubernetesEnclave = default(JsonKubernetesEnclave), string internalAttesationServer = default(string), string internalWireguardServer = default(string))
        {
