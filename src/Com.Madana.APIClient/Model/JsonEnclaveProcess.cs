...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnclaveProcess :  IEquatable<JsonEnclaveProcess>, IValidatableObject
    {
        ...
        public JsonEnclaveProcess(string startupTime = default(string), JsonEnvironment environment = default(JsonEnvironment), string internalRemoteControlServer = default(string), string status = default(string), string startupCMD = default(string), string remoteControlServer = default(string), string signerIdent = default(string), string internalIdent = default(string), string enclaveIdent = default(string), Object enclaveInputstream = default(Object), string publicIdent = default(string), string wireguardPublicKey = default(string), string endingTime = default(string), string attestationServer = default(string), JsonProcess process = default(JsonProcess), string internalAttesationServer = default(string), string consoleOutput = default(string), JsonWireguardInterface wgInterface = default(JsonWireguardInterface))
        {
