...
namespace Com.Madana.APIClient.Model
{
    ...
    public partial class JsonEnclaveProcess :  IEquatable<JsonEnclaveProcess>, IValidatableObject
    {
        ...
        public JsonEnclaveProcess(string startupTime = default(string), string internalRemoteControlServer = default(string), string wireguardPublicKey = default(string), string consoleOutput = default(string), string enclaveIdent = default(string), string signerIdent = default(string), string endingTime = default(string), string remoteControlServer = default(string), string attestationServer = default(string), JsonEnvironment environment = default(JsonEnvironment), JsonProcess process = default(JsonProcess), string status = default(string), string startupCMD = default(string), Object enclaveInputstream = default(Object), string internalIdent = default(string), string internalAttesationServer = default(string), JsonWireguardInterface wgInterface = default(JsonWireguardInterface))
        {
