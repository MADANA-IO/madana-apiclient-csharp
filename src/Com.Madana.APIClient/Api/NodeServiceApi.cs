...
namespace Com.Madana.APIClient.Api
{
    ...
    public interface INodeServiceApi : IApiAccessor
    {
        ...
        /// <returns>System.IO.Stream</returns>
        System.IO.Stream GetNodeLicenses (string active = default(string));
        ...
        /// <param name="active"> (optional, default to &quot;true&quot;)</param>
        /// <returns>ApiResponse of System.IO.Stream</returns>
        ApiResponse<System.IO.Stream> GetNodeLicensesWithHttpInfo (string active = default(string));
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of System.IO.Stream</returns>
        System.Threading.Tasks.Task<System.IO.Stream> GetNodeLicensesAsync (string active = default(string), CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (System.IO.Stream)</returns>
        System.Threading.Tasks.Task<ApiResponse<System.IO.Stream>> GetNodeLicensesWithHttpInfoAsync (string active = default(string), CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    public partial class NodeServiceApi : INodeServiceApi
    {
        ...
        /// <param name="active"> (optional, default to &quot;true&quot;)</param>
        /// <returns>System.IO.Stream</returns>
        public System.IO.Stream GetNodeLicenses (string active = default(string))
        {
             ApiResponse<System.IO.Stream> localVarResponse = GetNodeLicensesWithHttpInfo(active);
             return localVarResponse.Data;
        }
        ...
        /// <param name="active"> (optional, default to &quot;true&quot;)</param>
        /// <returns>ApiResponse of System.IO.Stream</returns>
        public ApiResponse<System.IO.Stream> GetNodeLicensesWithHttpInfo (string active = default(string))
        {

            var localVarPath = "/nodes/licenses";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetNodeLicenses", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of System.IO.Stream</returns>
        public async System.Threading.Tasks.Task<System.IO.Stream> GetNodeLicensesAsync (string active = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<System.IO.Stream> localVarResponse = await GetNodeLicensesWithHttpInfoAsync(active, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (System.IO.Stream)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<System.IO.Stream>> GetNodeLicensesWithHttpInfoAsync (string active = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
