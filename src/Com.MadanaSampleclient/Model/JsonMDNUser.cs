...
namespace Com.MadanaSampleclient.Model
{
    ...
    public partial class JsonMDNUser : JsonMDNAUserObject,  IEquatable<JsonMDNUser>, IValidatableObject
    {
        ...
        public JsonMDNUser(string mail = default(string), string lastName = default(string), string guid = default(string), List<JsonMDNUserSetting> settings = default(List<JsonMDNUserSetting>), List<JsonMDNSocialUserObject> socialAccounts = default(List<JsonMDNSocialUserObject>), JsonMDNUserCredentials credentials = default(JsonMDNUserCredentials), string firstName = default(string), string image = default(string), string activated = default(string), string created = default(string), string lastActive = default(string), string userName = default(string)) : base()
        {
            this.Mail = mail;
