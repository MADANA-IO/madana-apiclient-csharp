...
namespace Com.MadanaSampleclient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class JsonAnalysis : JsonAnalysisRequest,  IEquatable<JsonAnalysis>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JsonAnalysis" /> class.
        /// </summary>
        ...
        public JsonAnalysis(string created = default(string), string uuid = default(string), string status = default(string), string agent = default(string), List<JsonDatasetInfo> datasets = default(List<JsonDatasetInfo>), List<string> participants = default(List<string>), string views = default(string), List<JsonAnalysisRequestAction> actions = default(List<JsonAnalysisRequestAction>), string creator = default(string), string datasetCount = default(string), string tokenAmount = default(string), string treshold = default(string), string dataCollectionMethod = default(string), string dataCollectionConfig = default(string), string description = default(string)) : base()
        {
        ...
        {
            return this.Equals(input as JsonAnalysis);
        }

        /// <summary>
        /// Returns true if JsonAnalysis instances are equal
        /// </summary>
        /// <param name="input">Instance of JsonAnalysis to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JsonAnalysis input)
        {
            if (input == null)
                return false;
