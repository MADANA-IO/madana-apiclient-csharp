...
${nuget_cmd} install src/Com.Madana.APIClient/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Com.Madana.APIClient.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Com.Madana.APIClient.dll \
-recurse:'src/Com.Madana.APIClient/*.cs' \
-doc:bin/Com.Madana.APIClient.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Com.Madana.APIClient.dll was created successfully"
fi
