...
${nuget_cmd} install src/Com.MadanaSampleclient/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Com.MadanaSampleclient.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Com.MadanaSampleclient.dll \
-recurse:'src/Com.MadanaSampleclient/*.cs' \
-doc:bin/Com.MadanaSampleclient.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Com.MadanaSampleclient.dll was created successfully"
fi
